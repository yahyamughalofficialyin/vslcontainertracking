...
<!-- Mirrored from prium.github.io/falcon/v3.21.0/app/email/inbox.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 17 Oct 2024 20:05:44 GMT -->
        ...
        <div class="content">
          ...
          <div class="card">
            ...
            <div class="card-body fs-10 border-top border-200 p-0" id="emails">
              <h5 class="fs-9 px-3 pt-3 pb-2 mb-0 border-bottom border-200">Unread</h5>
              <div class="row border-bottom border-200 hover-actions-trigger hover-shadow py-2 px-1 mx-0 bg-white dark__bg-dark" data-href="email-detail.html">
                <div class="btn-group btn-group-sm z-2 hover-actions end-0 me-3" style="width: 10rem;"><button class="btn btn-tertiary hover-bg-200" type="button" data-bs-toggle="tooltip" data-bs-placement="top" title="Archive"><span class="fas fa-archive"></span></button><button class="btn btn-tertiary hover-bg-200" type="button" data-bs-toggle="tooltip" data-bs-placement="top" title="Delete"><span class="fas fa-trash-alt"></span></button><button class="btn btn-tertiary hover-bg-200" type="button" data-bs-toggle="tooltip" data-bs-placement="top" title="Mark as read"><span class="fas fa-envelope-open"></span></button><button class="btn btn-tertiary hover-bg-200" type="button" data-bs-toggle="tooltip" data-bs-placement="top" title="Snooze"><span class="fas fa-clock"></span></button></div>
                <div class="col-auto d-none d-sm-block">
                  <div class="d-flex bg-white dark__bg-dark">
                    <div class="form-check mb-0 fs-9"><input class="form-check-input" type="checkbox" id="checkbox-2" data-bulk-select-row="data-bulk-select-row" /></div><span class="fas text-warning fa-star ms-1" data-fa-transform="down-4"></span>
                  </div>
                </div>
                  ...
                  <div class="row">
                    <div class="col-md-4 col-xl-3 col-xxl-2 ps-md-0 mb-1 mb-md-0">
                      <div class="d-flex position-relative">
                        ...
                        <div class="flex-1 ms-2"><a class="fw-bold stretched-link inbox-link" href="email-detail.html">Diana</a><span class="badge badge-subtle-success badge-pill ms-2">NEW</span></div>
                      </div>
                    </div>
              ...
              <div class="row border-bottom border-200 hover-actions-trigger hover-shadow py-2 px-1 mx-0 bg-white dark__bg-dark" data-href="email-detail.html">
                ...
                <div class="col-auto d-none d-sm-block">
                  <div class="d-flex bg-white dark__bg-dark">
                    <div class="form-check mb-0 fs-9"><input class="form-check-input" type="checkbox" id="checkbox-7" data-bulk-select-row="data-bulk-select-row" /></div><span class="far text-300 fa-star ms-1" data-fa-transform="down-4"></span>
                  </div>
                </div>
                <div class="col col-md-9 col-xxl-10">
                  <div class="row">
              ...
              <div class="row border-bottom border-200 hover-actions-trigger hover-shadow py-2 px-1 mx-0 bg-white dark__bg-dark" data-href="email-detail.html">
                ...
                <div class="col-auto d-none d-sm-block">
                  <div class="d-flex bg-white dark__bg-dark">
                    <div class="form-check mb-0 fs-9"><input class="form-check-input" type="checkbox" id="checkbox-12" data-bulk-select-row="data-bulk-select-row" /></div><span class="far text-300 fa-star ms-1" data-fa-transform="down-4"></span>
                  </div>
                </div>
                <div class="col col-md-9 col-xxl-10">
                  <div class="row">
              ...
              <h5 class="fs-9 px-3 pt-3 pb-2 mb-0 border-bottom border-200">Everything else</h5>
              <div class="row border-bottom border-200 hover-actions-trigger hover-shadow py-2 px-1 mx-0 bg-body-tertiary" data-href="email-detail.html">
                <div class="btn-group btn-group-sm z-2 hover-actions end-0 me-3" style="width: 10rem;"><button class="btn btn-tertiary hover-bg-200" type="button" data-bs-toggle="tooltip" data-bs-placement="top" title="Archive"><span class="fas fa-archive"></span></button><button class="btn btn-tertiary hover-bg-200" type="button" data-bs-toggle="tooltip" data-bs-placement="top" title="Delete"><span class="fas fa-trash-alt"></span></button><button class="btn btn-tertiary hover-bg-200" type="button" data-bs-toggle="tooltip" data-bs-placement="top" title="Mark as unread"><span class="fas fa-envelope"></span></button><button class="btn btn-tertiary hover-bg-200" type="button" data-bs-toggle="tooltip" data-bs-placement="top" title="Snooze"><span class="fas fa-clock"></span></button></div>
                <div class="col-auto d-none d-sm-block">
                  <div class="d-flex bg-body-tertiary">
                    <div class="form-check mb-0 fs-9"><input class="form-check-input" type="checkbox" id="checkbox-1" data-bulk-select-row="data-bulk-select-row" /></div><span class="fas text-warning fa-star ms-1" data-fa-transform="down-4"></span>
                  </div>
                </div>
                <div class="col col-md-9 col-xxl-10">
                  <div class="row">
              ...
              <div class="row border-bottom border-200 hover-actions-trigger hover-shadow py-2 px-1 mx-0 bg-body-tertiary" data-href="email-detail.html">
                ...
                <div class="col-auto d-none d-sm-block">
                  <div class="d-flex bg-body-tertiary">
                    <div class="form-check mb-0 fs-9"><input class="form-check-input" type="checkbox" id="checkbox-3" data-bulk-select-row="data-bulk-select-row" /></div><span class="fas text-warning fa-star ms-1" data-fa-transform="down-4"></span>
                  </div>
                </div>
                <div class="col col-md-9 col-xxl-10">
                  <div class="row">
              ...
              <div class="row border-bottom border-200 hover-actions-trigger hover-shadow py-2 px-1 mx-0 bg-body-tertiary" data-href="email-detail.html">
                ...
                <div class="col-auto d-none d-sm-block">
                  <div class="d-flex bg-body-tertiary">
                    <div class="form-check mb-0 fs-9"><input class="form-check-input" type="checkbox" id="checkbox-4" data-bulk-select-row="data-bulk-select-row" /></div><span class="far text-300 fa-star ms-1" data-fa-transform="down-4"></span>
                  </div>
                </div>
                <div class="col col-md-9 col-xxl-10">
                  <div class="row">
              ...
              <div class="row border-bottom border-200 hover-actions-trigger hover-shadow py-2 px-1 mx-0 bg-body-tertiary" data-href="email-detail.html">
                ...
                <div class="col-auto d-none d-sm-block">
                  <div class="d-flex bg-body-tertiary">
                    <div class="form-check mb-0 fs-9"><input class="form-check-input" type="checkbox" id="checkbox-5" data-bulk-select-row="data-bulk-select-row" /></div><span class="far text-300 fa-star ms-1" data-fa-transform="down-4"></span>
                  </div>
                </div>
                <div class="col col-md-9 col-xxl-10">
                  <div class="row">
              ...
              <div class="row border-bottom border-200 hover-actions-trigger hover-shadow py-2 px-1 mx-0 bg-body-tertiary" data-href="email-detail.html">
                ...
                <div class="col-auto d-none d-sm-block">
                  <div class="d-flex bg-body-tertiary">
                    <div class="form-check mb-0 fs-9"><input class="form-check-input" type="checkbox" id="checkbox-6" data-bulk-select-row="data-bulk-select-row" /></div><span class="fas text-warning fa-star ms-1" data-fa-transform="down-4"></span>
                  </div>
                </div>
                <div class="col col-md-9 col-xxl-10">
                  <div class="row">
              ...
              <div class="row border-bottom border-200 hover-actions-trigger hover-shadow py-2 px-1 mx-0 bg-body-tertiary" data-href="email-detail.html">
                ...
                <div class="col-auto d-none d-sm-block">
                  <div class="d-flex bg-body-tertiary">
                    <div class="form-check mb-0 fs-9"><input class="form-check-input" type="checkbox" id="checkbox-8" data-bulk-select-row="data-bulk-select-row" /></div><span class="fas text-warning fa-star ms-1" data-fa-transform="down-4"></span>
                  </div>
                </div>
                <div class="col col-md-9 col-xxl-10">
                  <div class="row">
              ...
              <div class="row border-bottom border-200 hover-actions-trigger hover-shadow py-2 px-1 mx-0 bg-body-tertiary" data-href="email-detail.html">
                ...
                <div class="col-auto d-none d-sm-block">
                  <div class="d-flex bg-body-tertiary">
                    <div class="form-check mb-0 fs-9"><input class="form-check-input" type="checkbox" id="checkbox-9" data-bulk-select-row="data-bulk-select-row" /></div><span class="far text-300 fa-star ms-1" data-fa-transform="down-4"></span>
                  </div>
                </div>
                <div class="col col-md-9 col-xxl-10">
                  <div class="row">
              ...
              <div class="row border-bottom border-200 hover-actions-trigger hover-shadow py-2 px-1 mx-0 bg-body-tertiary" data-href="email-detail.html">
                ...
                <div class="col-auto d-none d-sm-block">
                  <div class="d-flex bg-body-tertiary">
                    <div class="form-check mb-0 fs-9"><input class="form-check-input" type="checkbox" id="checkbox-10" data-bulk-select-row="data-bulk-select-row" /></div><span class="far text-300 fa-star ms-1" data-fa-transform="down-4"></span>
                  </div>
                </div>
                <div class="col col-md-9 col-xxl-10">
                  <div class="row">
              ...
              <div class="row border-bottom border-200 hover-actions-trigger hover-shadow py-2 px-1 mx-0 bg-body-tertiary" data-href="email-detail.html">
                ...
                <div class="col-auto d-none d-sm-block">
                  <div class="d-flex bg-body-tertiary">
                    <div class="form-check mb-0 fs-9"><input class="form-check-input" type="checkbox" id="checkbox-11" data-bulk-select-row="data-bulk-select-row" /></div><span class="far text-300 fa-star ms-1" data-fa-transform="down-4"></span>
                  </div>
                </div>
                <div class="col col-md-9 col-xxl-10">
                  <div class="row">
...
<!-- Mirrored from prium.github.io/falcon/v3.21.0/app/email/inbox.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 17 Oct 2024 20:05:48 GMT -->
</html>