...
<!-- Mirrored from prium.github.io/falcon/v3.21.0/app/e-learning/trainer-profile.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 17 Oct 2024 20:05:42 GMT -->
                      ...
                      <div class="col-md-6 col-lg-12">
                        <div class="row row-cols-1 g-0">
                          <div class="col text-center">
                            <h4>Bill Finger </h4>
                            <h5 class="mb-1 text-800 fs-9">Artist | Comic Writer</h5>
                            <p class="mb-0 fs-10">National Comics Publications, NY, USA</p>
                          </div>
                      ...
                      <div class="card h-100 overflow-hidden">
                        <div class="card-body p-0 d-flex flex-column justify-content-between">
                          <div>
                            ...
                            <div class="p-3">
                              <h5 class="fs-9 mb-2"><a class="text-1100" href="course/course-details.html">Script Writing Masterclass: Introdution to Industry Cliches</a></h5>
                      ...
                      <div class="card h-100 overflow-hidden">
                        <div class="card-body p-0 d-flex flex-column justify-content-between">
                          <div>
                            ...
                            <div class="p-3">
                              <h5 class="fs-9 mb-2"><a class="text-1100" href="course/course-details.html">Composition in Comics: Easy to Read Between Panels</a></h5>
                              <h5 class="fs-9"><a href="trainer-profile.html">Bill Finger</a></h5>
                            </div>
                          </div>
                          <div class="row g-0 mb-3 align-items-end">
                      ...
                      <div class="card h-100 overflow-hidden">
                        <div class="card-body p-0 d-flex flex-column justify-content-between">
                          <div>
                            ...
                            <div class="p-3">
                              <h5 class="fs-9 mb-2"><a class="text-1100" href="course/course-details.html">Advanced Design Tools for Modern Designs</a></h5>
                              <h5 class="fs-9"><a href="trainer-profile.html">Bill Finger</a></h5>
                            </div>
                          </div>
                          <div class="row g-0 mb-3 align-items-end">
                      ...
                      <div class="card h-100 overflow-hidden">
                        <div class="card-body p-0 d-flex flex-column justify-content-between">
                          <div>
                            ...
                            <div class="p-3">
                              <h5 class="fs-9 mb-2"><a class="text-1100" href="course/course-details.html">Comic Page Layout: Analysing The Classics</a></h5>
                              <h5 class="fs-9"><a href="trainer-profile.html">Bill Finger</a></h5>
                            </div>
                          </div>
                          <div class="row g-0 mb-3 align-items-end">
                      ...
                      <div class="card h-100 overflow-hidden">
                        <div class="card-body p-0 d-flex flex-column justify-content-between">
                          <div>
                            ...
                            <div class="p-3">
                              <h5 class="fs-9 mb-2"><a class="text-1100" href="course/course-details.html">Abstract Painting: Zero to Mastery in Traditional Medium</a></h5>
                      ...
                      <div class="card h-100 overflow-hidden">
                        <div class="card-body p-0 d-flex flex-column justify-content-between">
                          <div>
                            ...
                            <div class="p-3">
                              <h5 class="fs-9 mb-2"><a class="text-1100" href="course/course-details.html">Inking: Choosing Between Analog vs Digital</a></h5>
                              <h5 class="fs-9"><a href="trainer-profile.html">Bill Finger</a></h5>
                            </div>
                          </div>
                          <div class="row g-0 mb-3 align-items-end">
                      ...
                      <div class="card h-100 overflow-hidden">
                        <div class="card-body p-0 d-flex flex-column justify-content-between">
                          <div>
                            ...
                            <div class="p-3">
                              <h5 class="fs-9 mb-2"><a class="text-1100" href="course/course-details.html">Character Design Masterclass: Your First Supervillain</a></h5>
                              <h5 class="fs-9"><a href="trainer-profile.html">Bill Finger</a></h5>
                            </div>
                          </div>
                          <div class="row g-0 mb-3 align-items-end">
                      ...
                      <div class="card h-100 overflow-hidden">
                        <div class="card-body p-0 d-flex flex-column justify-content-between">
                          <div>
                            ...
                            <div class="p-3">
                              <h5 class="fs-9 mb-2"><a class="text-1100" href="course/course-details.html">Character Design Masterclass: Your First Superhero</a></h5>
                              <h5 class="fs-9"><a href="trainer-profile.html">Bill Finger</a></h5>
                            </div>
                          </div>
                          <div class="row g-0 mb-3 align-items-end">
                      ...
                      <div class="card h-100 overflow-hidden">
                        <div class="card-body p-0 d-flex flex-column justify-content-between">
                          <div>
                            ...
                            <div class="p-3">
                              <h5 class="fs-9 mb-2"><a class="text-1100" href="course/course-details.html">Character Design Masterclass: Your First Sidekick</a></h5>
                              <h5 class="fs-9"><a href="trainer-profile.html">Bill Finger</a></h5>
                            </div>
                          </div>
                          <div class="row g-0 mb-3 align-items-end">
...
<!-- Mirrored from prium.github.io/falcon/v3.21.0/app/e-learning/trainer-profile.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 17 Oct 2024 20:05:43 GMT -->
</html>