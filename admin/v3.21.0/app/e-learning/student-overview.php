...
<!-- Mirrored from prium.github.io/falcon/v3.21.0/app/e-learning/student-overview.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 17 Oct 2024 20:05:41 GMT -->
                        ...
                        <div class="row">
                          ...
                          <div class="col-6 col-md-4">
                            <div class="nav flex-column">
                              <p class="nav-link text-700 mb-0 fw-bold">E-Learning</p><a class="nav-link py-1 link-600 fw-medium" href="course/course-list.html">Course list</a><a class="nav-link py-1 link-600 fw-medium" href="course/course-grid.html">Course grid</a><a class="nav-link py-1 link-600 fw-medium" href="course/course-details.html">Course details</a><a class="nav-link py-1 link-600 fw-medium" href="course/create-a-course.html">Create a course</a><a class="nav-link py-1 link-600 fw-medium" href="student-overview.html">Student overview</a><a class="nav-link py-1 link-600 fw-medium" href="trainer-profile.html">Trainer profile</a>
        ...
        <div class="content">
          ...
          <div class="card mb-3">
            <div class="card-body d-flex flex-wrap flex-between-center">
              ...
              <div><button class="btn btn-primary btn-md me-2" type="button"><span class="fas fa-envelope me-md-1"> </span><span class="d-none d-md-inline">Message</span></button><button class="btn btn-falcon-default btn-md" type="button"><span class="fas fa-users me-md-1"></span><span class="d-none d-md-inline">Followers</span></button></div>
            </div>
          </div>
                  ...
                  <tbody class="list">
                    <tr class="btn-reveal-trigger fw-semi-bold">
                      <td class="align-middle white-space-nowrap title" style="max-width: 23rem;">
                        <div class="d-flex gap-3 align-items-center position-relative"><img class="rounded-1 border border-200" src="../../assets/img/elearning/courses/course3.png" width="60" alt="" /><a class="stretched-link text-truncate" href="course/course-details.html">Advanced Design Tools for Modern Designs</a></div>
                      </td>
                    ...
                    <tr class="btn-reveal-trigger fw-semi-bold">
                      <td class="align-middle white-space-nowrap title" style="max-width: 23rem;">
                        <div class="d-flex gap-3 align-items-center position-relative"><img class="rounded-1 border border-200" src="../../assets/img/elearning/courses/course8.png" width="60" alt="" /><a class="stretched-link text-truncate" href="course/course-details.html">Character Design Masterclass: Your First Superhero</a></div>
                      </td>
                    ...
                    <tr class="btn-reveal-trigger fw-semi-bold">
                      <td class="align-middle white-space-nowrap title" style="max-width: 23rem;">
                        <div class="d-flex gap-3 align-items-center position-relative"><img class="rounded-1 border border-200" src="../../assets/img/elearning/courses/course1.png" width="60" alt="" /><a class="stretched-link text-truncate" href="course/course-details.html">Script Writing Masterclass: Introdution to Industry Cliches</a></div>
                      </td>
                      <td class="align-middle text-nowrap trainer"><a class="text-800" href="trainer-profile.html">Bill finger</a></td>
                      <td class="align-middle date">01/10/21</td>
                      <td class="align-middle time">12h:50m:00s</td>
                    ...
                    <tr class="btn-reveal-trigger fw-semi-bold">
                      <td class="align-middle white-space-nowrap title" style="max-width: 23rem;">
                        <div class="d-flex gap-3 align-items-center position-relative"><img class="rounded-1 border border-200" src="../../assets/img/elearning/courses/course5.png" width="60" alt="" /><a class="stretched-link text-truncate" href="course/course-details.html">Abstract Painting: Zero to Mastery in Traditional Medium</a></div>
                      </td>
                    ...
                    <tr class="btn-reveal-trigger fw-semi-bold">
                      <td class="align-middle white-space-nowrap title" style="max-width: 23rem;">
                        <div class="d-flex gap-3 align-items-center position-relative"><img class="rounded-1 border border-200" src="../../assets/img/elearning/courses/course7.png" width="60" alt="" /><a class="stretched-link text-truncate" href="course/course-details.html">Character Design Masterclass: Your First Supervillain</a></div>
                      </td>
                      <td class="align-middle text-nowrap trainer"><a class="text-800" href="trainer-profile.html">Bill finger</a></td>
                      <td class="align-middle date">01/10/21</td>
                    ...
                    <tr class="btn-reveal-trigger fw-semi-bold">
                      <td class="align-middle white-space-nowrap title" style="max-width: 23rem;">
                        <div class="d-flex gap-3 align-items-center position-relative"><img class="rounded-1 border border-200" src="../../assets/img/elearning/courses/course2.png" width="60" alt="" /><a class="stretched-link text-truncate" href="course/course-details.html">Composition in Comics: Easy to Read Between Panels</a></div>
                      </td>
                      <td class="align-middle text-nowrap trainer"><a class="text-800" href="trainer-profile.html">Bill finger</a></td>
...
<!-- Mirrored from prium.github.io/falcon/v3.21.0/app/e-learning/student-overview.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 17 Oct 2024 20:05:42 GMT -->
</html>