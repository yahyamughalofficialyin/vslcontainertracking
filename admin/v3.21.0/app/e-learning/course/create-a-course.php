...
<!-- Mirrored from prium.github.io/falcon/v3.21.0/app/e-learning/course/create-a-course.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 17 Oct 2024 20:05:39 GMT -->
            ...
            <div class="navbar-vertical-content scrollbar">
              <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                ...
                <li class="nav-item"><!-- label-->
                  ...
                  </ul><!-- parent pages--><a class="nav-link dropdown-indicator" href="#e-learning" role="button" data-bs-toggle="collapse" aria-expanded="true" aria-controls="e-learning">
            ...
            <div class="col-lg-8">
              <div class="card mb-3">
                ...
                <div class="card-body z-1">
                  ...
                  <p class="mb-0">Enlighten the world with your knowledge. Use our Course Creator to design a well-structured course; set whatever price you feel worthy of, and publish at our platform. <br />or, <br class="d-lg-none" />Want to edit your existing course? Jump to <a href="course-grid.html">Your courses</a></p>
                </div>
              </div>
              <div class="card mb-3">
                <div class="card-header">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body p-0">
                  <div class="table-responsive scrollbar">
                    <table class="table table-borderless mb-0 fs-10 overflow-hidden">
                      <tbody>
                        <tr class="btn-reveal-trigger bg-body-tertiary">
                          <td class="align-middle white-space-nowrap">
                            <div class="d-flex gap-3 align-items-center position-relative"><img class="rounded-1 border border-200" src="../../../assets/img/elearning/lessons/intro.png" width="60" alt="" />
                              <div>
                                <h5 class="fs-9 text-primary">Intro<span data-bs-toggle="tooltip" data-bs-placement="top" title="Requirement fulfilled"><span class="text-primary fs-9 ms-2 fas fa-check-circle"></span></span></h5>
                                <p class="fs-10 text-900 mb-0">Introduction and Course Objectives</p>
                              </div>
                            </div>
                          </td>
                        ...
                        <tr class="btn-reveal-trigger">
                          <td class="align-middle white-space-nowrap">
                            <div class="d-flex gap-3 align-items-center position-relative"><img class="rounded-1 border border-200" src="../../../assets/img/elearning/lessons/chapter1.png" width="60" alt="" />
                              <div>
                                <h5 class="fs-9 text-primary">Chapter 1<span data-bs-toggle="tooltip" data-bs-placement="top" title="Requirement fulfilled"><span class="text-primary fs-9 ms-2 fas fa-check-circle"></span></span></h5>
                                <p class="fs-10 text-900 mb-0">Getting Started with Photoshop</p>
                              </div>
                            </div>
                          </td>
                          <td class="align-middle white-space-nowrap fs-10 text-700">
                        ...
                        <tr class="btn-reveal-trigger bg-body-tertiary">
                          <td class="align-middle white-space-nowrap">
                            <div class="d-flex gap-3 align-items-center position-relative"><img class="rounded-1 border border-200" src="../../../assets/img/elearning/lessons/chapter2.png" width="60" alt="" />
                              <div>
                                <h5 class="fs-9 text-primary">Chapter 2<span data-bs-toggle="tooltip" data-bs-placement="top" title="No. of Slide/Test doesn’t fulfill requirement"><span class="text-primary fs-9 ms-2 fas fa-exclamation-circle"></span></span></h5>
                                <p class="fs-10 text-900 mb-0">Understanding Layers</p>
                              </div>
                            </div>
                          </td>
                          <td class="align-middle white-space-nowrap fs-10 text-700">
                ...
                <div class="card-footer py-2 text-center"><a class="btn btn-link btn-sm px-0 fw-medium" href="#!"> <span class="fas fa-plus me-1 fs-11"></span>Add New Chaptar</a></div>
              </div>
              <div class="card mb-3">
                ...
                <div class="card-body pt-0">
                  <ul class="list-unstyled mb-0">
                    <li>
                      <div class="d-flex hover-actions-trigger align-items-center py-3"><span class="fas fa-grip-lines fs-11 text-secondary me-3"></span>
                        <p class="mb-0 fs-10 me-6">This course requires profieciency in English language as the Lessons are prepared in English.</p>
                        <div class="hover-actions end-0 top-50 translate-middle-y"><button class="btn btn-link me-3 fs-11 p-0 text-700" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit"><span class="fas fa-pencil-alt"></span></button><button class="btn btn-tertiary icon-item rounded-3 fs-11 icon-item-sm" data-bs-toggle="tooltip" data-bs-placement="top" title="Remove"><span class="fas fa-times"></span></button></div>
                      </div>
                    </li>
                    <li>
                      <div class="d-flex hover-actions-trigger align-items-center py-3 border-top border-300"><span class="fas fa-grip-lines fs-11 text-secondary me-3"></span>
                        <p class="mb-0 fs-10 me-6">Learners with following skills might be more benefited, but little extra work is all that’ll take.</p>
                        <div class="hover-actions end-0 top-50 translate-middle-y"><button class="btn btn-link me-3 fs-11 p-0 text-700" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit"><span class="fas fa-pencil-alt"></span></button><button class="btn btn-tertiary icon-item rounded-3 fs-11 icon-item-sm" data-bs-toggle="tooltip" data-bs-placement="top" title="Remove"><span class="fas fa-times"></span></button></div>
                      </div>
                    </li>
                  </ul>
                  <div class="position-relative focus-actions-trigger"><input class="form-control" type="text" placeholder="Add another requirement..." />
                    <div class="position-absolute end-0 top-50 translate-middle focus-actions"><button class="btn btn-link btn-sm p-0 text-700 me-2"><span class="fas fa-arrow-right"></span></button></div>
                  </div>
                </div>
              </div>
              <div class="card mb-3 mb-lg-0">
                ...
                <div class="card-body"> <label class="mb-3 form-label lh-1" for="course-goal">Course Goals <span class="text-danger">*</span></label>
                  <ul class="list-unstyled mb-0">
                    <li>
                      <div class="d-flex py-3 hover-actions-trigger align-items-center border-top border-300"><span class="fas fa-grip-lines fs-11 text-secondary me-3"></span>
                  ...
                  <div class="position-relative mb-4 focus-actions-trigger"><input class="form-control" id="course-goal" type="text" placeholder="Add another goal..." />
                    <div class="position-absolute end-0 top-50 translate-middle focus-actions"><button class="btn btn-link btn-sm p-0 text-700 me-2"><span class="fas fa-arrow-right"></span></button></div>
                  </div>
                  <div class="d-flex flex-between-center mb-2"><label class="mb-0 lh-1" for="course-features">Key features<span class="text-danger">*</span></label><button class="btn btn-link btn-sm fw-medium p-0" type="button">Add New</button></div><select class="form-select js-choice" id="course-features" multiple="multiple" size="1" name="features" data-options='{"removeItemButton":true,"placeholder":true}'>
              ...
              <div class="sticky-sidebar top-navbar-height d-flex flex-column">
                <div class="card mb-lg-3 order-lg-0 order-1">
                  <div class="card-header py-2 d-flex flex-between-center">
                    <h5 class="mb-0">Publish your Course</h5><a class="btn btn-link btn-sm text-secondary px-0" href="#!"><span class="fw-medium d-lg-none d-xxl-inline-block">Preview</span><span class="fas fa-external-link-alt fs-11 ms-2"></span></a>
                  </div>
                  <div class="card-body bg-body-tertiary">
                  ...
                  <div class="card-footer py-2" id="course-publish-btn">
                    <div class="row flex-between-center g-0">
                      ...
                      <div class="col-auto"><button class="btn btn-primary btn-md px-xxl-5 px-4 fw-medium" type="submit">Publish</button></div>
                    </div>
                  </div>
                </div>
                <div class="card mb-3">
                  <div class="card-header">
                    <h5 class="mb-0">Upload Cover Photo <span data-bs-toggle="tooltip" data-bs-placement="top" title="Add cover photo"><span class="fas fa-info-circle text-primary fs-9 ms-2"></span></span></h5>
                  </div>
                  <div class="card-body bg-body-tertiary">
                    <form class="dropzone dropzone-single p-0" data-dropzone="data-dropzone" data-options='{"maxFiles":1,"acceptedFiles":"image/*"}'>
                      ...
                      <div class="dz-message fs-10" data-dz-message="data-dz-message"><img class="me-2" src="../../../assets/img/icons/cloud-upload.svg" width="20" alt="" /><span class="d-none d-lg-inline">Drag your image here<br/>or, </span><span class="btn btn-link p-0 fs-10">Browse</span></div>
                    </form>
                  </div>
                </div>
                <div class="card mb-3">
                  <div class="card-header">
                    <h5 class="mb-0">Upload Preview Video<span data-bs-toggle="tooltip" data-bs-placement="top" title="Upload preview video"><span class="fas fa-info-circle text-primary fs-9 ms-2"></span></span></h5>
                  </div>
                  <div class="card-body bg-body-tertiary">
                    <form class="dropzone dropzone-single p-0" data-dropzone="data-dropzone" data-options='{"maxFiles":1,"acceptedFiles":".mp4,.mkv,.avi"}'>
                      ...
                      <div class="dz-preview dz-preview-single">
                        <div class="dz-preview-cover dz-complete"><video class="dz-preview-img" controls="controls" data-dz-thumbnail=""></video><a class="dz-remove text-danger" href="#!" data-dz-remove="data-dz-remove"><span class="fas fa-times"></span></a>
                          <div class="dz-progress"><span class="dz-upload" data-dz-uploadprogress=""></span></div>
                          <div class="dz-errormessage m-1 text-center"><span data-dz-errormessage="data-dz-errormessage"></span></div>
                        </div>
                        <div class="dz-progress"><span class="dz-upload" data-dz-uploadprogress=""></span></div>
                      </div>
                      <div class="dz-message fs-10" data-dz-message="data-dz-message"><img class="me-2" src="../../../assets/img/icons/cloud-upload.svg" width="20" alt="" /><span class="d-none d-lg-inline">Drag your .mp4 or .mkv file here<br/>or, </span><span class="btn btn-link p-0 fs-10">Browse</span></div>
                    </form><label class="form-label mt-3" for="video-link">or, paste youtube link here</label>
                    <div class="position-relative"><input class="form-control" id="video-link" type="url" placeholder="youtu.be/xXxxXxXXxxX" />
                ...
                <div class="card mb-3 mb-lg-0">
                  ...
                  <div class="card-body bg-body-tertiary">
                    <div class="row gx-2">
                      <div class="col-12 mb-3"><label class="form-label" for="base-price">Base Price <span data-bs-toggle="tooltip" data-bs-placement="top" title="Course regular price"><span class="fas fa-question-circle text-primary fs-10 ms-1"></span></span></label><input class="form-control" id="base-price" type="text" placeholder="" /></div>
                      <div class="col-12"><label class="form-label" for="discounted-price">Discounted Price <span data-bs-toggle="tooltip" data-bs-placement="top" title="Course discounted price"><span class="fas fa-question-circle text-primary fs-10 ms-1"></span></span></label><input class="form-control" id="discounted-price" type="text" placeholder="" /></div>
                      <div class="text-end"> <a class="fs-10 fw-medium" href="#schedule-discount-modal" data-bs-toggle="modal">Schedule Discount</a></div>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div class="card rounded-0 bottom-bar d-lg-none" data-bottom-bar='{"target":"course-publish-btn","breakPoint":"lg"}'>
            <div class="card-body py-2 px-0">
              <div class="container">
                <div class="row flex-between-center g-0">
                  <div class="col-auto"><a class="btn btn-link btn-sm text-secondary fw-medium px-0" href="#!">Save as Draft</a></div>
                  <div class="col-auto"><button class="btn btn-primary btn-md px-5 fw-medium" type="submit">Publish</button></div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
              ...
              <div class="modal-body p-4 bg-body-tertiary">
                <form class="row gx-3">
                  <div class="col-lg-6 mb-3"><label class="form-label" for="time-zone">Timezone</label><select class="form-select" id="time-zone">
                  ...
                  <div class="col-lg-6 mb-3"><label class="form-label" for="start-date">Start Date</label><input class="form-control datetimepicker" id="start-date" type="text" placeholder="dd/mm/yyyy" data-options='{"dateFormat":"d/m/y","disableMobile":true}' /></div>
                  <div class="col-lg-6 mb-3"><label class="form-label" for="start-time">Start Time</label><input class="form-control datetimepicker" id="start-time" type="text" placeholder="23 : 45" data-options='{"enableTime":true,"noCalendar":true,"dateFormat":"H:i","disableMobile":true}' /></div>
                  <div class="col-lg-6 mb-3"><label class="form-label" for="end-date">End Date</label><input class="form-control datetimepicker" id="end-date" type="text" placeholder="dd/mm/yyyy" data-options='{"dateFormat":"d/m/y","disableMobile":true}' /></div>
                  <div class="col-lg-6 mb-3"><label class="form-label" for="end-time">End Time</label><input class="form-control datetimepicker" id="end-time" type="text" placeholder="23 : 45" data-options='{"enableTime":true,"noCalendar":true,"dateFormat":"H:i","disableMobile":true}' /></div>
                </form>
              </div>
              <div class="modal-footer border-top text-start py-2 px-4 d-flex justify-content-end"><button class="btn btn-outline-secondary btn-md" data-bs-dismiss="modal"> <span class="fas fa-times me-1 fs-10"></span>Cancel</button><button class="btn btn-primary btn-md ms-2" type="submit"> <span class="fas fa-check me-1 fs-10"></span>Confirm</button></div>
            </div>
          </div>
        </div>
      </div>
...
<!-- Mirrored from prium.github.io/falcon/v3.21.0/app/e-learning/course/create-a-course.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 17 Oct 2024 20:05:41 GMT -->
</html>