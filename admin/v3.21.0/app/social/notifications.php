...
<!-- Mirrored from prium.github.io/falcon/v3.21.0/app/social/notifications.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 17 Oct 2024 20:04:45 GMT -->
              ...
              <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                ...
                <li class="nav-item"><!-- label-->
                  ...
                  <ul class="nav collapse show" id="social">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="notifications.html">
          ...
          <div class="card overflow-hidden">
            <div class="card-header bg-body-tertiary">
              <div class="row flex-between-center">
                ...
                <div class="col-sm-auto fs-10"><a class="font-sans-serif" href="#!">Mark all as read</a><a class="font-sans-serif ms-2 ms-sm-3" href="#notification-settings-modal" data-bs-toggle="modal">Notification settings</a></div>
              </div>
            </div>
            ...
            <div class="modal-content">
              ...
              <div class="modal-body p-4">
                <form class="text-start">
                  <div class="form-check lh-1 mb-0"><input class="form-check-input" type="radio" value="" id="always" name="notification-settings" checked="checked" /><label class="form-check-label mb-0" for="always">Get a notification each time there is activity on your page or an important update.</label></div>
                  ...
                  <h5 class="fs-9 mb-3 mt-4">Edit your notification settings for: </h5>
                  <ul class="list-group list-group-flush mb-4 fs-10">
                    <li class="list-group-item d-flex justify-content-between align-items-center py-2 px-0 border-200 bg-transparent"><span>New Mention of Page </span><span class="form-check fs-9 mb-0"><input class="form-check-input me-0" id="checkbox1" type="checkbox" name="checkbox1" checked="checked"/></span></li>
                    <li class="list-group-item d-flex justify-content-between align-items-center py-2 px-0 border-200 bg-transparent"><span>New Comments on page post</span><span class="form-check fs-9 mb-0"><input class="form-check-input me-0" id="checkbox2" type="checkbox" name="checkbox2" checked="checked"/></span></li>
                    <li class="list-group-item d-flex justify-content-between align-items-center py-2 px-0 border-200 bg-transparent"><span>Edits to Comments you have written</span><span class="form-check fs-9 mb-0"><input class="form-check-input me-0" id="checkbox3" type="checkbox" name="checkbox3" checked="checked"/></span></li>
                  </ul>
