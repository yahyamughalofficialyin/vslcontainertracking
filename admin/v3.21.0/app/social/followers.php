...
<!-- Mirrored from prium.github.io/falcon/v3.21.0/app/social/followers.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 17 Oct 2024 20:05:25 GMT -->
              ...
              <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                ...
                <li class="nav-item"><!-- label-->
                  ...
                  <ul class="nav collapse show" id="social">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="followers.html">
              ...
              <div class="row g-0 text-center fs-10">
                ...
                <div class="col-6 col-md-4 col-lg-3 col-xxl-2 mb-1">
                  <div class="bg-white dark__bg-1100 p-3 h-100"><a href="../../pages/user/profile.html"><img class="img-thumbnail img-fluid rounded-circle mb-3 shadow-sm" src="../../assets/img/team/17.jpg" alt="" width="100" /></a>
                    ...
                    <p class="fs-11 mb-1"><a class="text-700" href="#!">Musical Club</a></p>
                  </div>
                </div>
                <div class="col-6 col-md-4 col-lg-3 col-xxl-2 mb-1">
                  <div class="bg-white dark__bg-1100 p-3 h-100"><a href="../../pages/user/profile.html"><img class="img-thumbnail img-fluid rounded-circle mb-3 shadow-sm" src="../../assets/img/team/18.jpg" alt="" width="100" /></a>
                    ...
                    <p class="fs-11 mb-1"><a class="text-700" href="#!">Concert Choir</a></p>
                  </div>
                </div>
                <div class="col-6 col-md-4 col-lg-3 col-xxl-2 mb-1">
                  <div class="bg-white dark__bg-1100 p-3 h-100"><a href="../../pages/user/profile.html"><img class="img-thumbnail img-fluid rounded-circle mb-3 shadow-sm" src="../../assets/img/team/19.jpg" alt="" width="100" /></a>
                    ...
                    <p class="fs-11 mb-1"><a class="text-700" href="#!">Career Club</a></p>
                  </div>
                </div>
                <div class="col-6 col-md-4 col-lg-3 col-xxl-2 mb-1">
                ...
                <div class="col-6 col-md-4 col-lg-3 col-xxl-2 mb-1">
                  <div class="bg-white dark__bg-1100 p-3 h-100"><a href="../../pages/user/profile.html"><img class="img-thumbnail img-fluid rounded-circle mb-3 shadow-sm" src="../../assets/img/team/21.jpg" alt="" width="100" /></a>
                    <h6 class="mb-1"><a href="../../pages/user/profile.html">Rory McCann</a></h6>
                    <p class="fs-11 mb-1"><a class="text-700" href="#!">Alpine Ski Club</a></p>
                  </div>
                </div>
                <div class="col-6 col-md-4 col-lg-3 col-xxl-2 mb-1">
                ...
                <div class="col-6 col-md-4 col-lg-3 col-xxl-2 mb-1">
                  <div class="bg-white dark__bg-1100 p-3 h-100"><a href="../../pages/user/profile.html"><img class="img-thumbnail img-fluid rounded-circle mb-3 shadow-sm" src="../../assets/img/team/23.jpg" alt="" width="100" /></a>
                    ...
                    <p class="fs-11 mb-1"><a class="text-700" href="#!">Alpha Chi Omega</a></p>
                  </div>
                </div>
                <div class="col-6 col-md-4 col-lg-3 col-xxl-2 mb-1">
...
<!-- Mirrored from prium.github.io/falcon/v3.21.0/app/social/followers.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 17 Oct 2024 20:05:26 GMT -->
</html>