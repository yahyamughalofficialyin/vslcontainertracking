...
<!-- Mirrored from prium.github.io/falcon/v3.21.0/app/support-desk/tickets-preview.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 17 Oct 2024 20:05:27 GMT -->
              ...
              <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                ...
                <li class="nav-item"><!-- label-->
                  ...
                  <ul class="nav collapse show" id="support-desk">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="tickets-preview.html">
            ...
            <div class="col-xxl-9 col-xl-8">
              <div class="card">
                <div class="card-header d-flex flex-between-center"><button class="btn btn-falcon-default btn-sm" type="button"><span class="fas fa-arrow-left"></span></button>
                  <div class="d-flex"><button class="btn btn-falcon-default btn-sm" type="button"><span class="fas fa-object-ungroup" data-fa-transform="shrink-2"></span><span class="d-none d-md-inline-block ms-1">Merge</span></button><button class="btn btn-falcon-default btn-sm mx-2" type="button"><span class="fas fa-check" data-fa-transform="shrink-2 down-2"></span><span class="d-none d-md-inline-block ms-1">close</span></button><button class="btn btn-falcon-default btn-sm" type="button"><span class="fas fa-ban" data-fa-transform="shrink-2 down-1"></span><span class="d-none d-md-inline-block ms-1">Ban visitor</span></button><button class="btn btn-falcon-default btn-sm ms-2 d-none d-sm-block" type="button"><span class="fas fa-trash-alt" data-fa-transform="shrink-2 down-1"></span><span class="d-none d-md-inline-block ms-1">Delete</span></button>
                ...
                <div class="card-body">
                  <div class="d-md-flex d-xl-inline-block d-xxl-flex align-items-center justify-content-between mb-x1">
                    <div class="d-flex align-items-center gap-2"><a href="contact-details.html">
                      ...
                      <p class="mb-0"><a class="fw-semi-bold mb-0 text-800" href="contact-details.html">Emma Waston</a><span class="fs-11 text-800 fw-normal mx-2">via email</span><a class="mb-0 fs-10 d-block text-500" href="mailto:emma@watson.com">emma@watson.com</a></p>
                    </div>
                  ...
                  <div class="d-md-flex d-xl-inline-block d-xxl-flex align-items-center justify-content-between mb-x1">
                    <div class="d-flex align-items-center gap-2"><a href="contact-details.html">
                      ...
                      <p class="mb-0"><a class="fw-semi-bold mb-0 text-800" href="contact-details.html">Mike</a><span class="fs-11 text-800 fw-normal mx-2">replied</span><a class="mb-0 fs-10 d-block text-500" href="mailto:mike@support.com">mike@support.com</a></p>
                    </div>
                    ...
                    <div class="card-body">
                      ...
                      <div class="row g-0 justify-content-lg-between">
                        ...
                        <div class="col-auto col-md-6 col-lg-auto ps-md-5 ps-xl-0">
                          ...
                          <h6 class="d-flex align-items-center mb-1"><span class="me-2">Previous Tickets</span><span class="badge badge-subtle-info">Responded</span></h6><a class="text-truncate fs-10 font-sans-serif mb-1 d-block text-700" href="tickets-preview.html">When I unboxed my TV, I found a broken TV</a>
...
<!-- Mirrored from prium.github.io/falcon/v3.21.0/app/support-desk/tickets-preview.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 17 Oct 2024 20:05:28 GMT -->
</html>