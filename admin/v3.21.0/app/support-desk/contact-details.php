...
<!-- Mirrored from prium.github.io/falcon/v3.21.0/app/support-desk/contact-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 17 Oct 2024 20:05:27 GMT -->
              ...
              <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                ...
                <li class="nav-item"><!-- label-->
                  ...
                  <ul class="nav collapse show" id="support-desk">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="contact-details.html">
                    ...
                    <div class="card border rounded-3 bg-white dark__bg-1000 shadow-none">
                      ...
                      <div class="card-body row g-0 flex-column flex-sm-row flex-xl-column z-1 align-items-center">
                        ...
                        <div class="col-sm-8 col-md-6 col-lg-4 col-xl-12 ps-sm-1 ps-xl-0">
                          ...
                          <div class="d-flex gap-2 justify-content-center"><button class="btn btn-primary btn-sm px-2 text-nowrap w-50"><span class="fas fa-plus me-1" data-fa-transform="shrink-3 down-1"></span><span class="fs-11">New Ticket</span></button><button class="btn btn-sm btn-falcon-default w-50"><span class="fas fa-phone-alt me-1" data-fa-transform="shrink-4"></span><span class="fs-11">Call</span></button></div>
                        </div>
                      </div>
                    </div>
