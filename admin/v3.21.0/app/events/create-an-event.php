...
<!-- Mirrored from prium.github.io/falcon/v3.21.0/app/events/create-an-event.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 17 Oct 2024 20:05:43 GMT -->
                  ...
                  <div class="search-box" data-list='{"valueNames":["title"]}'>
                    ...
                    <div class="dropdown-menu border font-base start-0 mt-2 py-0 overflow-hidden w-100">
                      <div class="scrollbar list py-3" style="max-height: 24rem;">
                        <h6 class="dropdown-header fw-medium text-uppercase px-x1 fs-11 pt-0 pb-2">Recently Browsed</h6><a class="dropdown-item fs-10 px-x1 py-1 hover-primary" href="event-detail.html">
                      ...
                      <div class="scrollbar-overlay nine-dots-dropdown">
                        <div class="card-body px-3">
                          <div class="row text-center gx-0 gy-0">
                            ...
                            <div class="col-4"><a class="d-block hover-bg-200 px-2 py-3 rounded-3 text-center text-decoration-none" href="event-detail.html" target="_blank">
              ...
              <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                ...
                <li class="nav-item"><!-- label-->
                  ...
                  <ul class="nav collapse show" id="events">
                    ...
                    <li class="nav-item"><a class="nav-link" href="event-list.html">
          ...
          <div class="row g-0">
            <div class="col-lg-8 pe-lg-2">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body bg-body-tertiary">
                  <div class="border rounded-1 position-relative bg-body-emphasis p-3">
                    <div class="position-absolute end-0 top-0 mt-2 me-3 z-1"><button class="btn btn-link btn-sm p-0" type="button"><span class="fas fa-times-circle text-danger" data-fa-transform="shrink-1"></span></button></div>
                    <div class="row gx-2">
                      ...
                      <div class="col-sm-6 mb-3"><label class="form-label" for="schedule-start-date">Start Date</label><input class="form-control form-control-sm datetimepicker" id="schedule-start-date" type="text" placeholder="dd/mm/yy" data-options='{"dateFormat":"d/m/y","enableTime":false}' /></div>
                      ...
                      <div class="col-sm-6 mb-3 mb-sm-0"><label class="form-label" for="schedule-end-date">End Date</label><input class="form-control form-control-sm datetimepicker" id="schedule-end-date" type="text" placeholder="dd/mm/yy" data-options='{"dateFormat":"d/m/y","enableTime":false}' /></div>
                  ...
                  </div><button class="btn btn-falcon-default btn-sm mt-2" type="button"><span class="fas fa-plus fs-11 me-1" data-fa-transform="up-1"></span>Add Item </button>
                </div>
              </div>
              <div class="card mb-3">
                <div class="card-header">
              ...
              <div class="card mb-3 mb-lg-0">
                ...
                <div class="card-body bg-body-tertiary">
                  <div class="position-relative rounded-1 border bg-body-emphasis p-3">
                    <div class="position-absolute end-0 top-0 mt-2 me-3 z-1"><button class="btn btn-link btn-sm p-0" type="button"><span class="fas fa-times-circle text-danger" data-fa-transform="shrink-1"></span></button></div>
                    <div class="row gx-2">
                      ...
                      <div class="col-12"><label class="form-label" for="field-options">Field Options</label><textarea class="form-control form-control-sm" id="field-options" rows="3"></textarea>
                        <div class="form-text fs-10 text-warning">* Separate your options with comma</div>
                      </div>
                    </div>
                  </div><button class="btn btn-falcon-default btn-sm mt-2" type="submit"><span class="fas fa-plus fs-11 me-1" data-fa-transform="up-1"></span>Add Item</button>
                </div>
              </div>
            </div>
