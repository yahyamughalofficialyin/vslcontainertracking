...
<!-- Mirrored from prium.github.io/falcon/v3.21.0/app/chat.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 17 Oct 2024 20:05:08 GMT -->
            ...
            <div class="navbar-vertical-content scrollbar">
              <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                ...
                <li class="nav-item"><!-- label-->
                  ...
                  </a><!-- parent pages--><a class="nav-link active" href="chat.html" role="button">
            ...
            <div class="card-body d-flex p-0 h-100">
                  ...
                  <div class="nav nav-tabs border-0 flex-column" role="tablist" aria-orientation="vertical">
                    <div class="hover-actions-trigger chat-contact nav-item active" role="tab" id="chat-link-0" data-bs-toggle="tab" data-bs-target="#chat-0" aria-controls="chat-0" aria-selected="true">
                      <div class="d-md-none d-lg-block">
                        <div class="dropdown dropdown-active-trigger dropdown-chat"><button class="hover-actions btn btn-link btn-sm text-400 dropdown-caret-none dropdown-toggle end-0 fs-9 mt-4 me-1 z-1 pb-2 mb-n2" type="button" data-boundary="viewport" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><span class="fas fa-cog" data-fa-transform="shrink-3 down-4"></span></button>
                      ...
                      <div class="d-flex p-3">
                        ...
                        <div class="flex-1 chat-contact-body ms-2 d-md-none d-lg-block">
                          <div class="d-flex justify-content-between">
                            <h6 class="mb-0 chat-contact-title">Antony Hopkins</h6><span class="message-time fs-11">Tue</span>
                          </div>
                          <div class="min-w-0">
                    ...
                    <div class="hover-actions-trigger chat-contact nav-item" role="tab" id="chat-link-1" data-bs-toggle="tab" data-bs-target="#chat-1" aria-controls="chat-1" aria-selected="false">
                      ...
                      <div class="d-flex p-3">
                        ...
                        <div class="flex-1 chat-contact-body ms-2 d-md-none d-lg-block">
                          <div class="d-flex justify-content-between">
                            <h6 class="mb-0 chat-contact-title">Avengers</h6><span class="message-time fs-11">Sun</span>
                          </div>
                          <div class="min-w-0">
                    ...
                    <div class="hover-actions-trigger chat-contact nav-item" role="tab" id="chat-link-2" data-bs-toggle="tab" data-bs-target="#chat-2" aria-controls="chat-2" aria-selected="false">
                      ...
                      <div class="d-flex p-3">
                        ...
                        <div class="flex-1 chat-contact-body ms-2 d-md-none d-lg-block">
                          <div class="d-flex justify-content-between">
                            <h6 class="mb-0 chat-contact-title">Emma Watson</h6><span class="message-time fs-11">Sun</span>
                          </div>
                          <div class="min-w-0">
                    ...
                    <div class="hover-actions-trigger chat-contact nav-item unread-message" role="tab" id="chat-link-3" data-bs-toggle="tab" data-bs-target="#chat-3" aria-controls="chat-3" aria-selected="false">
                      ...
                      <div class="d-flex p-3">
                        ...
                        <div class="flex-1 chat-contact-body ms-2 d-md-none d-lg-block">
                          <div class="d-flex justify-content-between">
                            <h6 class="mb-0 chat-contact-title">Anna Karinina</h6><span class="message-time fs-11">Sat</span>
                          </div>
                          <div class="min-w-0">
                    ...
                    <div class="hover-actions-trigger chat-contact nav-item unread-message" role="tab" id="chat-link-4" data-bs-toggle="tab" data-bs-target="#chat-4" aria-controls="chat-4" aria-selected="false">
                      ...
                      <div class="d-flex p-3">
                        ...
                        <div class="flex-1 chat-contact-body ms-2 d-md-none d-lg-block">
                          <div class="d-flex justify-content-between">
                            <h6 class="mb-0 chat-contact-title">John Lee</h6><span class="message-time fs-11">Mon</span>
                          </div>
                          <div class="min-w-0">
                    ...
                    <div class="hover-actions-trigger chat-contact nav-item" role="tab" id="chat-link-5" data-bs-toggle="tab" data-bs-target="#chat-5" aria-controls="chat-5" aria-selected="false">
                      ...
                      <div class="d-flex p-3">
                        ...
                        <div class="flex-1 chat-contact-body ms-2 d-md-none d-lg-block">
                          <div class="d-flex justify-content-between">
                            <h6 class="mb-0 chat-contact-title">Bucky Robert</h6><span class="message-time fs-11">Wed</span>
                          </div>
                          <div class="min-w-0">
                            <div class="chat-contact-content pe-3">You: 👋</div>
                    ...
                    <div class="hover-actions-trigger chat-contact nav-item" role="tab" id="chat-link-6" data-bs-toggle="tab" data-bs-target="#chat-6" aria-controls="chat-6" aria-selected="false">
                      ...
                      <div class="d-flex p-3">
                        ...
                        <div class="flex-1 chat-contact-body ms-2 d-md-none d-lg-block">
                          <div class="d-flex justify-content-between">
                            <h6 class="mb-0 chat-contact-title">John Bradley</h6><span class="message-time fs-11">Fri</span>
                          </div>
                          <div class="min-w-0">
                    ...
                    <div class="hover-actions-trigger chat-contact nav-item" role="tab" id="chat-link-7" data-bs-toggle="tab" data-bs-target="#chat-7" aria-controls="chat-7" aria-selected="false">
                      ...
                      <div class="d-flex p-3">
                        ...
                        <div class="flex-1 chat-contact-body ms-2 d-md-none d-lg-block">
                          <div class="d-flex justify-content-between">
                            <h6 class="mb-0 chat-contact-title">Rory McCann</h6><span class="message-time fs-11">Sun</span>
                          </div>
                          <div class="min-w-0">
                            <div class="chat-contact-content pe-3">You: 😮</div>
                            <div class="position-absolute bottom-0 end-0 hover-hide"><span class="fas fa-check text-400" data-fa-transform="shrink-5 down-4"></span></div>
                    ...
                    <div class="hover-actions-trigger chat-contact nav-item" role="tab" id="chat-link-8" data-bs-toggle="tab" data-bs-target="#chat-8" aria-controls="chat-8" aria-selected="false">
                      ...
                      <div class="d-flex p-3">
                        ...
                        <div class="flex-1 chat-contact-body ms-2 d-md-none d-lg-block">
                          <div class="d-flex justify-content-between">
                            <h6 class="mb-0 chat-contact-title">Joe Bempsie</h6><span class="message-time fs-11">Wed</span>
                          </div>
                          <div class="min-w-0">
                            <div class="chat-contact-content pe-3">Hello!</div>
                            <div class="position-absolute bottom-0 end-0 hover-hide"></div>
                    ...
                    <div class="hover-actions-trigger chat-contact nav-item" role="tab" id="chat-link-9" data-bs-toggle="tab" data-bs-target="#chat-9" aria-controls="chat-9" aria-selected="false">
                      ...
                      <div class="d-flex p-3">
                        ...
                        <div class="flex-1 chat-contact-body ms-2 d-md-none d-lg-block">
                          <div class="d-flex justify-content-between">
                            <h6 class="mb-0 chat-contact-title">Diana Rigg</h6><span class="message-time fs-11">Mon</span>
                          </div>
                          <div class="min-w-0">
              ...
              <div class="tab-content card-chat-content">
                  ...
                  <div class="chat-content-header">
                    <div class="row flex-between-center">
                      <div class="col-6 col-sm-8 d-flex align-items-center"><a class="pe-3 text-700 d-md-none contacts-list-show" href="#!">
                        ...
                        <div class="min-w-0">
                          <h5 class="mb-0 text-truncate fs-9">Antony Hopkins</h5>
                      ...
                      <div class="h-100 overflow-auto scrollbar">
                        <div class="d-flex position-relative align-items-center p-3 border-bottom">
                          ...
                          <div class="flex-1 ms-2 d-flex flex-between-center">
                            ...
                            <div class="dropdown z-1"><button class="btn btn-link btn-sm text-400 dropdown-toggle dropdown-caret-none me-n3" type="button" id="profile-dropdown-0" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><span class="fas fa-cog"></span></button>
                      ...
                      <div class="d-flex p-3">
                        <div class="flex-1 d-flex justify-content-end">
                          <div class="w-100 w-xxl-75">
                            ...
                            <div class="text-400 fs-11 text-end">11:54 am<span class="fas fa-check ms-2 text-success"></span></div>
                          </div>
                        </div>
                      </div>
                      <div class="d-flex p-3">
                        <div class="flex-1 d-flex justify-content-end">
                          <div class="w-100 w-xxl-75">
                            <div class="hover-actions-trigger d-flex flex-end-center">
                              ...
                              <div class="bg-primary text-white p-2 rounded-2 chat-message" data-bs-theme="light">Nothing!</div>
                            </div>
                            <div class="text-400 fs-11 text-end">11:54 am<span class="fas fa-check ms-2 text-success"></span></div>
                          </div>
                        </div>
                      ...
                      <div class="d-flex p-3">
                        <div class="flex-1 d-flex justify-content-end">
                          <div class="w-100 w-xxl-75">
                            ...
                            <div class="text-400 fs-11 text-end">11:54 am<span class="fas fa-check-double ms-2"></span></div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="d-flex p-3">
                        <div class="flex-1 d-flex justify-content-end">
                          <div class="w-100 w-xxl-75">
                            ...
                            <div class="text-400 fs-11 text-end">11:54 am<span class="fas fa-check ms-2"></span></div>
                          </div>
                        </div>
                      </div>
                      <div class="d-flex p-3">
                        ...
                        <div class="flex-1 d-flex justify-content-end">
                          <div class="w-100 w-xxl-75">
                            <div class="hover-actions-trigger d-flex flex-end-center">
                              ...
                              <div class="bg-primary text-white p-2 rounded-2 chat-message" data-bs-theme="light">Give me the images.</div>
                            </div>
                  ...
                  <div class="chat-content-header">
                    <div class="row flex-between-center">
                      <div class="col-6 col-sm-8 d-flex align-items-center"><a class="pe-3 text-700 d-md-none contacts-list-show" href="#!">
                        ...
                        <div class="min-w-0">
                          <h5 class="mb-0 text-truncate fs-9">Avengers</h5>
                          <div class="fs-11 text-400">Active 7h ago</div>
                        </div>
                      </div>
                      ...
                      <div class="h-100 overflow-auto scrollbar">
                        <div class="d-flex position-relative align-items-center p-3 border-bottom">
                          ...
                          <div class="flex-1 ms-2 d-flex flex-between-center">
                            ...
                            <div class="dropdown z-1"><button class="btn btn-link btn-sm text-400 dropdown-toggle dropdown-caret-none me-n3" type="button" id="profile-dropdown-1" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><span class="fas fa-cog"></span></button>
                          ...
                          <div class="collapse" id="members-1" aria-labelledby="member-title-1" data-parent="#others-info-1">
                            <div class="d-flex align-items-center py-2 hover-actions-trigger">
                              ...
                              <div class="flex-1 ms-2 d-flex justify-content-between">
                                <div>
                                  ...
                                  <div class="fs-11 text-400">Admin</div>
                                </div>
                                <div class="dropdown hover-actions position-relative dropdown-active-trigger z-1"><button class="btn btn-link btn-sm text-400 dropdown-toggle dropdown-caret-none" type="button" id="user-settings-dropdown-0" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><span class="fas fa-ellipsis-h"></span></button>
                            ...
                            <div class="d-flex align-items-center py-2 hover-actions-trigger">
                              ...
                              <div class="flex-1 ms-2 d-flex justify-content-between">
                                <div>
                                  ...
                                  <div class="fs-11 text-400">Member</div>
                                </div>
                                <div class="dropdown hover-actions position-relative dropdown-active-trigger z-1"><button class="btn btn-link btn-sm text-400 dropdown-toggle dropdown-caret-none" type="button" id="user-settings-dropdown-1" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><span class="fas fa-ellipsis-h"></span></button>
                            ...
                            <div class="d-flex align-items-center py-2 hover-actions-trigger">
                              ...
                              <div class="flex-1 ms-2 d-flex justify-content-between">
                                ...
                                <div class="dropdown hover-actions position-relative dropdown-active-trigger z-1"><button class="btn btn-link btn-sm text-400 dropdown-toggle dropdown-caret-none" type="button" id="user-settings-dropdown-2" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><span class="fas fa-ellipsis-h"></span></button>
                            ...
                            <div class="d-flex align-items-center py-2 hover-actions-trigger">
                              ...
                              <div class="flex-1 ms-2 d-flex justify-content-between">
                                ...
                                <div class="dropdown hover-actions position-relative dropdown-active-trigger z-1"><button class="btn btn-link btn-sm text-400 dropdown-toggle dropdown-caret-none" type="button" id="user-settings-dropdown-3" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><span class="fas fa-ellipsis-h"></span></button>
                            ...
                            <div class="d-flex align-items-center py-2 hover-actions-trigger">
                              ...
                              <div class="flex-1 ms-2 d-flex justify-content-between">
                                ...
                                <div class="dropdown hover-actions position-relative dropdown-active-trigger z-1"><button class="btn btn-link btn-sm text-400 dropdown-toggle dropdown-caret-none" type="button" id="user-settings-dropdown-4" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><span class="fas fa-ellipsis-h"></span></button>
                      ...
                      <div class="d-flex p-3">
                        ...
                        <div class="flex-1">
                          <div class="w-xxl-75">
                            ...
                            <div class="text-400 fs-11"><span class="fw-semi-bold me-2">Anna</span><span>11:54 am</span></div>
                          </div>
                        </div>
                      </div>
                      <div class="d-flex p-3">
                        <div class="flex-1 d-flex justify-content-end">
                          <div class="w-100 w-xxl-75">
                            <div class="hover-actions-trigger d-flex flex-end-center">
                              ...
                              <div class="bg-primary text-white p-2 rounded-2 chat-message" data-bs-theme="light">Your are right 👍</div>
                            </div>
                            <div class="text-400 fs-11 text-end">11:54 am<span class="fas fa-check ms-2 text-success"></span></div>
                          </div>
                        </div>
                      ...
                      <div class="d-flex p-3">
                        ...
                        <div class="flex-1">
                          <div class="w-xxl-75">
                            ...
                            <div class="text-400 fs-11"><span class="fw-semi-bold me-2">Antony</span><span>11:54 am</span></div>
                          </div>
                        </div>
                      </div>
                      <div class="d-flex p-3">
                        ...
                        <div class="flex-1">
                          <div class="w-xxl-75">
                            ...
                            <div class="text-400 fs-11"><span class="fw-semi-bold me-2">John</span><span>11:54 am</span></div>
                          </div>
                        </div>
                      </div>
                      <div class="text-center fs-11 text-500"><span>May 7, 2019, 11:54 am</span></div>
                        ...
                        <div class="flex-1 d-flex justify-content-end">
                          <div class="w-100 w-xxl-75">
                            <div class="hover-actions-trigger d-flex flex-end-center">
                              ...
                              <div class="bg-primary text-white p-2 rounded-2 chat-message" data-bs-theme="light">I can help you to do this.</div>
                            </div>
                            <div class="text-400 fs-11 text-end">11:54 am<span class="fas fa-check ms-2 text-success"></span></div>
                          </div>
                        </div>
                      ...
                      <div class="d-flex p-3">
                        ...
                        <div class="flex-1">
                          <div class="w-xxl-75">
                            ...
                            <div class="text-400 fs-11"><span class="fw-semi-bold me-2">Emma</span><span>11:54 am</span></div>
                          </div>
                        </div>
                      </div>
                      <div class="d-flex p-3">
                        ...
                        <div class="flex-1">
                          <div class="w-xxl-75">
                            ...
                            <div class="text-400 fs-11"><span class="fw-semi-bold me-2">Bucky</span><span>11:54 am</span></div>
                          </div>
                        </div>
                      </div>
                      <div class="d-flex p-3">
                  ...
                  <div class="chat-content-header">
                    <div class="row flex-between-center">
                      <div class="col-6 col-sm-8 d-flex align-items-center"><a class="pe-3 text-700 d-md-none contacts-list-show" href="#!">
                        ...
                        <div class="min-w-0">
                          <h5 class="mb-0 text-truncate fs-9">Emma Watson</h5>
                          <div class="fs-11 text-400">Active 7h ago</div>
                        </div>
                      </div>
                      ...
                      <div class="h-100 overflow-auto scrollbar">
                        <div class="d-flex position-relative align-items-center p-3 border-bottom">
                          ...
                          <div class="flex-1 ms-2 d-flex flex-between-center">
                            ...
                            <div class="dropdown z-1"><button class="btn btn-link btn-sm text-400 dropdown-toggle dropdown-caret-none me-n3" type="button" id="profile-dropdown-2" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><span class="fas fa-cog"></span></button>
                        ...
                        <div class="flex-1 d-flex justify-content-end">
                          <div class="w-100 w-xxl-75">
                            <div class="hover-actions-trigger d-flex flex-end-center">
                              ...
                              <div class="bg-primary text-white p-2 rounded-2 chat-message" data-bs-theme="light">Hello</div>
                            </div>
                            <div class="text-400 fs-11 text-end">11:54 am<span class="fas fa-check ms-2 text-success"></span></div>
                          </div>
                        </div>
                        ...
                        <div class="flex-1 d-flex justify-content-end">
                          <div class="w-100 w-xxl-75">
                            <div class="hover-actions-trigger d-flex flex-end-center">
                              ...
                              <div class="bg-primary text-white p-2 rounded-2 chat-message" data-bs-theme="light">🙂</div>
                            </div>
                            <div class="text-400 fs-11 text-end">11:54 am<span class="fas fa-check ms-2 text-success"></span></div>
                          </div>
                        </div>
                  ...
                  <div class="chat-content-header">
                    <div class="row flex-between-center">
                      <div class="col-6 col-sm-8 d-flex align-items-center"><a class="pe-3 text-700 d-md-none contacts-list-show" href="#!">
                        ...
                        <div class="min-w-0">
                          <h5 class="mb-0 text-truncate fs-9">Anna Karinina</h5>
                          <div class="fs-11 text-400">Active On Chat</div>
                        </div>
                      </div>
                      ...
                      <div class="h-100 overflow-auto scrollbar">
                        <div class="d-flex position-relative align-items-center p-3 border-bottom">
                          ...
                          <div class="flex-1 ms-2 d-flex flex-between-center">
                            ...
                            <div class="dropdown z-1"><button class="btn btn-link btn-sm text-400 dropdown-toggle dropdown-caret-none me-n3" type="button" id="profile-dropdown-3" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><span class="fas fa-cog"></span></button>
                  ...
                  <div class="chat-content-header">
                    <div class="row flex-between-center">
                      <div class="col-6 col-sm-8 d-flex align-items-center"><a class="pe-3 text-700 d-md-none contacts-list-show" href="#!">
                        ...
                        <div class="min-w-0">
                          <h5 class="mb-0 text-truncate fs-9">John Lee</h5>
                          <div class="fs-11 text-400">Active On Chat</div>
                        </div>
                      </div>
                      ...
                      <div class="h-100 overflow-auto scrollbar">
                        <div class="d-flex position-relative align-items-center p-3 border-bottom">
                          ...
                          <div class="flex-1 ms-2 d-flex flex-between-center">
                            ...
                            <div class="dropdown z-1"><button class="btn btn-link btn-sm text-400 dropdown-toggle dropdown-caret-none me-n3" type="button" id="profile-dropdown-4" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><span class="fas fa-cog"></span></button>
                        ...
                        <div class="flex-1 d-flex justify-content-end">
                          <div class="w-100 w-xxl-75">
                            <div class="hover-actions-trigger d-flex flex-end-center">
                              ...
                              <div class="bg-primary text-white p-2 rounded-2 chat-message" data-bs-theme="light">Hey!</div>
                            </div>
                            <div class="text-400 fs-11 text-end">11:54 am<span class="fas fa-check ms-2"></span></div>
                          </div>
                        </div>
                  ...
                  <div class="chat-content-header">
                    <div class="row flex-between-center">
                      <div class="col-6 col-sm-8 d-flex align-items-center"><a class="pe-3 text-700 d-md-none contacts-list-show" href="#!">
                        ...
                        <div class="min-w-0">
                          <h5 class="mb-0 text-truncate fs-9">Bucky Robert</h5>
                          <div class="fs-11 text-400">Active On Chat</div>
                        </div>
                      </div>
                      ...
                      <div class="h-100 overflow-auto scrollbar">
                        <div class="d-flex position-relative align-items-center p-3 border-bottom">
                          ...
                          <div class="flex-1 ms-2 d-flex flex-between-center">
                            ...
                            <div class="dropdown z-1"><button class="btn btn-link btn-sm text-400 dropdown-toggle dropdown-caret-none me-n3" type="button" id="profile-dropdown-5" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><span class="fas fa-cog"></span></button>
                  ...
                  <div class="chat-content-header">
                    <div class="row flex-between-center">
                      <div class="col-6 col-sm-8 d-flex align-items-center"><a class="pe-3 text-700 d-md-none contacts-list-show" href="#!">
                        ...
                        <div class="min-w-0">
                          <h5 class="mb-0 text-truncate fs-9">John Bradley</h5>
                          <div class="fs-11 text-400">Active On Chat</div>
                        </div>
                      </div>
                      ...
                      <div class="h-100 overflow-auto scrollbar">
                        <div class="d-flex position-relative align-items-center p-3 border-bottom">
                          ...
                          <div class="flex-1 ms-2 d-flex flex-between-center">
                            ...
                            <div class="dropdown z-1"><button class="btn btn-link btn-sm text-400 dropdown-toggle dropdown-caret-none me-n3" type="button" id="profile-dropdown-6" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><span class="fas fa-cog"></span></button>
                  ...
                  <div class="chat-content-header">
                    <div class="row flex-between-center">
                      <div class="col-6 col-sm-8 d-flex align-items-center"><a class="pe-3 text-700 d-md-none contacts-list-show" href="#!">
                        ...
                        <div class="min-w-0">
                          <h5 class="mb-0 text-truncate fs-9">Rory McCann</h5>
                          <div class="fs-11 text-400">Active On Chat</div>
                        </div>
                      </div>
                      ...
                      <div class="h-100 overflow-auto scrollbar">
                        <div class="d-flex position-relative align-items-center p-3 border-bottom">
                          ...
                          <div class="flex-1 ms-2 d-flex flex-between-center">
                            ...
                            <div class="dropdown z-1"><button class="btn btn-link btn-sm text-400 dropdown-toggle dropdown-caret-none me-n3" type="button" id="profile-dropdown-7" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><span class="fas fa-cog"></span></button>
                  ...
                  <div class="chat-content-header">
                    <div class="row flex-between-center">
                      <div class="col-6 col-sm-8 d-flex align-items-center"><a class="pe-3 text-700 d-md-none contacts-list-show" href="#!">
                        ...
                        <div class="min-w-0">
                          <h5 class="mb-0 text-truncate fs-9">Joe Bempsie</h5>
                          <div class="fs-11 text-400">Active 7h ago</div>
                        </div>
                      </div>
                      ...
                      <div class="h-100 overflow-auto scrollbar">
                        <div class="d-flex position-relative align-items-center p-3 border-bottom">
                          ...
                          <div class="flex-1 ms-2 d-flex flex-between-center">
                            ...
                            <div class="dropdown z-1"><button class="btn btn-link btn-sm text-400 dropdown-toggle dropdown-caret-none me-n3" type="button" id="profile-dropdown-8" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><span class="fas fa-cog"></span></button>
                  ...
                  <div class="chat-content-header">
                    <div class="row flex-between-center">
                      <div class="col-6 col-sm-8 d-flex align-items-center"><a class="pe-3 text-700 d-md-none contacts-list-show" href="#!">
                        ...
                        <div class="min-w-0">
                          <h5 class="mb-0 text-truncate fs-9">Diana Rigg</h5>
                          <div class="fs-11 text-400">Active 7h ago</div>
                        </div>
                      </div>
                      ...
                      <div class="h-100 overflow-auto scrollbar">
                        <div class="d-flex position-relative align-items-center p-3 border-bottom">
                          ...
                          <div class="flex-1 ms-2 d-flex flex-between-center">
                            ...
                            <div class="dropdown z-1"><button class="btn btn-link btn-sm text-400 dropdown-toggle dropdown-caret-none me-n3" type="button" id="profile-dropdown-9" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><span class="fas fa-cog"></span></button>
                  ...
                  <div class="chat-content-header">
                    <div class="row flex-between-center">
                      <div class="col-6 col-sm-8 d-flex align-items-center"><a class="pe-3 text-700 d-md-none contacts-list-show" href="#!">
                        ...
                        <div class="min-w-0">
                          <h5 class="mb-0 text-truncate fs-9">Gemma Whelan</h5>
                          <div class="fs-11 text-400">Active 7h ago</div>
                        </div>
                      </div>
                      ...
                      <div class="h-100 overflow-auto scrollbar">
                        <div class="d-flex position-relative align-items-center p-3 border-bottom">
                          ...
                          <div class="flex-1 ms-2 d-flex flex-between-center">
                            ...
                            <div class="dropdown z-1"><button class="btn btn-link btn-sm text-400 dropdown-toggle dropdown-caret-none me-n3" type="button" id="profile-dropdown-10" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><span class="fas fa-cog"></span></button>
                ...
                <form class="chat-editor-area">
                  ...
                  </div><button class="btn btn-sm btn-send shadow-none" type="submit">Send</button>
                </form>
              </div>
            </div>
          </div>
...
<!-- Mirrored from prium.github.io/falcon/v3.21.0/app/chat.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 17 Oct 2024 20:05:16 GMT -->
</html>