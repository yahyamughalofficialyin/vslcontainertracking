...
<!-- Mirrored from prium.github.io/falcon/v3.21.0/app/e-commerce/checkout.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 17 Oct 2024 20:05:52 GMT -->
              ...
              <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                ...
                <li class="nav-item"><!-- label-->
                  ...
                  <ul class="nav collapse show" id="e-commerce">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="checkout.html">
          ...
          <div class="row g-3">
            <div class="col-xl-4 order-xl-1">
              <div class="card">
                <div class="card-header bg-body-tertiary d-flex flex-between-center">
                  <h5 class="mb-0">Order Summary</h5><a class="btn btn-falcon-default btn-sm text-600" href="shopping-cart.html"><span class="fas fa-pencil-alt"></span></a>
                </div>
                <div class="card-body">
            ...
            <div class="col-xl-8">
                ...
                <div class="card-body">
                  <div class="row">
                    <div class="col-md-6 mb-3 mb-md-0">
                      <div class="form-check mb-0 custom-radio radio-select"><input class="form-check-input" id="address-1" type="radio" name="clientName" checked="checked" /><label class="form-check-label mb-0 fw-bold d-block" for="address-1">Antony Hopkins<span class="radio-select-content"><span> 2392 Main Avenue,<br/>Pensaukee,<br/>New Jersey 02139<span class="d-block mb-0 pt-2">+(856) 929-229</span></span></span></label><a class="fs-10" href="#!">Edit</a></div>
                    </div>
                    <div class="col-md-6">
                      <div class="position-relative">
                        <div class="form-check mb-0 custom-radio radio-select"><input class="form-check-input" id="address-2" type="radio" name="clientName" /><label class="form-check-label mb-0 fw-bold d-block" for="address-2">Robert Bruce<span class="radio-select-content"><span>3448 Ile De France St #242<br/>Fort Wainwright, <br/>Alaska, 99703<span class="d-block mb-0 pt-2">+(901) 637-734</span></span></span></label><a class="fs-10" href="#!">Edit</a></div>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="card">
                ...
                <div class="card-body">
                  <form>
                    <div class="form-check mb-0"><input class="form-check-input" type="radio" value="" id="credit-card" checked="checked" name="payment-method" /><label class="form-check-label mb-2 fs-8" for="credit-card">Credit Card</label></div>
                    <div class="row gx-0 ps-2 mb-4">
                      ...
                      <div class="col-4 ps-3 text-center pt-2 d-none d-sm-block">
                        <div class="rounded-1 p-2 mt-3 bg-100">
                          <div class="text-uppercase fs-11 fw-bold">We Accept</div><img src="../../assets/img/icons/icon-payment-methods-grid.png" alt="" width="120" />
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-5 col-xl-12 col-xxl-5 ps-lg-4 ps-xl-2 ps-xxl-5 text-center text-md-start text-xl-center text-xxl-start">
                        ...
                        <div class="fs-7 fw-semi-bold">All Total: <span class="text-primary">$3320</span></div><button class="btn btn-success mt-3 px-5" type="submit">Confirm &amp; Pay</button>
...
<!-- Mirrored from prium.github.io/falcon/v3.21.0/app/e-commerce/checkout.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 17 Oct 2024 20:05:53 GMT -->
</html>