...
<!-- Mirrored from prium.github.io/falcon/v3.21.0/app/e-commerce/product/product-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 17 Oct 2024 20:05:49 GMT -->
                  ...
                  <ul class="nav collapse show" id="e-commerce">
                    <li class="nav-item"><a class="nav-link dropdown-indicator" href="#product" data-bs-toggle="collapse" aria-expanded="true" aria-controls="e-commerce">
                      ...
                      <ul class="nav collapse show" id="product">
                        <li class="nav-item"><a class="nav-link active" href="product-list.html">
              ...
              <div class="row flex-between-center">
                ...
                <div class="col-sm-auto">
                  <div class="row gx-2 align-items-center">
                    ...
                    <div class="col-auto pe-0"><a class="text-600 px-1" href="product-grid.html" data-bs-toggle="tooltip" title="Product Grid"><span class="fas fa-th"></span></a></div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="card-body p-0 overflow-hidden">
              <div class="row g-0">
                <div class="col-12 p-x1">
                  <div class="row">
                    <div class="col-sm-5 col-md-4">
                      <div class="position-relative h-sm-100"><a class="d-block h-100" href="product-details.html"><img class="img-fluid object-fit-cover w-sm-100 h-sm-100 rounded-1 absolute-sm-centered" src="../../../assets/img/products/2.jpg" alt="" /></a>
                    ...
                    <div class="col-sm-7 col-md-8">
                      <div class="row">
                        <div class="col-lg-8">
                          <h5 class="mt-3 mt-sm-0"><a class="text-1100 fs-9 fs-lg-8" href="product-details.html">Apple iMac Pro (27-inch with Retina 5K Display, 3.0GHz 10-core Intel Xeon W, 1TB SSD)</a></h5>
                          <p class="fs-10 mb-2 mb-md-3"><a class="text-500" href="#!">Computer &amp; Accessories</a></p>
                        ...
                        <div class="col-lg-4 d-flex justify-content-between flex-column">
                          <div>
                            <h4 class="fs-8 fs-md-7 text-warning mb-0">$1199.5</h4>
                            <h5 class="fs-10 text-500 mb-0 mt-1"><del>$2399 </del><span class="ms-1">-50%</span></h5>
                  ...
                  <div class="row">
                    <div class="col-sm-5 col-md-4">
                      <div class="position-relative h-sm-100">
                        <div class="swiper theme-slider h-100" data-swiper='{"autoplay":true,"autoHeight":true,"spaceBetween":5,"loop":true,"loopedSlides":5,"navigation":{"nextEl":".swiper-button-next","prevEl":".swiper-button-prev"}}'>
                          <div class="swiper-wrapper h-100">
                            <div class="swiper-slide h-100"><a class="d-block h-sm-100" href="product-details.html"><img class="rounded-1 h-100 w-100 object-fit-cover" src="../../../assets/img/products/1.jpg" alt="" /></a></div>
                            <div class="swiper-slide h-100"><a class="d-block h-sm-100" href="product-details.html"><img class="rounded-1 h-100 w-100 object-fit-cover" src="../../../assets/img/products/1-2.jpg" alt="" /></a></div>
                            <div class="swiper-slide h-100"><a class="d-block h-sm-100" href="product-details.html"><img class="rounded-1 h-100 w-100 object-fit-cover" src="../../../assets/img/products/1-3.jpg" alt="" /></a></div>
                          </div>
                    ...
                    <div class="col-sm-7 col-md-8">
                      <div class="row">
                        <div class="col-lg-8">
                          <h5 class="mt-3 mt-sm-0"><a class="text-1100 fs-9 fs-lg-8" href="product-details.html">Apple MacBook Pro (15&quot; Retina, Touch Bar, 2.2GHz 6-Core Intel Core i7, 16GB RAM, 256GB SSD) - Space Gray (Latest Model)</a></h5>
                          <p class="fs-10 mb-2 mb-md-3"><a class="text-500" href="#!">Computer &amp; Accessories</a></p>
                          <ul class="list-unstyled d-none d-lg-block">
                            <li><span class="fas fa-circle" data-fa-transform="shrink-12"></span><span>16GB RAM</span></li>
                        ...
                        <div class="col-lg-4 d-flex justify-content-between flex-column">
                          <div>
                            <h4 class="fs-8 fs-md-7 text-warning mb-0">$7199</h4>
                ...
                <div class="col-12 p-x1">
                  <div class="row">
                    <div class="col-sm-5 col-md-4">
                      <div class="position-relative h-sm-100"><a class="d-block h-100" href="product-details.html"><img class="img-fluid object-fit-cover w-sm-100 h-sm-100 rounded-1 absolute-sm-centered" src="../../../assets/img/products/4.jpg" alt="" /></a></div>
                    </div>
                    <div class="col-sm-7 col-md-8">
                      <div class="row">
                        <div class="col-lg-8">
                          <h5 class="mt-3 mt-sm-0"><a class="text-1100 fs-9 fs-lg-8" href="product-details.html">Apple iPad Air 2019 (3GB RAM, 128GB ROM, 8MP Main Camera)</a></h5>
                          <p class="fs-10 mb-2 mb-md-3"><a class="text-500" href="#!">Mobile &amp; Tabs</a></p>
                          <ul class="list-unstyled d-none d-lg-block">
                        ...
                        <div class="col-lg-4 d-flex justify-content-between flex-column">
                          <div>
                            <h4 class="fs-8 fs-md-7 text-warning mb-0">$562.5</h4>
                            <h5 class="fs-10 text-500 mb-0 mt-1"><del>$750 </del><span class="ms-1">-25%</span></h5>
                ...
                <div class="col-12 p-x1 bg-100">
                  <div class="row">
                    <div class="col-sm-5 col-md-4">
                      <div class="position-relative h-sm-100"><a class="d-block h-100" href="product-details.html"><img class="img-fluid object-fit-cover w-sm-100 h-sm-100 rounded-1 absolute-sm-centered" src="../../../assets/img/products/3.jpg" alt="" /></a></div>
                    </div>
                    <div class="col-sm-7 col-md-8">
                      <div class="row">
                        <div class="col-lg-8">
                          <h5 class="mt-3 mt-sm-0"><a class="text-1100 fs-9 fs-lg-8" href="product-details.html">Apple iPhone XS Max (4GB RAM, 512GB ROM, 12MP Main Camera)</a></h5>
                          <p class="fs-10 mb-2 mb-md-3"><a class="text-500" href="#!">Mobile &amp; Tabs</a></p>
                          <ul class="list-unstyled d-none d-lg-block">
                        ...
                        <div class="col-lg-4 d-flex justify-content-between flex-column">
                          <div>
                            <h4 class="fs-8 fs-md-7 text-warning mb-0">$1050</h4>
