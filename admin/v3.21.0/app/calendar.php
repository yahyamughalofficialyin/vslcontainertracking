...
<!-- Mirrored from prium.github.io/falcon/v3.21.0/app/calendar.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 17 Oct 2024 20:05:08 GMT -->
            ...
            <div class="navbar-vertical-content scrollbar">
              <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                ...
                <li class="nav-item"><!-- label-->
                  ...
                  </div><!-- parent pages--><a class="nav-link active" href="calendar.html" role="button">
          ...
          <div class="modal-dialog">
            <div class="modal-content border">
              <form id="addEventForm" autocomplete="off">
                ...
                <div class="modal-footer d-flex justify-content-end align-items-center bg-body-tertiary border-0"><a class="me-3 text-600" href="events/create-an-event.html">More options</a><button class="btn btn-primary px-4" type="submit">Save</button></div>
              </form>
            </div>
          </div>
        </div>
