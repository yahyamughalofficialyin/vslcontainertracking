...
<!-- Mirrored from prium.github.io/falcon/v3.21.0/pages/user/profile.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 17 Oct 2024 20:04:39 GMT -->
                  ...
                  <div class="search-box" data-list='{"valueNames":["title"]}'>
                    ...
                    <div class="dropdown-menu border font-base start-0 mt-2 py-0 overflow-hidden w-100">
                      <div class="scrollbar list py-3" style="max-height: 24rem;">
                        ...
                        <hr class="text-200 dark__text-900" />
                        <h6 class="dropdown-header fw-medium text-uppercase px-x1 fs-11 pt-0 pb-2">Members</h6><a class="dropdown-item px-x1 py-2" href="profile.html">
                          <div class="d-flex align-items-center">
                      ...
                      <div class="scrollbar-overlay nine-dots-dropdown">
                        <div class="card-body px-3">
                          <div class="row text-center gx-0 gy-0">
                            <div class="col-4"><a class="d-block hover-bg-200 px-2 py-3 rounded-3 text-center text-decoration-none" href="profile.html" target="_blank">
                    ...
                    <div class="card navbar-card-pages shadow-none dark__bg-1000">
                      <div class="card-body scrollbar max-h-dropdown"><img class="img-dropdown" src="../../assets/img/icons/spot-illustrations/authentication-corner.png" width="130" alt="" />
                        ...
                        <div class="row">
                          <div class="col-6 col-xxl-3">
                            <div class="nav flex-column">
                              <p class="nav-link text-700 mb-0 fw-bold">User</p><a class="nav-link py-1 link-600 fw-medium" href="profile.html">Profile</a><a class="nav-link py-1 link-600 fw-medium" href="settings.html">Settings</a>
                            </div>
                          </div>
                          <div class="col-6 col-xxl-3">
                            <div class="nav flex-column">
            ...
            <div class="navbar-vertical-content scrollbar">
              <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                ...
                <li class="nav-item"><!-- label-->
                  ...
                  </ul><!-- parent pages--><a class="nav-link dropdown-indicator" href="#user" role="button" data-bs-toggle="collapse" aria-expanded="true" aria-controls="user">
            ...
            <div class="col-lg-8 pe-lg-2">
              ...
              <div class="card mb-3">
                <div class="card-header bg-body-tertiary d-flex justify-content-between">
                  <h5 class="mb-0">Associations</h5><a class="font-sans-serif" href="../miscellaneous/associations.html">All Associations</a>
                </div>
...
<!-- Mirrored from prium.github.io/falcon/v3.21.0/pages/user/profile.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 17 Oct 2024 20:04:45 GMT -->
</html>