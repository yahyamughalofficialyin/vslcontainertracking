...
<!-- Mirrored from prium.github.io/falcon/v3.21.0/pages/pricing/pricing-default.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 17 Oct 2024 20:06:03 GMT -->
                    ...
                    <div class="card navbar-card-pages shadow-none dark__bg-1000">
                      <div class="card-body scrollbar max-h-dropdown"><img class="img-dropdown" src="../../assets/img/icons/spot-illustrations/authentication-corner.png" width="130" alt="" />
                        ...
                        <div class="row">
                          ...
                          <div class="col-6 col-xxl-3">
                            <div class="nav flex-column">
                              <p class="nav-link text-700 mb-0 fw-bold">Pricing</p><a class="nav-link py-1 link-600 fw-medium" href="pricing-default.html">Pricing default</a><a class="nav-link py-1 link-600 fw-medium" href="pricing-alt.html">Pricing alt</a>
                            </div>
                          </div>
                          <div class="col-6 col-xxl-3">
                            <div class="nav flex-column">
            ...
            <div class="navbar-vertical-content scrollbar">
              <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                ...
                <li class="nav-item"><!-- label-->
                  ...
                  </div><!-- parent pages--><a class="nav-link" href="../starter.html" role="button">
                  ...
                  </a><!-- parent pages--><a class="nav-link" href="../landing.html" role="button">
                  ...
                  <ul class="nav collapse" id="authentication">
                    <li class="nav-item"><a class="nav-link dropdown-indicator" href="#simple" data-bs-toggle="collapse" aria-expanded="false" aria-controls="authentication">
                      ...
                      <ul class="nav collapse" id="simple">
                        <li class="nav-item"><a class="nav-link" href="../authentication/simple/login.html">
                            <div class="d-flex align-items-center"><span class="nav-link-text ps-1">Login</span></div>
                          </a><!-- more inner pages--></li>
                        <li class="nav-item"><a class="nav-link" href="../authentication/simple/logout.html">
                            <div class="d-flex align-items-center"><span class="nav-link-text ps-1">Logout</span></div>
                          </a><!-- more inner pages--></li>
                        <li class="nav-item"><a class="nav-link" href="../authentication/simple/register.html">
                        ...
                        <li class="nav-item"><a class="nav-link" href="../authentication/simple/confirm-mail.html">
                  ...
                  <ul class="nav collapse" id="user">
                    <li class="nav-item"><a class="nav-link" href="../user/profile.html">
                        <div class="d-flex align-items-center"><span class="nav-link-text ps-1">Profile</span></div>
                      </a><!-- more inner pages--></li>
                    <li class="nav-item"><a class="nav-link" href="../user/settings.html">
                        <div class="d-flex align-items-center"><span class="nav-link-text ps-1">Settings</span></div>
                      </a><!-- more inner pages--></li>
                  </ul><!-- parent pages--><a class="nav-link dropdown-indicator" href="#pricing" role="button" data-bs-toggle="collapse" aria-expanded="true" aria-controls="pricing">
                  ...
                  <ul class="nav collapse show" id="pricing">
                    <li class="nav-item"><a class="nav-link active" href="pricing-default.html">
                        <div class="d-flex align-items-center"><span class="nav-link-text ps-1">Pricing default</span></div>
                      </a><!-- more inner pages--></li>
                    <li class="nav-item"><a class="nav-link" href="pricing-alt.html">
                  ...
                  <ul class="nav collapse" id="faq">
                    <li class="nav-item"><a class="nav-link" href="../faq/faq-basic.html">
                        <div class="d-flex align-items-center"><span class="nav-link-text ps-1">Faq basic</span></div>
                      </a><!-- more inner pages--></li>
                    <li class="nav-item"><a class="nav-link" href="../faq/faq-alt.html">
                  ...
                  <ul class="nav collapse" id="miscellaneous">
                    <li class="nav-item"><a class="nav-link" href="../miscellaneous/associations.html">
                        <div class="d-flex align-items-center"><span class="nav-link-text ps-1">Associations</span></div>
                      </a><!-- more inner pages--></li>
                    <li class="nav-item"><a class="nav-link" href="../miscellaneous/invite-people.html">
                        <div class="d-flex align-items-center"><span class="nav-link-text ps-1">Invite people</span></div>
                      </a><!-- more inner pages--></li>
                    <li class="nav-item"><a class="nav-link" href="../miscellaneous/privacy-policy.html">
                ...
                <div class="col-12 mb-3">
                  <div class="row justify-content-center justify-content-sm-between">
                    ...
                    <div class="col-sm-auto d-flex justify-content-center mt-1 mt-sm-0"><label class="form-check-label me-2" for="customSwitch1">Monthly</label>
                      <div class="form-check form-switch mb-0"><input class="form-check-input falcon-dual-switch" id="customSwitch1" type="checkbox" checked="checked" /><label class="form-check-label align-top" for="customSwitch1">Yearly</label></div>
                    </div>
                  </div>
                </div>
                <div class="col-lg-4 border-top border-bottom">
                  <div class="h-100">
                    <div class="text-center p-4">
                      ...
                      <h2 class="fw-medium my-4"> <sup class="fw-normal fs-7 me-1">&dollar;</sup>0<small class="fs-10 text-700">/ year</small></h2><a class="btn btn-outline-primary" href="../../app/e-commerce/billing.html">Start free trial</a>
                    </div>
                    ...
                    <div class="text-start px-sm-4 py-4">
                      ...
                      <ul class="list-unstyled mt-3">
                        <li class="py-1"><span class="me-2 fas fa-check text-success"> </span> Timeline</li>
                        <li class="py-1"><span class="me-2 fas fa-check text-success"> </span> Advanced Search</li>
                        ...
                        <li class="py-1"><span class="me-2 fas fa-check text-success"> </span> Task dependencies</li>
                        <li class="py-1"><span class="me-2 fas fa-check text-success"> </span> Private teams & projects</li>
                ...
                <div class="col-lg-4 border-top border-bottom dark__bg-1000 px-4 px-lg-0" style="background-color: rgba(115, 255, 236, 0.18);">
                  <div class="h-100">
                    <div class="text-center p-4">
                      ...
                      <h2 class="fw-medium my-4"> <sup class="fw-normal fs-7 me-1">&dollar;</sup>39<small class="fs-10 text-700">/ year</small></h2><a class="btn btn-primary" href="../../app/e-commerce/billing.html">Get Business</a>
                    </div>
                    <hr class="border-bottom-0 m-0" />
                    <div class="text-start px-sm-4 py-4">
                      <h5 class="fw-medium fs-9">Everything in Premium, plus:</h5>
                      <ul class="list-unstyled mt-3">
                        <li class="py-1"><span class="me-2 fas fa-check text-success"> </span> Portfolios</li>
                        <li class="py-1"><span class="me-2 fas fa-check text-success"> </span> Lock custom fields</li>
                        <li class="py-1"><span class="me-2 fas fa-check text-success"> </span> Onboarding plan</li>
                        <li class="py-1"><span class="me-2 fas fa-check text-success"> </span> Resource Management</li>
                        <li class="py-1"><span class="me-2 fas fa-check text-success"> </span> Lock custom fields</li>
                ...
                <div class="col-lg-4 border-top border-bottom">
                  <div class="h-100">
                    <div class="text-center p-4">
                      ...
                      <h2 class="fw-medium my-4"> <sup class="fw-normal fs-7 me-1">&dollar;</sup>99<small class="fs-10 text-700">/ year</small></h2><a class="btn btn-outline-primary" href="../../app/e-commerce/billing.html">Purchase</a>
                    </div>
                    <hr class="border-bottom-0 m-0" />
                    <div class="text-start px-sm-4 py-4">
