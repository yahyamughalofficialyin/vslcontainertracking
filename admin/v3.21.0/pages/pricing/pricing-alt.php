...
<!-- Mirrored from prium.github.io/falcon/v3.21.0/pages/pricing/pricing-alt.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 17 Oct 2024 20:06:03 GMT -->
              ...
              <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                ...
                <li class="nav-item"><!-- label-->
                  ...
                  <ul class="nav collapse show" id="pricing">
                    <li class="nav-item"><a class="nav-link" href="pricing-default.html">
                        <div class="d-flex align-items-center"><span class="nav-link-text ps-1">Pricing default</span></div>
                      </a><!-- more inner pages--></li>
                    <li class="nav-item"><a class="nav-link active" href="pricing-alt.html">
            ...
            <div class="card-body">
              <div class="row justify-content-center">
                <div class="col-12 text-center mb-4">
                  <div class="fs-8">Falcon Pricing</div>
                  <h3 class="fs-7 fs-md-6">Free plan with all the basic features. <br class="d-none d-md-block" />Pro plan for advanced users.</h3>
                  <div class="d-flex justify-content-center"><label class="form-check-label me-2" for="customSwitch1" checked="checked">Monthly</label>
                    <div class="form-check form-switch"><input class="form-check-input falcon-dual-switch" id="customSwitch1" type="checkbox" /><label class="form-check-label align-top" for="customSwitch1">Yearly</label></div>
                  </div>
                </div>
                    ...
                    <div class="col-md">
                      <div class="border rounded-3 overflow-hidden mb-3 mb-md-0">
                        <div class="d-flex flex-between-center p-4">
                          <div>
                            <h3 class="fw-light fs-4 mb-0 text-primary">Free</h3>
                            <h2 class="fw-light mt-0 text-primary"><sup class="fs-8">&dollar;</sup><span class="fs-6">0</span><span class="fs-11 mt-1">/ m</span></h2>
                          </div>
                        ...
                        <div class="p-4 bg-body-tertiary">
                          ...
                          </ul><button class="btn btn-outline-primary d-block w-100" type="button">Start free trial </button>
                        </div>
                      </div>
                    </div>
                    <div class="col-md">
                      <div class="border rounded-3 overflow-hidden">
                        <div class="d-flex flex-between-center p-4">
                          <div>
                            <h3 class="fw-light text-primary fs-4 mb-0">Pro</h3>
                            <h2 class="fw-light text-primary mt-0"><sup class="fs-8">&dollar;</sup><span class="fs-6">99</span><span class="fs-11 mt-1">/ m</span></h2>
                          </div>
...
<!-- Mirrored from prium.github.io/falcon/v3.21.0/pages/pricing/pricing-alt.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 17 Oct 2024 20:06:04 GMT -->
</html>