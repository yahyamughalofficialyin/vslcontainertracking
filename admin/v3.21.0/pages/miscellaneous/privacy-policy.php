...
<!-- Mirrored from prium.github.io/falcon/v3.21.0/pages/miscellaneous/privacy-policy.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 17 Oct 2024 20:06:06 GMT -->
                    ...
                    <div class="card navbar-card-pages shadow-none dark__bg-1000">
                      <div class="card-body scrollbar max-h-dropdown"><img class="img-dropdown" src="../../assets/img/icons/spot-illustrations/authentication-corner.png" width="130" alt="" />
                        ...
                        <div class="row">
                          <div class="col-6 col-xxl-3">
                            <div class="nav flex-column">
                              <p class="nav-link text-700 mb-0 fw-bold">Miscellaneous</p><a class="nav-link py-1 link-600 fw-medium" href="associations.html">Associations</a><a class="nav-link py-1 link-600 fw-medium" href="invite-people.html">Invite people</a><a class="nav-link py-1 link-600 fw-medium" href="privacy-policy.html">Privacy policy</a>
                            </div>
                          </div>
                          <div class="col-6 col-xxl-3">
                            <div class="nav flex-column">
            ...
            <div class="navbar-vertical-content scrollbar">
              <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                ...
                <li class="nav-item"><!-- label-->
                  ...
                  </ul><!-- parent pages--><a class="nav-link dropdown-indicator" href="#miscellaneous" role="button" data-bs-toggle="collapse" aria-expanded="true" aria-controls="miscellaneous">
                  ...
                  <ul class="nav collapse show" id="miscellaneous">
                    <li class="nav-item"><a class="nav-link" href="associations.html">
                        <div class="d-flex align-items-center"><span class="nav-link-text ps-1">Associations</span></div>
                      </a><!-- more inner pages--></li>
                    <li class="nav-item"><a class="nav-link" href="invite-people.html">
                        <div class="d-flex align-items-center"><span class="nav-link-text ps-1">Invite people</span></div>
                      </a><!-- more inner pages--></li>
                    <li class="nav-item"><a class="nav-link active" href="privacy-policy.html">
            ...
            <div class="col-lg-8 pe-lg-2">
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <p class="fs-9 mb-0 fw-semi-bold">In order to use the Service, you must:</p>
                  <ol type="1">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <p class="fs-9 mb-0 fw-semi-bold">You promise to follow these rules:</p>
                  <ol type="1">
                  ...
                  <hr class="my-4" />
                  <p class="fs-9 mb-0 fw-semi-bold">You shall:</p>
                  <ol type="1">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <p class="fs-9 mb-0 fw-semi-bold">Our responsibility for loss or damage if you are a business</p>
                  <ol type="1">
                  ...
                  <hr class="my-4" />
                  <p class="fs-9 mb-0 fw-semi-bold">Except as expressly and specifically provided in these Terms:</p>
                  <ol type="1">
                  ...
                  <hr class="my-4" />
                  <p class="fs-9 mb-0 fw-semi-bold">Nothing in these Terms excludes our liability:</p>
                  <ol type="1">
                    <li>for death or personal injury caused by our negligence; or</li>
                    <li>for fraud or fraudulent misrepresentation.</li>
                  </ol>
                  <hr class="my-4" />
                  <p class="fs-9 mb-0 fw-semi-bold">Subject to section 15.3 above: We shall not be liable whether in tort (including for negligence or breach of statutory duty), contract, misrepresentation, restitution or otherwise for any:</p>
                  <ol type="1">
                  ...
                  <hr class="my-4" />
                  <p class="fs-9 mb-0 fw-semi-bold">Our responsibility for loss or damage if you are a consumer</p>
                  <ol type="1">
                  ...
                  <hr class="my-4" />
                  <p class="fs-9 mb-0 fw-semi-bold">Force majeur</p>
                  ...
                  <hr class="my-4" />
                  <p class="fs-9 mb-0 fw-semi-bold">Data processing term</p>
