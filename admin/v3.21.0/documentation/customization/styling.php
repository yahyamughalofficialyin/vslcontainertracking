...
<!-- Mirrored from prium.github.io/falcon/v3.21.0/documentation/customization/styling.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 17 Oct 2024 20:07:12 GMT -->
        ...
        <div class="content">
          ...
          <div class="card mb-3">
            ...
            <div class="card-body bg-body-tertiary">
              <div class="border rounded-1 bg-body-quaternary px-3 py-2 mb-3"><code>user.scss</code></div>
              <p class="mb-0">You can add your own SCSS and override the theme style in the <code>src/scss/user.scss</code> file.</p>
              <div class="border-bottom border-dashed my-3"></div>
              <div class="border rounded-1 bg-body-quaternary px-3 py-2 mt-4 mb-3"><code>_user-variables.scss</code></div>
              ...
              <div class="border-bottom border-dashed my-3"></div>
              <div class="border rounded-1 bg-body-quaternary px-3 py-2 mt-4 mb-3"><code>_bootstrap.scss</code></div>
          ...
          <div class="card mb-3">
            ...
            <div class="card-body bg-body-tertiary">
              <div class="border rounded-1 bg-body-quaternary px-3 py-2 mb-3"><code>user.css</code></div>
              <p class="mb-0">You can add your own CSS and override the theme style in the <code>public/assets/css/user.css</code> file.</p>
            </div>
          </div>
          <div class="card">
            <div class="card-header">
              <h5 class="mb-0 fs-7" data-anchor="data-anchor">Changing theme colors</h5>
            </div>
            <div class="card-body bg-body-tertiary">
              ...
              <h6 class="fs-9" data-anchor="data-anchor">1. Using scss variable:</h6>
              <div class="border rounded-1 bg-body-quaternary px-3 py-2 mb-3"><code>_user-variables.scss</code></div>
              ...
              <p> Light mode is default theme style in Falcon. So, if you update any bootstrap’s SCSS variables, it will effect in Light mode. If you want to update any color, find the corresponding variable for thise color and place theme to _user-variables.scss file. For example:</p><pre><code class="lang-css">//*-----------------------------------------------
//|   Theme Colors
//-----------------------------------------------*/
...
$dark: $gray-1100 !default;        
              ...
              <p class="mt-3">If you want to update any theme colors for dark mode, update <code>$theme-dark-colors </code>variable and to update the grays colors you have to update the <code>$dark-grays </code>variable.</p><pre><code class="lang-css">/*-----------------------------------------------
|   Theme Styles
-----------------------------------------------*/
$theme-dark-colors: (
  'primary': $primary,
...
$dark-grays: (
  ...
  '1100': $gray-100,
              ...
              <h6 class="mt-4 fs-9" data-anchor="data-anchor">2. Using CSS variable:</h6>
              <div class="border rounded-1 bg-body-quaternary px-3 py-2 mb-3"><code>_user.scss</code></div>
              <p>To update theme color with this approach, you have to update CSS variable for both modes. If you change any color you have to assign it's corresponding RGB color too. Please note sometimes you may need to update corresponding component's CSS variable. For example:</p><pre><code class="lang-css">/*-----------------------------------------------
|   Theme Styles
-----------------------------------------------*/
$success: #00d27a;
$danger: #e63757;
