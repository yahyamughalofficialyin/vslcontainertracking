...
<!-- Mirrored from prium.github.io/falcon/v3.21.0/documentation/gulp.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 17 Oct 2024 20:07:16 GMT -->
      ...
      <div class="container" data-layout="container">
              ...
              <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                ...
                <li class="nav-item"><!-- label-->
                  ...
                  <ul class="nav collapse" id="customization">
                    ...
                    <div class="d-flex align-items-center"><span class="nav-link-icon"><span class="fas fa-question-circle"></span></span><span class="nav-link-text ps-1">Faq</span></div>
                  </a><!-- parent pages--><a class="nav-link active" href="gulp.html" role="button">
        ...
        <div class="content">
          ...
          <div class="card mb-3">
            ...
            <div class="card-body bg-body-tertiary"><code class="fs-7 border rounded-1 py-2 px-3 d-block border-300 bg-body-quaternary">gulp</code>
