...
<!-- Mirrored from prium.github.io/falcon/v3.21.0/modules/utilities/background.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 17 Oct 2024 20:06:44 GMT -->
      ...
      <div class="container" data-layout="container">
        ...
        <div class="content">
          ...
          <div class="card mb-3">
            ...
            <div class="card-body position-relative">
              <div class="row">
                <div class="col-lg-8">
                  <h3>Background</h3>
                  <p class="mb-0">Convey meaning through <code>background-color</code> and add decoration with gradients.</p><a class="btn btn-link btn-sm ps-0 mt-2" href="https://getbootstrap.com/docs/5.3/utilities/background/" target="_blank">Background on Bootstrap<span class="fas fa-chevron-right ms-1 fs-11"></span></a>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="card-body bg-body-tertiary">
              <div class="row g-0">
                <div class="col-6 col-sm-4 col-lg-3">
                  <div class="p-3 d-flex flex-center bg-primary  " style="height: 180px"><pre><code class="text-white">.bg-primary  </code></pre>
                  </div>
                </div>
                <div class="col-6 col-sm-4 col-lg-3">
                  <div class="p-3 d-flex flex-center bg-secondary  " style="height: 180px"><pre><code class="text-white">.bg-secondary  </code></pre>
                  </div>
                </div>
                <div class="col-6 col-sm-4 col-lg-3">
                  <div class="p-3 d-flex flex-center bg-success  " style="height: 180px"><pre><code class="text-white">.bg-success  </code></pre>
                  </div>
                </div>
                <div class="col-6 col-sm-4 col-lg-3">
                  <div class="p-3 d-flex flex-center bg-info  " style="height: 180px"><pre><code class="text-white">.bg-info  </code></pre>
                  </div>
                </div>
                <div class="col-6 col-sm-4 col-lg-3">
                  <div class="p-3 d-flex flex-center bg-warning  " style="height: 180px"><pre><code class="text-white">.bg-warning  </code></pre>
                  </div>
                </div>
                <div class="col-6 col-sm-4 col-lg-3">
                  <div class="p-3 d-flex flex-center bg-danger  " style="height: 180px"><pre><code class="text-white">.bg-danger  </code></pre>
                  </div>
                </div>
                <div class="col-6 col-sm-4 col-lg-3">
                  <div class="p-3 d-flex flex-center bg-light  border border-300" style="height: 180px"><pre><code class="text-black">.bg-light  </code></pre>
                  </div>
                </div>
                <div class="col-6 col-sm-4 col-lg-3">
                  <div class="p-3 d-flex flex-center bg-dark  " style="height: 180px"><pre><code class="text-white">.bg-dark  </code></pre>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="card mb-3">
            ...
            <div class="card-body bg-body-tertiary">
              <div class="row g-0" data-bs-theme="light">
                <div class="col-6 col-sm-4 col-lg-3">
                  <div class="p-3 d-flex flex-center bg-1100  " style="height: 180px"><pre><code class="text-white">.bg-1100  </code></pre>
                  </div>
                </div>
                <div class="col-6 col-sm-4 col-lg-3">
                  <div class="p-3 d-flex flex-center bg-1000  " style="height: 180px"><pre><code class="text-white">.bg-1000  </code></pre>
                  </div>
                </div>
                <div class="col-6 col-sm-4 col-lg-3">
                  <div class="p-3 d-flex flex-center bg-900  " style="height: 180px"><pre><code class="text-white">.bg-900  </code></pre>
                  </div>
                </div>
                <div class="col-6 col-sm-4 col-lg-3">
                  <div class="p-3 d-flex flex-center bg-800  " style="height: 180px"><pre><code class="text-white">.bg-800  </code></pre>
                  </div>
                </div>
                <div class="col-6 col-sm-4 col-lg-3">
                  <div class="p-3 d-flex flex-center bg-700  " style="height: 180px"><pre><code class="text-white">.bg-700  </code></pre>
                  </div>
                </div>
                <div class="col-6 col-sm-4 col-lg-3">
                  <div class="p-3 d-flex flex-center bg-600  " style="height: 180px"><pre><code class="text-white">.bg-600  </code></pre>
                  </div>
                </div>
                <div class="col-6 col-sm-4 col-lg-3">
                  <div class="p-3 d-flex flex-center bg-500  " style="height: 180px"><pre><code class="text-white">.bg-500  </code></pre>
                  </div>
                </div>
                <div class="col-6 col-sm-4 col-lg-3">
                  <div class="p-3 d-flex flex-center bg-400  " style="height: 180px"><pre><code class="text-white">.bg-400  </code></pre>
                  </div>
                </div>
                <div class="col-6 col-sm-4 col-lg-3">
                  <div class="p-3 d-flex flex-center bg-300  " style="height: 180px"><pre><code class="text-black">.bg-300  </code></pre>
                  </div>
                </div>
                <div class="col-6 col-sm-4 col-lg-3">
                  <div class="p-3 d-flex flex-center bg-200  border border-300" style="height: 180px"><pre><code class="text-black">.bg-200  </code></pre>
                  </div>
                </div>
                <div class="col-6 col-sm-4 col-lg-3">
                  <div class="p-3 d-flex flex-center bg-100  border border-300" style="height: 180px"><pre><code class="text-black">.bg-100  </code></pre>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="card mb-3">
            ...
            <div class="card-body bg-body-tertiary">
              <div class="row g-0">
                <div class="col-6 col-sm-4 col-lg-3">
                  <div class="p-3 d-flex flex-center bg-primary bg-gradient " style="height: 180px"><pre><code class="text-white">.bg-gradient</code><br/><code class="text-white">.bg-primary  </code></pre>
                  </div>
                </div>
                <div class="col-6 col-sm-4 col-lg-3">
                  <div class="p-3 d-flex flex-center bg-secondary bg-gradient " style="height: 180px"><pre><code class="text-white">.bg-gradient</code><br/><code class="text-white">.bg-secondary  </code></pre>
                  </div>
                </div>
                <div class="col-6 col-sm-4 col-lg-3">
                  <div class="p-3 d-flex flex-center bg-success bg-gradient " style="height: 180px"><pre><code class="text-white">.bg-gradient</code><br/><code class="text-white">.bg-success  </code></pre>
                  </div>
                </div>
                <div class="col-6 col-sm-4 col-lg-3">
                  <div class="p-3 d-flex flex-center bg-info bg-gradient " style="height: 180px"><pre><code class="text-white">.bg-gradient</code><br/><code class="text-white">.bg-info  </code></pre>
                  </div>
                </div>
                <div class="col-6 col-sm-4 col-lg-3">
                  <div class="p-3 d-flex flex-center bg-warning bg-gradient " style="height: 180px"><pre><code class="text-white">.bg-gradient</code><br/><code class="text-white">.bg-warning  </code></pre>
                  </div>
                </div>
                <div class="col-6 col-sm-4 col-lg-3">
                  <div class="p-3 d-flex flex-center bg-danger bg-gradient " style="height: 180px"><pre><code class="text-white">.bg-gradient</code><br/><code class="text-white">.bg-danger  </code></pre>
                  </div>
                </div>
                <div class="col-6 col-sm-4 col-lg-3">
                  <div class="p-3 d-flex flex-center bg-light bg-gradient border border-300" style="height: 180px"><pre><code class="text-black">.bg-gradient</code><br/><code class="text-black">.bg-light  </code></pre>
                  </div>
                </div>
                <div class="col-6 col-sm-4 col-lg-3">
                  <div class="p-3 d-flex flex-center bg-dark bg-gradient " style="height: 180px"><pre><code class="text-white">.bg-gradient</code><br/><code class="text-white">.bg-dark  </code></pre>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="card mb-3">
            ...
            <div class="card-body bg-body-tertiary">
              <div class="row g-0">
                <div class="col-6 col-sm-4 col-lg-3">
                  <div class="p-3 d-flex flex-center bg-primary-subtle" style="height: 180px"><pre><code class="text-primary">.bg-primary-subtle</code></pre>
                  </div>
                </div>
                <div class="col-6 col-sm-4 col-lg-3">
                  <div class="p-3 d-flex flex-center bg-secondary-subtle" style="height: 180px"><pre><code class="text-secondary">.bg-secondary-subtle</code></pre>
                  </div>
                </div>
                <div class="col-6 col-sm-4 col-lg-3">
                  <div class="p-3 d-flex flex-center bg-success-subtle" style="height: 180px"><pre><code class="text-success">.bg-success-subtle</code></pre>
                  </div>
                </div>
                <div class="col-6 col-sm-4 col-lg-3">
                  <div class="p-3 d-flex flex-center bg-info-subtle" style="height: 180px"><pre><code class="text-info">.bg-info-subtle</code></pre>
                  </div>
                </div>
                <div class="col-6 col-sm-4 col-lg-3">
                  <div class="p-3 d-flex flex-center bg-warning-subtle" style="height: 180px"><pre><code class="text-warning">.bg-warning-subtle</code></pre>
                  </div>
                </div>
                <div class="col-6 col-sm-4 col-lg-3">
                  <div class="p-3 d-flex flex-center bg-danger-subtle" style="height: 180px"><pre><code class="text-danger">.bg-danger-subtle</code></pre>
                  </div>
                </div>
                <div class="col-6 col-sm-4 col-lg-3">
                  <div class="p-3 d-flex flex-center bg-light-subtle" style="height: 180px"><pre><code class="text-black">.bg-light-subtle</code></pre>
                  </div>
                </div>
                <div class="col-6 col-sm-4 col-lg-3">
                  <div class="p-3 d-flex flex-center bg-dark-subtle" style="height: 180px"><pre><code class="text-dark">.bg-dark-subtle</code></pre>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="card">
            <div class="card-header">
              <h5 class="mb-0" data-anchor="data-anchor">Color and background</h5>
            </div>
            <div class="card-body bg-body-tertiary">
              <div class="row g-0">
                <div class="col-6 col-sm-4 col-lg-3">
                  <div class="p-3 d-flex flex-center text-bg-primary" style="height: 180px"><pre><code>.text-bg-primary</code></pre>
                  </div>
                </div>
                <div class="col-6 col-sm-4 col-lg-3">
                  <div class="p-3 d-flex flex-center text-bg-secondary" style="height: 180px"><pre><code>.text-bg-secondary</code></pre>
                  </div>
                </div>
                <div class="col-6 col-sm-4 col-lg-3">
                  <div class="p-3 d-flex flex-center text-bg-success" style="height: 180px"><pre><code>.text-bg-success</code></pre>
                  </div>
                </div>
                <div class="col-6 col-sm-4 col-lg-3">
                  <div class="p-3 d-flex flex-center text-bg-info" style="height: 180px"><pre><code>.text-bg-info</code></pre>
                  </div>
                </div>
                <div class="col-6 col-sm-4 col-lg-3">
                  <div class="p-3 d-flex flex-center text-bg-warning" style="height: 180px"><pre><code>.text-bg-warning</code></pre>
                  </div>
                </div>
                <div class="col-6 col-sm-4 col-lg-3">
                  <div class="p-3 d-flex flex-center text-bg-danger" style="height: 180px"><pre><code>.text-bg-danger</code></pre>
                  </div>
                </div>
                <div class="col-6 col-sm-4 col-lg-3">
                  <div class="p-3 d-flex flex-center text-bg-light" style="height: 180px"><pre><code>.text-bg-light</code></pre>
                  </div>
                </div>
                <div class="col-6 col-sm-4 col-lg-3">
                  <div class="p-3 d-flex flex-center text-bg-dark" style="height: 180px"><pre><code>.text-bg-dark</code></pre>
                  </div>
                </div>
              </div>
            </div>
