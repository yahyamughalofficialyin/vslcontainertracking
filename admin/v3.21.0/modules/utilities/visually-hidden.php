...
<!-- Mirrored from prium.github.io/falcon/v3.21.0/modules/utilities/visually-hidden.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 17 Oct 2024 20:07:18 GMT -->
              ...
              <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                ...
                <li class="nav-item"><!-- label-->
                  ...
                  <ul class="nav collapse show" id="utilities">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="visually-hidden.html">
            ...
            <div class="card-body position-relative">
              <div class="row">
                <div class="col-lg-8">
                  ...
                  <p class="mb-0">Use these helpers to visually hide elements but keep them accessible to assistive technologies.</p><a class="btn btn-link btn-sm ps-0 mt-2" href="https://getbootstrap.com/docs/5.3/helpers/visually-hidden/" target="_blank">Visually hidden on Bootstrap<span class="fas fa-chevron-right ms-1 fs-11"></span></a>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="card-header">
              <div class="row flex-between-end">
                <div class="col-auto align-self-center">
                  ...
                  <p class="mb-0 pt-1 mt-2">Visually hide an element while still allowing it to be exposed to assistive technologies (such as screen readers) with <code>.visually-hidden</code>. Use <code>.visually-hidden-focusable</code> to visually hide an element by default, but to display it when it's focused (e.g. by a keyboard-only user). <code>.visually-hidden-focusable</code> can also be applied to a container–thanks to <code>:focus-within</code>, the container will be displayed when any child element of the container receives focus.</p>
                </div>
                <div class="col-auto ms-auto">
                  <div class="nav nav-pills nav-pills-falcon flex-grow-1 mt-2" role="tablist"><button class="btn btn-sm active" data-bs-toggle="pill" data-bs-target="#dom-052b5d65-63ae-451c-8778-63375db0fd90" type="button" role="tab" aria-controls="dom-052b5d65-63ae-451c-8778-63375db0fd90" aria-selected="true" id="tab-dom-052b5d65-63ae-451c-8778-63375db0fd90">Preview</button><button class="btn btn-sm" data-bs-toggle="pill" data-bs-target="#dom-27708d95-5f41-48b4-b127-40e0d02f129e" type="button" role="tab" aria-controls="dom-27708d95-5f41-48b4-b127-40e0d02f129e" aria-selected="false" id="tab-dom-27708d95-5f41-48b4-b127-40e0d02f129e">Code</button></div>
                </div>
              </div>
            </div>
            <div class="card-body bg-body-tertiary">
              <div class="tab-content">
                <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-052b5d65-63ae-451c-8778-63375db0fd90" id="dom-052b5d65-63ae-451c-8778-63375db0fd90">
                  <h2 class="visually-hidden">Title for screen readers</h2>
                  <a class="visually-hidden-focusable" href="#content">Skip to main content</a>
                  <div class="visually-hidden-focusable"> A container with a
                    <a href="#">focusable element.</a>
                  </div>
                </div>
                <div class="tab-pane code-tab-pane" role="tabpanel" aria-labelledby="tab-dom-27708d95-5f41-48b4-b127-40e0d02f129e" id="dom-27708d95-5f41-48b4-b127-40e0d02f129e"><pre class="scrollbar rounded-1" style="max-height:420px"><code class="language-html">&lt;h2 class=&quot;visually-hidden&quot;&gt;Title for screen readers&lt;/h2&gt;
&lt;a class=&quot;visually-hidden-focusable&quot; href=&quot;#content&quot;&gt;Skip to main content&lt;/a&gt;
&lt;div class=&quot;visually-hidden-focusable&quot;&gt; A container with a
  &lt;a href=&quot;#&quot;&gt;focusable element.&lt;/a&gt;
&lt;/div&gt;</code></pre>
