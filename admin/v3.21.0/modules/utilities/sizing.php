...
<!-- Mirrored from prium.github.io/falcon/v3.21.0/modules/utilities/sizing.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 17 Oct 2024 20:06:48 GMT -->
            ...
            <div class="card-header">
              <div class="row flex-between-end">
                ...
                <div class="col-auto ms-auto">
                  <div class="nav nav-pills nav-pills-falcon flex-grow-1" role="tablist"><button class="btn btn-sm active" data-bs-toggle="pill" data-bs-target="#dom-e7a31147-bf15-471c-964e-ed4df9714fc9" type="button" role="tab" aria-controls="dom-e7a31147-bf15-471c-964e-ed4df9714fc9" aria-selected="true" id="tab-dom-e7a31147-bf15-471c-964e-ed4df9714fc9">Preview</button><button class="btn btn-sm" data-bs-toggle="pill" data-bs-target="#dom-30797867-ffbd-4b4d-985e-e22abd760074" type="button" role="tab" aria-controls="dom-30797867-ffbd-4b4d-985e-e22abd760074" aria-selected="false" id="tab-dom-30797867-ffbd-4b4d-985e-e22abd760074">Code</button></div>
                </div>
              </div>
            </div>
            <div class="card-body bg-body-tertiary">
              <div class="tab-content">
                <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-e7a31147-bf15-471c-964e-ed4df9714fc9" id="dom-e7a31147-bf15-471c-964e-ed4df9714fc9">
                  <div class="bg-100 text-dark p-2 border border-dashed mb-3 w-100"><code>.w-100</code></div>
                  <div class="bg-100 text-dark p-2 border border-dashed mb-3 w-75"><code>.w-75</code></div>
                  <div class="bg-100 text-dark p-2 border border-dashed mb-3 w-50"><code>.w-50</code></div>
                  <div class="bg-100 text-dark p-2 border border-dashed mb-3 w-25"><code>.w-25</code></div>
                  <div class="bg-100 text-dark p-2 border border-dashed mb-3 w-auto"><code>.w-auto</code></div>
                </div>
                <div class="tab-pane code-tab-pane" role="tabpanel" aria-labelledby="tab-dom-30797867-ffbd-4b4d-985e-e22abd760074" id="dom-30797867-ffbd-4b4d-985e-e22abd760074"><pre class="scrollbar rounded-1" style="max-height:420px"><code class="language-html">&lt;div class=&quot;bg-100 text-dark p-2 border border-dashed mb-3 w-100&quot;&gt;&lt;code&gt;.w-100&lt;/code&gt;&lt;/div&gt;
&lt;div class=&quot;bg-100 text-dark p-2 border border-dashed mb-3 w-75&quot;&gt;&lt;code&gt;.w-75&lt;/code&gt;&lt;/div&gt;
&lt;div class=&quot;bg-100 text-dark p-2 border border-dashed mb-3 w-50&quot;&gt;&lt;code&gt;.w-50&lt;/code&gt;&lt;/div&gt;
&lt;div class=&quot;bg-100 text-dark p-2 border border-dashed mb-3 w-25&quot;&gt;&lt;code&gt;.w-25&lt;/code&gt;&lt;/div&gt;
&lt;div class=&quot;bg-100 text-dark p-2 border border-dashed mb-3 w-auto&quot;&gt;&lt;code&gt;.w-auto&lt;/code&gt;&lt;/div&gt;</code></pre>
                </div>
              </div>
            </div>
          </div>
          <div class="card mb-3">
            <div class="card-header">
              <div class="row flex-between-end">
                ...
                <div class="col-auto ms-auto">
                  <div class="nav nav-pills nav-pills-falcon flex-grow-1" role="tablist"><button class="btn btn-sm active" data-bs-toggle="pill" data-bs-target="#dom-db4ac242-87e9-4643-9e4e-f43c71c540f1" type="button" role="tab" aria-controls="dom-db4ac242-87e9-4643-9e4e-f43c71c540f1" aria-selected="true" id="tab-dom-db4ac242-87e9-4643-9e4e-f43c71c540f1">Preview</button><button class="btn btn-sm" data-bs-toggle="pill" data-bs-target="#dom-cdc19960-4024-4473-a9a6-d3d8dbba854e" type="button" role="tab" aria-controls="dom-cdc19960-4024-4473-a9a6-d3d8dbba854e" aria-selected="false" id="tab-dom-cdc19960-4024-4473-a9a6-d3d8dbba854e">Code</button></div>
                </div>
              </div>
            </div>
            <div class="card-body bg-body-tertiary">
              <div class="tab-content">
                <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-db4ac242-87e9-4643-9e4e-f43c71c540f1" id="dom-db4ac242-87e9-4643-9e4e-f43c71c540f1">
                  <div class="vh-50 text-dark py-3">
                    <div class="row h-100">
                      <div class="col">
                        <div class="bg-100 p-2 border border-dashed mb-3 h-100"><code>.h-100</code></div>
                      </div>
                      <div class="col">
                        <div class="bg-100 p-2 border border-dashed mb-3 h-75"><code>.h-75</code></div>
                      </div>
                      <div class="col">
                        <div class="bg-100 p-2 border border-dashed mb-3 h-50"><code>.h-50</code></div>
                      </div>
                      <div class="col">
                        <div class="bg-100 p-2 border border-dashed mb-3 h-25"><code>.h-25</code></div>
                      </div>
                      <div class="col">
                        <div class="bg-100 p-2 border border-dashed mb-3 h-auto"><code>.h-auto</code></div>
                      </div>
                    </div>
                  </div>
                </div>
                <div class="tab-pane code-tab-pane" role="tabpanel" aria-labelledby="tab-dom-cdc19960-4024-4473-a9a6-d3d8dbba854e" id="dom-cdc19960-4024-4473-a9a6-d3d8dbba854e"><pre class="scrollbar rounded-1" style="max-height:420px"><code class="language-html">&lt;div class=&quot;vh-50 text-dark py-3&quot;&gt;
  &lt;div class=&quot;row h-100&quot;&gt;
    &lt;div class=&quot;col&quot;&gt;
      &lt;div class=&quot;bg-100 p-2 border border-dashed mb-3 h-100&quot;&gt;&lt;code&gt;.h-100&lt;/code&gt;&lt;/div&gt;
    &lt;/div&gt;
...
&lt;/div&gt;</code></pre>
          ...
          <div class="card">
            ...
            <div class="card-body bg-body-tertiary"><pre class="rounded-3"><code class="lang-css">.mw-100 { max-width: 100%; }
