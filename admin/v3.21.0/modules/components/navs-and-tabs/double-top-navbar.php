...
<!-- Mirrored from prium.github.io/falcon/v3.21.0/modules/components/navs-and-tabs/double-top-navbar.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 17 Oct 2024 20:06:33 GMT -->
      ...
      <div class="container" data-layout="container">
                  ...
                  <ul class="nav collapse show" id="components">
                    ...
                    <li class="nav-item"><a class="nav-link dropdown-indicator" href="#navs-_and_-Tabs" data-bs-toggle="collapse" aria-expanded="true" aria-controls="components">
                      ...
                      <ul class="nav collapse show" id="navs-_and_-Tabs">
                        ...
                        <li class="nav-item"><a class="nav-link active" href="double-top-navbar.html">
                            <div class="d-flex align-items-center"><span class="nav-link-text ps-1">Double top</span><span class="badge rounded-pill ms-2 badge-subtle-success">New</span></div>
                          </a><!-- more inner pages--></li>
        ...
        <div class="content">
            ...
            <div class="card-body position-relative">
              <div class="row">
                <div class="col-lg-8">
                  ...
                  <p class="mb-0">Navbar Double Top is a different user friendly layout system in Falcon.</p><a class="btn btn-link btn-sm ps-0 mt-2" href="../../../demo/navbar-double-top.html" target="_blank">Navbar double top example page<span class="fas fa-chevron-right ms-1 fs-11"></span></a>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="card mb-3">
            ...
            <div class="card-body bg-body-tertiary"><pre class="scrollbar mt-2"><code class="language-html">&lt;nav class=&quot;navbar navbar-light navbar-glass navbar-top&quot;&gt;
  &lt;div&gt;
 &lt;!-- Navbar Content--&gt;&lt;/div&gt;
  &lt;hr class=&quot;my-2 d-none d-lg-block&quot; /&gt;
...
&lt;/nav&gt;</code></pre>
            ...
            <div class="card-body position-relative">
              <div class="row">
                <div class="col-lg-8">
                  ...
                  <p class="mb-0">Falcon's special Navbar for landing, where background color will be changed gradually transparent to darken on scroll.</p><a class="btn btn-link btn-sm ps-0 mt-2" href="../../../pages/landing.html" target="_blank">See the implementation here<span class="fas fa-chevron-right ms-1 fs-11"></span></a>
                </div>
              </div>
            </div>
          </div>
          <div class="card mb-3">
            ...
            <div class="card-body bg-body-tertiary">
              <p>You can add <strong>darken on scroll </strong>feature to the Bootstrap navbar, just add <code>data-navbar-darken-on-scroll </code>attribute to the <code>.navbar </code>element. By default it will take the <code>bg-dark </code>color code to darken the navbar.</p><pre class="scrollbar mt-2"><code class="language-html">&lt;nav class=&quot;navbar navbar-expand-lg navbar-dark&quot; data-navbar-darken-on-scroll=&quot;data-navbar-darken-on-scroll&quot;&gt;
&lt;!-- Navbar content --&gt;&lt;/nav&gt;</code></pre>
              <p class="mt-3">You can also change the background color of the navbar by using any of the color from the list: <code>primary</code>, <code>secondary</code>, <code>success</code>, <code>info</code>, <code>warning</code>, <code>danger</code>, <code>light</code>, <code>dark</code>, <code>1100</code>, <code>1000</code>, <code>900</code>, <code>800</code>, <code>700</code>, <code>600</code>, <code>500</code>, <code>400</code>, <code>300</code>, <code>200</code>, <code>100</code> like as follows: <a href="../../utilities/colors.html">See all colors in Falcon</a></p><pre class="scrollbar mt-2"><code class="language-html">&lt;nav class=&quot;navbar navbar-expand-lg navbar-dark&quot; data-navbar-darken-on-scroll=&quot;primary&quot;&gt;
&lt;!-- Navbar content --&gt;&lt;/nav&gt;</code></pre>
            </div>
          </div>
          <footer class="footer">
