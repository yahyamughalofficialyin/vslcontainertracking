...
<!-- Mirrored from prium.github.io/falcon/v3.21.0/modules/components/navs-and-tabs/vertical-navbar.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 17 Oct 2024 20:06:30 GMT -->
                    ...
                    <div class="card navbar-card-components shadow-none dark__bg-1000">
                      <div class="card-body scrollbar max-h-dropdown"><img class="img-dropdown" src="../../../assets/img/icons/spot-illustrations/authentication-corner.png" width="130" alt="" />
                        <div class="row">
                          ...
                          <div class="col-6 col-xxl-3">
                            <div class="nav flex-column mt-md-4 pt-md-1"><a class="nav-link py-1 link-600 fw-medium" href="../carousel/swiper.html">Swiper</a><a class="nav-link py-1 link-600 fw-medium" href="../collapse.html">Collapse</a><a class="nav-link py-1 link-600 fw-medium" href="../cookie-notice.html">Cookie notice</a><a class="nav-link py-1 link-600 fw-medium" href="../countup.html">Countup</a><a class="nav-link py-1 link-600 fw-medium" href="../dropdowns.html">Dropdowns</a><a class="nav-link py-1 link-600 fw-medium" href="../jquery-components.html">Jquery<span class="badge rounded-pill ms-2 badge-subtle-success">New</span></a><a class="nav-link py-1 link-600 fw-medium" href="../list-group.html">List group</a><a class="nav-link py-1 link-600 fw-medium" href="../modals.html">Modals</a><a class="nav-link py-1 link-600 fw-medium" href="navs.html">Navs</a><a class="nav-link py-1 link-600 fw-medium" href="navbar.html">Navbar</a><a class="nav-link py-1 link-600 fw-medium" href="vertical-navbar.html">Navbar vertical</a><a class="nav-link py-1 link-600 fw-medium" href="top-navbar.html">Top nav</a></div>
                          </div>
                          <div class="col-6 col-xxl-3">
                            <div class="nav flex-column mt-xxl-4 pt-xxl-1"><a class="nav-link py-1 link-600 fw-medium" href="double-top-navbar.html">Double top<span class="badge rounded-pill ms-2 badge-subtle-success">New</span></a><a class="nav-link py-1 link-600 fw-medium" href="combo-navbar.html">Combo nav</a><a class="nav-link py-1 link-600 fw-medium" href="tabs.html">Tabs</a><a class="nav-link py-1 link-600 fw-medium" href="../offcanvas.html">Offcanvas</a><a class="nav-link py-1 link-600 fw-medium" href="../pictures/avatar.html">Avatar</a><a class="nav-link py-1 link-600 fw-medium" href="../pictures/images.html">Images</a><a class="nav-link py-1 link-600 fw-medium" href="../pictures/figures.html">Figures</a><a class="nav-link py-1 link-600 fw-medium" href="../pictures/hoverbox.html">Hoverbox</a><a class="nav-link py-1 link-600 fw-medium" href="../pictures/lightbox.html">Lightbox</a><a class="nav-link py-1 link-600 fw-medium" href="../progress-bar.html">Progress bar</a><a class="nav-link py-1 link-600 fw-medium" href="../placeholder.html">Placeholder</a><a class="nav-link py-1 link-600 fw-medium" href="../pagination.html">Pagination</a></div>
                          </div>
                          <div class="col-6 col-xxl-3">
                  ...
                  <ul class="nav collapse show" id="components">
                    ...
                    <li class="nav-item"><a class="nav-link dropdown-indicator" href="#navs-_and_-Tabs" data-bs-toggle="collapse" aria-expanded="true" aria-controls="components">
                      ...
                      <ul class="nav collapse show" id="navs-_and_-Tabs">
                        ...
                        <li class="nav-item"><a class="nav-link" href="top-navbar.html">
                            <div class="d-flex align-items-center"><span class="nav-link-text ps-1">Top nav</span></div>
                          </a><!-- more inner pages--></li>
                        <li class="nav-item"><a class="nav-link" href="double-top-navbar.html">
                            <div class="d-flex align-items-center"><span class="nav-link-text ps-1">Double top</span><span class="badge rounded-pill ms-2 badge-subtle-success">New</span></div>
                          </a><!-- more inner pages--></li>
        ...
        <div class="content">
          ...
          <div class="card mb-3">
            ...
            <div class="card-body bg-body-tertiary">
              <p>Falcon used the Bootstrap's <code>.navbar-expand{-sm|-md|-lg|-xl|-xxl} </code>classes in <code>.navbar-vertical </code>element to decide when the navbar vertical will expand or not. </p><pre class="scrollbar mt-2"><code class="language-html">&lt;nav class=&quot;navbar navbar-vertical navbar-expand-xl navbar-light&quot;&gt;
&lt;!-- Content--&gt;
...
&lt;/nav&gt;</code></pre>
          ...
          <div class="card mb-3">
            ...
            <div class="card-body bg-body-tertiary">
              <p>From your project directory, If you are using gulp version open <code>src/js/config.js </code>or if you are using directly from the public folder open <code>public/assets/js/theme.js </code>and set <code>isNavbarVerticalCollapsed: true</code> of <code>CONFIG </code>object
                to collapse the Vertical Navigation by default</p><pre><code class="lang-html">const CONFIG = {
  ...
  ...
          ...
          <div class="card mb-3">
            ...
            <div class="card-body bg-body-tertiary">
              <p>Normally, links in navbar vertical may contain icons, texts, badges and indicator icons. By default each elements in navbar vertical's links are vertically centered with each other. Navbar vertical's top parent link example:</p><pre class="scrollbar mt-2"><code class="language-html">&lt;a class=&quot;nav-link&quot; href=&quot;#&quot;&gt;
  &lt;div class=&quot;d-flex align-items-center&quot;&gt;
...
&lt;/a&gt;</code></pre>
              ...
              <p class="mb-2">Child link example: </p><pre class="scrollbar mt-2 mb-3"><code class="language-html">&lt;a class=&quot;nav-link&quot; href=&quot;#&quot;&gt;
  &lt;div class=&quot;d-flex align-items-center&quot;&gt;
    Dashboard
    &lt;span class=&quot;badge rounded-pill badge-subtle-success ms-2&quot;&gt;New&lt;/span&gt;
  &lt;/div&gt;
&lt;/a&gt;</code></pre>
              <p class="mb-2">Add <code>dropdown-indicator </code>class to <code>.nav-link </code>element to show arrow icon to the right side of the link text.</p><pre class="scrollbar mt-2 mb-3"><code class="language-html">&lt;a class=&quot;nav-link dropdown-indicator&quot; href=&quot;#&quot;&gt;
&lt;!-- link content--&gt;
&lt;/a&gt;</code></pre>
            </div>
          </div>
          <div class="card mb-3">
            ...
            <div class="card-body bg-body-tertiary"><pre><code class="lang-html">const navbarVerticalToggle = document.querySelector(.navbar-vertical-toggle);
navbarVerticalToggle.addEventListener('navbar.vertical.toggle', function () {
  // do something...
          ...
          <div class="card">
            ...
            <div class="card-body bg-body-tertiary">
              <h6 class="fs-9">Breakpoints</h6>
              <p>Falcon use <code>$grid-brekpoints </code>in reversed order for styling navbar vertical when screen size is above the breakpoint. Note: Falcon get the brekpoint from <code>.navbar-expand-* </code>class.</p><pre class="scrollbar mt-2 mb-4"><code class="language-html">$navbar-vertical-breakpoints: mapReverse($grid-breakpoints) !default;</code></pre>
              <h6 class="fs-9">Width</h6>
              <p>It's possible to update navbar vertical default width when screen size is above breakpoint. </p><pre class="scrollbar mt-2 mb-4"><code class="language-html">$navbar-vertical-width: 12.625rem !default;</code></pre>
              <h6 class="fs-9">Icon Width</h6>
              <p>Set navbar vertical icon width and height using the variable.</p><pre class="scrollbar mt-2 mb-4"><code class="language-html">$navbar-vertical-icon-width: 1.5rem !default;</code></pre>
              <h6 class="fs-9">Collapsed width</h6>
              <p>Update width of navbar vertical when it is collapsed.</p><pre class="scrollbar mt-2 mb-4"><code class="language-html">$navbar-vertical-collapsed-width: 3.125rem !default;</code></pre>
              <h6 class="fs-9">Hover Width</h6>
              <p>To change the navbar vertical width on mouse over update the variable.</p><pre class="scrollbar mt-2 mb-4"><code class="language-html">$navbar-vertical-hover-width: 12.875rem !default;</code></pre>
              <h6 class="fs-9">Hover shadow</h6>
              <p>Update navbar vertical shadow on mouse over</p><pre class="scrollbar mt-2 mb-4"><code class="language-html">$navbar-vertical-collapsed-hover-shadow: 0.625rem 0 0.625rem -0.5625rem rgba($black, 0.2) !default;</code></pre>
              <h6 class="fs-9">Variation Width</h6>
              <p>Falcon comes with different types of navbar vertical and you can change the width of those navbar by updating the variable.</p><pre class="scrollbar mt-2 mb-4"><code class="language-html">$navbar-vertical-variation-width: 14.5rem !default;</code></pre>
              <h6 class="fs-9">Variation collapsed width</h6>
              <p>To change the collapsed with of navbar vertical variation update the variable.</p><pre class="scrollbar mt-2 mb-4"><code class="language-html">$navbar-vertical-variation-collapsed-width: 4.125rem !default;</code></pre>
              <h6 class="fs-9">Font size</h6>
              <p>To change the font size of navbar vertical link update the variable.</p><pre class="scrollbar mt-2 mb-4"><code class="language-html">$navbar-vertical-link-font-size: $font-size-sm !default;</code></pre>
              <h6 class="fs-9">Dropdown font size</h6>
              <p>To change the dropdown font size of navbar vertical link update the variable.</p><pre class="scrollbar mt-2 mb-4"><code class="language-html">$navbar-vertical-dropdown-font-size: 0.8125rem !default;</code></pre>
            </div>
          </div>
            ...
            <div class="card-body">
              <div class="d-flex align-items-start"><img class="me-3 border border-2 rounded-3 bg-200" src="../../../assets/img/generic/default.png" alt="" width="100" />
                <div class="flex-1">
                  ...
                  <p class="mb-1">Falcon lets you choose your own custom colors and customize Default Navbar Vertical.</p><a class="btn btn-link btn-sm ps-0" href="../../../demo/navbar-vertical.html" target="_blank"> See the implementation here <span class="fas fa-chevron-right ms-1 fs-11"></span></a>
                </div>
              </div>
            </div>
          </div>
          <div class="card mb-3">
            ...
            <div class="card-body bg-body-tertiary">
              <p>Class <code>.navbar-vertical </code>represents the default Transparent Vertical Navbar.</p><pre class="scrollbar mt-2 mb-3"><code class="language-html">&lt;nav class=&quot;navbar navbar-vertical navbar-expand-xl navbar-light&quot;&gt;
&lt;!-- Content--&gt;
  &lt;div class=&quot;collapse navbar-collapse&quot;&gt;
    &lt;div class=&quot;navbar-vertical-content scrollbar&quot;&gt;
&lt;!-- Navbar content--&gt;&lt;/div&gt;
  &lt;/div&gt;
&lt;/nav&gt;</code></pre>
              <p>You can change <code>background-color </code>by adding <code>.bg-* </code>utility classes in <code>.navbar-collapse </code>element or you can update globally using the SCSS or CSS variable which is described in Customize section below.</p><pre class="scrollbar mt-2"><code class="language-html">&lt;div class=&quot;collapse navbar-collapse bg-1000&quot;&gt;
   &lt;div class=&quot;navbar-vertical-content scrollbar&quot;&gt;
&lt;!-- Navbar content--&gt;&lt;/div&gt;
 &lt;/div&gt;</code></pre>
            </div>
          ...
          <div class="card mb-3">
            ...
            <div class="card-body bg-body-tertiary">
              ...
              <h6 class="fs-9">Background color</h6>
              <p class="mb-2">To change the background color
                of the
                Navbar Vertical
                , update the SCSS variable <code>$navbar-vertical-default-bg-color</code> in your <code>_user-variables.scss </code>or CSS variable <code>--falcon-navbar-vertical-default-bg-color</code> in your <code>public/assets/css/user.css</code>. Example: </p><pre class="scrollbar mt-2 mb-4"><code class="language-css">//- _user-variables.scss
$navbar-vertical-default-bg-color: #ff0000;
or,
//- public/assets/css/user.css
--falcon-navbar-vertical-default-bg-color: #ff0000;</code></pre>
              <h6 class="fs-9">Link color</h6>
              <p class="mb-2">To change the link color
                of the
                Navbar Vertical
                , update the SCSS variable <code>$navbar-vertical-default-link-color</code> in your <code>_user-variables.scss </code>or CSS variable <code>--falcon-navbar-vertical-default-link-color</code> in your <code>public/assets/css/user.css</code>. Example: </p><pre class="scrollbar mt-2 mb-4"><code class="language-css">//- _user-variables.scss
$navbar-vertical-default-link-color: #ff0000;
or,
//- public/assets/css/user.css
--falcon-navbar-vertical-default-link-color: #ff0000;</code></pre>
              <h6 class="fs-9">Link hover color</h6>
              <p class="mb-2">To change the link hover color
                of the
                Navbar Vertical
                , update the SCSS variable <code>$navbar-vertical-default-link-hover-color</code> in your <code>_user-variables.scss </code>or CSS variable <code>--falcon-navbar-vertical-default-link-hover-color</code> in your <code>public/assets/css/user.css</code>. Example: </p><pre class="scrollbar mt-2 mb-4"><code class="language-css">//- _user-variables.scss
$navbar-vertical-default-link-hover-color: #ff0000;
or,
//- public/assets/css/user.css
--falcon-navbar-vertical-default-link-hover-color: #ff0000;</code></pre>
              <h6 class="fs-9">Link active color</h6>
              <p class="mb-2">To change the link active color
                of the
                Navbar Vertical
                , update the SCSS variable <code>$navbar-vertical-default-link-active-color</code> in your <code>_user-variables.scss </code>or CSS variable <code>--falcon-navbar-vertical-default-link-active-color</code> in your <code>public/assets/css/user.css</code>. Example: </p><pre class="scrollbar mt-2 mb-4"><code class="language-css">//- _user-variables.scss
$navbar-vertical-default-link-active-color: #ff0000;
or,
//- public/assets/css/user.css
--falcon-navbar-vertical-default-link-active-color: #ff0000;</code></pre>
              <h6 class="fs-9">Divider color</h6>
              <p class="mb-2">To change the divider color
                of the
                Navbar Vertical
                , update the SCSS variable <code>$navbar-vertical-default-hr-color</code> in your <code>_user-variables.scss </code>or CSS variable <code>--falcon-navbar-vertical-default-hr-color</code> in your <code>public/assets/css/user.css</code>. Example: </p><pre class="scrollbar mt-2 mb-4"><code class="language-css">//- _user-variables.scss
$navbar-vertical-default-hr-color: #ff0000;
or,
//- public/assets/css/user.css
--falcon-navbar-vertical-default-hr-color: #ff0000;</code></pre>
              <h6 class="fs-9">Scrollbar color</h6>
              <p class="mb-2">To change the scrollbar color
                of the
                Navbar Vertical
                , update the SCSS variable <code>$navbar-vertical-default-scrollbar-color</code> in your <code>_user-variables.scss </code>or CSS variable <code>--falcon-navbar-vertical-default-scrollbar-color</code> in your <code>public/assets/css/user.css</code>. Example: </p><pre class="scrollbar mt-2 mb-4"><code class="language-css">//- _user-variables.scss
...
--falcon-navbar-vertical-default-scrollbar-color: #ff0000;</code></pre>
            ...
            <div class="card-body">
              <div class="d-flex align-items-start"><img class="me-3 border border-2 rounded-3 bg-200" src="../../../assets/img/generic/inverted.png" alt="" width="100" />
                <div class="flex-1">
                  ...
                  <p class="mb-1">You can update your Navbar Vertical <code>background-color</code> with Navbar Vertical Inverted.</p><a class="btn btn-link btn-sm ps-0" href="../../../demo/navbar-vertical-inverted.html" target="_blank"> See the implementation here <span class="fas fa-chevron-right ms-1 fs-11"></span></a>
                </div>
              </div>
            </div>
          </div>
          <div class="card mb-3">
            ...
            <div class="card-body bg-body-tertiary">
              <p>Add <code>.navbar-inverted </code>class to <code>.navbar-vertical </code>element to convert Transparent Vertical Navbar to Inverted Vertical Navbar.</p><pre class="scrollbar mt-2 mb-3"><code class="language-html">&lt;nav class=&quot;navbar navbar-vertical navbar-expand-xl navbar-light navbar-inverted&quot;&gt;
&lt;!-- Content--&gt;
  &lt;div class=&quot;collapse navbar-collapse&quot;&gt;
    &lt;div class=&quot;navbar-vertical-content scrollbar&quot;&gt;
&lt;!-- Navbar content--&gt;&lt;/div&gt;
  &lt;/div&gt;
&lt;/nav&gt;</code></pre>
              <p>You can change <code>background-color </code>by adding <code>.bg-* </code>utility classes in <code>.navbar-collapse </code>element or you can update globally using the SCSS variable which is described in SCSS section below.</p><pre class="scrollbar mt-2"><code class="language-html">&lt;div class=&quot;collapse navbar-collapse bg-1000&quot;&gt;
   &lt;div class=&quot;navbar-vertical-content scrollbar&quot;&gt;
&lt;!-- Navbar content--&gt;&lt;/div&gt;
 &lt;/div&gt;</code></pre>
            </div>
          ...
          <div class="card mb-3">
            ...
            <div class="card-body bg-body-tertiary">
              ...
              <p class="mb-2">To change the background color
                ...
                , update the SCSS variable <code>$navbar-vertical-inverted-bg-color</code> in your <code>_user-variables.scss </code>or CSS variable <code>--falcon-navbar-vertical-inverted-bg-color</code> in your <code>public/assets/css/user.css</code>. Example: </p><pre class="scrollbar mt-2 mb-4"><code class="language-css">//- _user-variables.scss
...
--falcon-navbar-vertical-inverted-bg-color: #ff0000;</code></pre>
              ...
              <p class="mb-2">To change the link color
                of the
                Navbar Vertical Inverted
                , update the SCSS variable <code>$navbar-vertical-inverted-link-color</code> in your <code>_user-variables.scss </code>or CSS variable <code>--falcon-navbar-vertical-inverted-link-color</code> in your <code>public/assets/css/user.css</code>. Example: </p><pre class="scrollbar mt-2 mb-4"><code class="language-css">//- _user-variables.scss
...
--falcon-navbar-vertical-inverted-link-color: #ff0000;</code></pre>
              ...
              <p class="mb-2">To change the link hover color
                of the
                Navbar Vertical Inverted
                , update the SCSS variable <code>$navbar-vertical-inverted-link-hover-color</code> in your <code>_user-variables.scss </code>or CSS variable <code>--falcon-navbar-vertical-inverted-link-hover-color</code> in your <code>public/assets/css/user.css</code>. Example: </p><pre class="scrollbar mt-2 mb-4"><code class="language-css">//- _user-variables.scss
...
--falcon-navbar-vertical-inverted-link-hover-color: #ff0000;</code></pre>
              ...
              <p class="mb-2">To change the link active color
                of the
                Navbar Vertical Inverted
                , update the SCSS variable <code>$navbar-vertical-inverted-link-active-color</code> in your <code>_user-variables.scss </code>or CSS variable <code>--falcon-navbar-vertical-inverted-link-active-color</code> in your <code>public/assets/css/user.css</code>. Example: </p><pre class="scrollbar mt-2 mb-4"><code class="language-css">//- _user-variables.scss
...
--falcon-navbar-vertical-inverted-link-active-color: #ff0000;</code></pre>
              ...
              <p class="mb-2">To change the divider color
                of the
                Navbar Vertical Inverted
                , update the SCSS variable <code>$navbar-vertical-inverted-hr-color</code> in your <code>_user-variables.scss </code>or CSS variable <code>--falcon-navbar-vertical-inverted-hr-color</code> in your <code>public/assets/css/user.css</code>. Example: </p><pre class="scrollbar mt-2 mb-4"><code class="language-css">//- _user-variables.scss
...
--falcon-navbar-vertical-inverted-hr-color: #ff0000;</code></pre>
              ...
              <p class="mb-2">To change the scrollbar color
                of the
                Navbar Vertical Inverted
                , update the SCSS variable <code>$navbar-vertical-inverted-scrollbar-color</code> in your <code>_user-variables.scss </code>or CSS variable <code>--falcon-navbar-vertical-inverted-scrollbar-color</code> in your <code>public/assets/css/user.css</code>. Example: </p><pre class="scrollbar mt-2 mb-4"><code class="language-css">//- _user-variables.scss
...
--falcon-navbar-vertical-inverted-scrollbar-color: #ff0000;</code></pre>
            ...
            <div class="card-body">
              <div class="d-flex align-items-start"><img class="me-3 border border-2 rounded-3 bg-200" src="../../../assets/img/generic/vibrant.png" alt="" width="100" />
                <div class="flex-1">
                  ...
                  <p class="mb-1">Make your Navbar Vertical more live and awesome with Falcon Navbar Vibrant.</p><a class="btn btn-link btn-sm ps-0" href="../../../demo/navbar-vertical-vibrant.html" target="_blank"> See the implementation here <span class="fas fa-chevron-right ms-1 fs-11"></span></a>
                </div>
              </div>
            </div>
          </div>
          <div class="card mb-3">
            ...
            <div class="card-body bg-body-tertiary">
              <p>Add <code>.navbar-vibrant </code>class to <code>.navbar-vertical </code>element which will set a <code>gradient-color </code>and a <code>background-image  </code>to the <code>.navbar-collapse </code>element. This style come from <code>theme.css</code>.</p><pre class="scrollbar mt-2 mb-3"><code class="language-html">&lt;nav class=&quot;navbar navbar-vertical navbar-expand-xl navbar-light navbar-vibrant&quot;&gt;
&lt;!-- Content--&gt;
  &lt;div class=&quot;collapse navbar-collapse&quot;&gt;
    &lt;div class=&quot;navbar-vertical-content scrollbar&quot;&gt;
&lt;!-- Navbar content--&gt;&lt;/div&gt;
  &lt;/div&gt;
&lt;/nav&gt;</code></pre>
              <p>You can change the background of navbar vibrant using inline style. Add style attribute to <code>.navbar-collapse </code>element to change the backgruond image property. Otherwise, you can change background using SCSS variable.</p><pre class="scrollbar mt-2"><code class="language-html">&lt;div class=&quot;collapse navbar-collapse&quot; style=&quot;background-image: linear-gradient(-45deg, rgba(0, 160, 255, 0.86), #0048a2), url(assets/img/generic/bg-navbar.png)&quot;&gt;
  &lt;div class=&quot;navbar-vertical-content scrollbar&quot;&gt;
&lt;!-- Navbar content--&gt;&lt;/div&gt;
&lt;/div&gt;</code></pre>
            </div>
          ...
          <div class="card mb-3">
            ...
            <div class="card-body bg-body-tertiary">
              <p>Falcon allow you to customize your Navbar Vertical with SCSS or CSS variables. The available options are listed below: </p>
              <h6 class="fs-9">Background</h6>
              <p class="mb-2">To change the background
                of the
                Navbar Vertical Vibrant
                , update the SCSS variable <code>$navbar-vertical-vibrant-bg-image</code> in your <code>_user-variables.scss </code>or CSS variable <code>--falcon-navbar-vertical-vibrant-bg-image</code> in your <code>public/assets/css/user.css</code>. Example: </p><pre class="scrollbar mt-2 mb-4"><code class="language-css">//- _user-variables.scss
...
--falcon-navbar-vertical-vibrant-bg-image: linear-gradient(-45deg,rgba(0, 160, 255, 0.86),#0048a2);</code></pre>
              ...
              <p class="mb-2">To change the link color
                of the
                Navbar Vertical Vibrant
                , update the SCSS variable <code>$navbar-vertical-vibrant-link-color</code> in your <code>_user-variables.scss </code>or CSS variable <code>--falcon-navbar-vertical-vibrant-link-color</code> in your <code>public/assets/css/user.css</code>. Example: </p><pre class="scrollbar mt-2 mb-4"><code class="language-css">//- _user-variables.scss
...
--falcon-navbar-vertical-vibrant-link-color: #ff0000;</code></pre>
              ...
              <p class="mb-2">To change the link hover color
                of the
                Navbar Vertical Vibrant
                , update the SCSS variable <code>$navbar-vertical-vibrant-link-hover-color</code> in your <code>_user-variables.scss </code>or CSS variable <code>--falcon-navbar-vertical-vibrant-link-hover-color</code> in your <code>public/assets/css/user.css</code>. Example: </p><pre class="scrollbar mt-2 mb-4"><code class="language-css">//- _user-variables.scss
...
--falcon-navbar-vertical-vibrant-link-hover-color: #ff0000;</code></pre>
              ...
              <p class="mb-2">To change the link active color
                of the
                Navbar Vertical Vibrant
                , update the SCSS variable <code>$navbar-vertical-vibrant-link-active-color</code> in your <code>_user-variables.scss </code>or CSS variable <code>--falcon-navbar-vertical-vibrant-link-active-color</code> in your <code>public/assets/css/user.css</code>. Example: </p><pre class="scrollbar mt-2 mb-4"><code class="language-css">//- _user-variables.scss
...
--falcon-navbar-vertical-vibrant-link-active-color: #ff0000;</code></pre>
              ...
              <p class="mb-2">To change the divider color
                of the
                Navbar Vertical Vibrant
                , update the SCSS variable <code>$navbar-vertical-vibrant-hr-color</code> in your <code>_user-variables.scss </code>or CSS variable <code>--falcon-navbar-vertical-vibrant-hr-color</code> in your <code>public/assets/css/user.css</code>. Example: </p><pre class="scrollbar mt-2 mb-4"><code class="language-css">//- _user-variables.scss
...
--falcon-navbar-vertical-vibrant-hr-color: #ff0000;</code></pre>
              ...
              <p class="mb-2">To change the scrollbar color
                of the
                Navbar Vertical Vibrant
                , update the SCSS variable <code>$navbar-vertical-vibrant-scrollbar-color</code> in your <code>_user-variables.scss </code>or CSS variable <code>--falcon-navbar-vertical-vibrant-scrollbar-color</code> in your <code>public/assets/css/user.css</code>. Example: </p><pre class="scrollbar mt-2 mb-4"><code class="language-css">//- _user-variables.scss
...
--falcon-navbar-vertical-vibrant-scrollbar-color: #ff0000;</code></pre>
            ...
            <div class="card-body">
              <div class="d-flex align-items-start"><img class="me-3 border border-2 rounded-3 bg-200" src="../../../assets/img/generic/card.png" alt="" width="100" />
                <div class="flex-1">
                  ...
                  <p class="mb-1">Make your navbar vertical like Falcon card by using Navbar Vertical Card.</p><a class="btn btn-link btn-sm ps-0" href="../../../demo/navbar-vertical-card.html" target="_blank"> See the implementation here <span class="fas fa-chevron-right ms-1 fs-11"></span></a>
                </div>
              </div>
            </div>
          </div>
          <div class="card mb-3">
            ...
            <div class="card-body bg-body-tertiary">
              <p>Add <code>.navbar-card </code>class to <code>.navbar-vertical </code>element to set white background and card shadow to the <code>.navbar-collapse </code>element to convert Transparent Navbar Vertical to Card Navbar Vertical.</p><pre class="scrollbar mt-2 mb-4"><code class="language-html">&lt;nav class=&quot;navbar navbar-vertical navbar-expand-xl navbar-light navbar-card&quot;&gt;
&lt;!-- Content--&gt;
  &lt;div class=&quot;collapse navbar-collapse&quot;&gt;
    &lt;div class=&quot;navbar-vertical-content scrollbar&quot;&gt;
&lt;!-- Navbar content--&gt;&lt;/div&gt;
  &lt;/div&gt;
&lt;/nav&gt;</code></pre>
              <p>You can change <code>background-color </code>by adding <code>.bg-* </code>utility classes in <code>.navbar-collapse </code>element or you can update globally using the SCSS variable which is described in SCSS section below.</p><pre class="scrollbar mt-2"><code class="language-html">&lt;div class=&quot;collapse navbar-collapse bg-white&quot;&gt;
   &lt;div class=&quot;navbar-vertical-content scrollbar&quot;&gt;
 &lt;!-- Navbar content  --&gt;&lt;/div&gt;
 &lt;/div&gt;</code></pre>
            </div>
          ...
          <div class="card">
            ...
            <div class="card-body bg-body-tertiary">
              ...
              <p class="mb-2">To change the background color
                ...
                , update the SCSS variable <code>$navbar-vertical-card-bg-color</code> in your <code>_user-variables.scss </code>or CSS variable <code>--falcon-navbar-vertical-card-bg-color</code> in your <code>public/assets/css/user.css</code>. Example: </p><pre class="scrollbar mt-2 mb-4"><code class="language-css">//- _user-variables.scss
...
--falcon-navbar-vertical-card-bg-color: #ff0000;</code></pre>
              ...
              <p class="mb-2">To change the link color
                of the
                Navbar Vertical Card
                , update the SCSS variable <code>$navbar-vertical-card-link-color</code> in your <code>_user-variables.scss </code>or CSS variable <code>--falcon-navbar-vertical-card-link-color</code> in your <code>public/assets/css/user.css</code>. Example: </p><pre class="scrollbar mt-2 mb-4"><code class="language-css">//- _user-variables.scss
...
--falcon-navbar-vertical-card-link-color: #ff0000;</code></pre>
              ...
              <p class="mb-2">To change the link hover color
                of the
                Navbar Vertical Card
                , update the SCSS variable <code>$navbar-vertical-card-link-hover-color</code> in your <code>_user-variables.scss </code>or CSS variable <code>--falcon-navbar-vertical-card-link-hover-color</code> in your <code>public/assets/css/user.css</code>. Example: </p><pre class="scrollbar mt-2 mb-4"><code class="language-css">//- _user-variables.scss
...
--falcon-navbar-vertical-card-link-hover-color: #ff0000;</code></pre>
              ...
              <p class="mb-2">To change the link active color
                of the
                Navbar Vertical Card
                , update the SCSS variable <code>$navbar-vertical-card-link-active-color</code> in your <code>_user-variables.scss </code>or CSS variable <code>--falcon-navbar-vertical-card-link-active-color</code> in your <code>public/assets/css/user.css</code>. Example: </p><pre class="scrollbar mt-2 mb-4"><code class="language-css">//- _user-variables.scss
...
--falcon-navbar-vertical-card-link-active-color: #ff0000;</code></pre>
              ...
              <p class="mb-2">To change the divider color
                of the
                Navbar Vertical Card
                , update the SCSS variable <code>$navbar-vertical-card-hr-color</code> in your <code>_user-variables.scss </code>or CSS variable <code>--falcon-navbar-vertical-card-hr-color</code> in your <code>public/assets/css/user.css</code>. Example: </p><pre class="scrollbar mt-2 mb-4"><code class="language-css">//- _user-variables.scss
...
--falcon-navbar-vertical-card-hr-color: #ff0000;</code></pre>
              ...
              <p class="mb-2">To change the scrollbar color
                of the
                Navbar Vertical Card
                , update the SCSS variable <code>$navbar-vertical-card-scrollbar-color</code> in your <code>_user-variables.scss </code>or CSS variable <code>--falcon-navbar-vertical-card-scrollbar-color</code> in your <code>public/assets/css/user.css</code>. Example: </p><pre class="scrollbar mt-2 mb-4"><code class="language-css">//- _user-variables.scss
...
--falcon-navbar-vertical-card-scrollbar-color: #ff0000;</code></pre>
    ...
    <div class="offcanvas offcanvas-end settings-panel border-0" id="settings-offcanvas" tabindex="-1" aria-labelledby="settings-offcanvas">
      ...
      <div class="offcanvas-body scrollbar-overlay px-x1 h-100" id="themeController">
        ...
        <p> <a class="fs-10" href="vertical-navbar.html#navbar-styles">See Documentation</a></p>
        <div class="btn-group d-block w-100 btn-group-navbar-style">
          <div class="row gx-2">
...
<!-- Mirrored from prium.github.io/falcon/v3.21.0/modules/components/navs-and-tabs/vertical-navbar.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 17 Oct 2024 20:06:32 GMT -->
</html>