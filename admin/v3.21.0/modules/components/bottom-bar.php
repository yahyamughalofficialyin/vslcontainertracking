...
<!-- Mirrored from prium.github.io/falcon/v3.21.0/modules/components/bottom-bar.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 17 Oct 2024 20:06:15 GMT -->
              ...
              <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                ...
                <li class="nav-item"><!-- label-->
                  ...
                  <ul class="nav collapse show" id="components">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="bottom-bar.html">
        ...
        <div class="content">
          ...
          <div class="card mb-3">
            ...
            <div class="card-body position-relative">
              <div class="row">
                <div class="col-lg-8">
                  <h3>Bottom Bar</h3>
                  <p class="mt-2"> Falcon's Bottom Bar feature is used to show any component in the bottom of the viewport. You can also trigger the bottom bar by targeting a component when it is scrolled outside the viewport.</p><button class="btn btn-primary btn-md px-5" type="button" id="bottom-bar-target-example-btn">Target Button</button>
                </div>
              </div>
            </div>
          </div>
          <div class="card mb-3">
            ...
            <div class="card-body bg-body-tertiary">
              <div class="mb-3">
                <h5>Basic</h5>
                <p class="mb-0 mt-2"><code>.bottom-bar </code>class is responsible for showing the bar in the bottom of the viewport. You can control the breakpoint of visibility by simply using <a href="../utilities/display.html">display utilities </a>classes.</p><pre class="scrollbar mt-2"><code class="language-html">&lt;div class=&quot;card bottom-bar d-lg-none&quot;&gt;
  &lt;div class=&quot;card-body&quot;&gt;
...
&lt;/div&gt;</code></pre>
              ...
              <div>
                <h5>Triggered</h5>
                <p class="mb-0 mt-2">Bottom Bar's can be triggered based on the target element's visibility on viewport. All you need to pass some options through the <code>data-bottom-bar </code>attribute.</p><pre class="scrollbar mt-2"><code class="language-html">&lt;div class=&quot;card bottom-bar d-lg-none&quot; data-bottom-bar='{&quot;target&quot;:&quot;target-element-id&quot;,&quot;breakPoint&quot;:&quot;lg&quot;,&quot;offsetTop&quot;:60}'&gt;
  &lt;div class=&quot;card-body&quot;&gt;
            ...
            <div class="card-body bg-body-tertiary">
              <div class="table-responsive scrollbar mb-3">
                <table class="table table-bordered border border-200 fs-10 mb-0">
                  <thead class="bg-200">
                    <tr>
                      <th class="text-900 white-space-nowrap">data-bottom-bar</th>
                      <th class="text-900">object</th>
                    </tr>
                  </thead>
                  <tbody>
                    <tr>
                      <td>Example</td>
                      <td> <pre class="language-css">data-bottom-bar={ "target": "target-element-id", "breakPoint": "lg", "offsetTop": 60 }</pre>
                      </td>
                    </tr>
                  </tbody>
                </table>
          ...
          <div class="card-body py-2 px-0">
            <div class="container">
              <div class="row flex-between-center g-0">
                <div class="col-auto">
                  <h6 class="fs-9 mb-0 text-secondary">Bottom Bar</h6>
                </div>
                <div class="col-auto"><button class="btn btn-primary btn-md px-5 fw-medium" type="button">Button</button></div>
              </div>
            </div>
          </div>
        </div>
