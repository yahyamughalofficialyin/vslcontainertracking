...
<!-- Mirrored from prium.github.io/falcon/v3.21.0/modules/components/countup.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 17 Oct 2024 20:06:22 GMT -->
              ...
              <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                ...
                <li class="nav-item"><!-- label-->
                  ...
                  <ul class="nav collapse show" id="components">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="countup.html">
          ...
          <div class="card mb-3">
            ...
            <div class="card-body position-relative">
              <div class="row">
                <div class="col-lg-8">
                  <h3>CountUp</h3>
                  <p class="mb-0">CountUp.js is a dependency-free, lightweight JavaScript class that can be used to quickly create animations that display numerical data in a more interesting way.</p><a class="btn btn-link btn-sm ps-0 mt-2" href="https://inorganik.github.io/countUp.js/" target="_blank">Documentation for CountUp<span class="fas fa-chevron-right ms-1 fs-11"></span></a>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="card-body bg-body-tertiary">
              <div class="row">
                <div class="col-6 col-md-4 col-xl mb-4 text-center">
                  <span class="fs-5 fw-medium" data-countup='{"endValue":36487}'>0</span>
                  <h6>(Default) </h6>
                </div>
                <div class="col-6 col-md-4 col-xl mb-4 text-center">
                  <span class="fs-5 fw-medium" data-countup='{"endValue":23542,"duration":10}'>0</span>
                  <h6>(Duration 10s) </h6>
                </div>
                <div class="col-6 col-md-4 col-xl mb-4 text-center">
                  <span class="fs-5 fw-medium" data-countup='{"endValue":36487,"separator":""}'>0</span>
                  <h6>(No Separator) </h6>
                </div>
                <div class="col-6 col-md-4 col-xl mb-4 text-center">
                  <span class="fs-5 fw-medium" data-countup='{"endValue":36487,"separator":" "}'>0</span>
                ...
                <div class="col-6 col-md-4 col-xl mb-4 text-center">
                  <span class="fs-5 fw-medium" data-countup='{"endValue":36.487,"decimalPlaces":2,"suffix":"k"}'>0</span>
                  <h6>(suffix) </h6>
                </div>
                <div class="col-6 col-md-4 col-xl mb-4 text-center">
                  <span class="fs-5 fw-medium" data-countup='{"endValue":36487,"prefix":"$"}'>0</span>
                  <h6>(Prefix) </h6>
                </div>
              </div><pre class="scrollbar mt-2"><code class="language-html">&lt;div data-countup='{&quot;endValue&quot;:36487}'&gt;0&lt;/div&gt;
...
&lt;div data-countup='{&quot;endValue&quot;:36487,&quot;prefix&quot;:&quot;$&quot;}'&gt;0&lt;/div&gt;</code></pre>
          ...
          <div class="card">
            ...
            <div class="card-body bg-body-tertiary"><pre class="scrollbar mt-2"><code class="language-html">&lt;script src=&quot;vendors/countup/countUp.umd.js&quot;&gt;&lt;/script&gt;</code></pre>
            </div>
          </div>
          <footer class="footer">
