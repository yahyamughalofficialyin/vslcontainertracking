...
<!-- Mirrored from prium.github.io/falcon/v3.21.0/modules/charts/echarts/heatmap-charts.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 17 Oct 2024 20:06:55 GMT -->
                ...
                <div class="card-header">
                  <div class="row flex-between-end">
                    ...
                    <div class="col-auto ms-auto">
                      <div class="nav nav-pills nav-pills-falcon flex-grow-1" role="tablist"><button class="btn btn-sm active" data-bs-toggle="pill" data-bs-target="#dom-b7ba9ae6-d62b-44ad-b350-e6d05307fb6c" type="button" role="tab" aria-controls="dom-b7ba9ae6-d62b-44ad-b350-e6d05307fb6c" aria-selected="true" id="tab-dom-b7ba9ae6-d62b-44ad-b350-e6d05307fb6c">Preview</button><button class="btn btn-sm" data-bs-toggle="pill" data-bs-target="#dom-54218a30-a6c3-4fe7-97a4-8627681a4622" type="button" role="tab" aria-controls="dom-54218a30-a6c3-4fe7-97a4-8627681a4622" aria-selected="false" id="tab-dom-54218a30-a6c3-4fe7-97a4-8627681a4622">Code</button></div>
                    </div>
                  </div>
                </div>
                <div class="card-body bg-body-tertiary">
                  <div class="tab-content">
                    <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-b7ba9ae6-d62b-44ad-b350-e6d05307fb6c" id="dom-b7ba9ae6-d62b-44ad-b350-e6d05307fb6c"><!-- Find the JS file for the following chart at: src/js/charts/echarts/examples/heatmap-chart.js--><!-- If you are not using gulp based workflow, you can find the transpiled code at: public/assets/js/echarts-example.js-->
                      <div class="echart-heatmap-chart-example" style="min-height: 350px;" data-echart-responsive="true"></div>
                    </div>
                    <div class="tab-pane code-tab-pane" role="tabpanel" aria-labelledby="tab-dom-54218a30-a6c3-4fe7-97a4-8627681a4622" id="dom-54218a30-a6c3-4fe7-97a4-8627681a4622"><pre class="scrollbar rounded-1" style="max-height:420px"><code class="language-html">
              ...
              <div class="card h-100" dir="ltr">
                <div class="card-header">
                  <div class="row flex-between-end">
                    ...
                    <div class="col-auto ms-auto">
                      <div class="nav nav-pills nav-pills-falcon flex-grow-1" role="tablist"><button class="btn btn-sm active" data-bs-toggle="pill" data-bs-target="#dom-ec6519d5-426c-4adc-9cdc-0b162ac301f0" type="button" role="tab" aria-controls="dom-ec6519d5-426c-4adc-9cdc-0b162ac301f0" aria-selected="true" id="tab-dom-ec6519d5-426c-4adc-9cdc-0b162ac301f0">Preview</button><button class="btn btn-sm" data-bs-toggle="pill" data-bs-target="#dom-2ee3965c-7111-462b-8047-5f10900033ee" type="button" role="tab" aria-controls="dom-2ee3965c-7111-462b-8047-5f10900033ee" aria-selected="false" id="tab-dom-2ee3965c-7111-462b-8047-5f10900033ee">Code</button></div>
                    </div>
                  </div>
                </div>
                <div class="card-body bg-body-tertiary">
                  <div class="tab-content">
                    <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-ec6519d5-426c-4adc-9cdc-0b162ac301f0" id="dom-ec6519d5-426c-4adc-9cdc-0b162ac301f0"><!-- Find the JS file for the following chart at: src/js/charts/echarts/examples/heatmap-single-series-chart.js--><!-- If you are not using gulp based workflow, you can find the transpiled code at: public/assets/js/echarts-example.js-->
                      <div class="echart-heatmap-single-series-chart" style="min-height: 350px;" data-echart-responsive="true"></div>
                    </div>
                    <div class="tab-pane code-tab-pane" role="tabpanel" aria-labelledby="tab-dom-2ee3965c-7111-462b-8047-5f10900033ee" id="dom-2ee3965c-7111-462b-8047-5f10900033ee"><pre class="scrollbar rounded-1" style="max-height:420px"><code class="language-html">
