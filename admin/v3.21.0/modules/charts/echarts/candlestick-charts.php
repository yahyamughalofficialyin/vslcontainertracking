...
<!-- Mirrored from prium.github.io/falcon/v3.21.0/modules/charts/echarts/candlestick-charts.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 17 Oct 2024 20:06:53 GMT -->
                ...
                <div class="card-header">
                  <div class="row flex-between-end">
                    ...
                    <div class="col-auto ms-auto">
                      <div class="nav nav-pills nav-pills-falcon flex-grow-1" role="tablist"><button class="btn btn-sm active" data-bs-toggle="pill" data-bs-target="#dom-c4f3fb3f-a897-4a76-aa26-64dec434826d" type="button" role="tab" aria-controls="dom-c4f3fb3f-a897-4a76-aa26-64dec434826d" aria-selected="true" id="tab-dom-c4f3fb3f-a897-4a76-aa26-64dec434826d">Preview</button><button class="btn btn-sm" data-bs-toggle="pill" data-bs-target="#dom-fbb5683f-3895-4704-9d3f-518d98d8c333" type="button" role="tab" aria-controls="dom-fbb5683f-3895-4704-9d3f-518d98d8c333" aria-selected="false" id="tab-dom-fbb5683f-3895-4704-9d3f-518d98d8c333">Code</button></div>
                    </div>
                  </div>
                </div>
                <div class="card-body bg-body-tertiary">
                  <div class="tab-content">
                    <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-c4f3fb3f-a897-4a76-aa26-64dec434826d" id="dom-c4f3fb3f-a897-4a76-aa26-64dec434826d"><!-- Find the JS file for the following chart at: src/js/charts/echarts/examples/basic-candlestick-chart.js--><!-- If you are not using gulp based workflow, you can find the transpiled code at: public/assets/js/echarts-example.js-->
                      <div class="echart-candlestick-chart-example" style="min-height: 300px;" data-echart-responsive="true"></div>
                    </div>
                    <div class="tab-pane code-tab-pane" role="tabpanel" aria-labelledby="tab-dom-fbb5683f-3895-4704-9d3f-518d98d8c333" id="dom-fbb5683f-3895-4704-9d3f-518d98d8c333"><pre class="scrollbar rounded-1" style="max-height:420px"><code class="language-html">
              ...
              <div class="card h-100" dir="ltr">
                <div class="card-header">
                  <div class="row flex-between-end">
                    ...
                    <div class="col-auto ms-auto">
                      <div class="nav nav-pills nav-pills-falcon flex-grow-1" role="tablist"><button class="btn btn-sm active" data-bs-toggle="pill" data-bs-target="#dom-371f4bbd-ef1c-4b65-8597-d5244f060c8d" type="button" role="tab" aria-controls="dom-371f4bbd-ef1c-4b65-8597-d5244f060c8d" aria-selected="true" id="tab-dom-371f4bbd-ef1c-4b65-8597-d5244f060c8d">Preview</button><button class="btn btn-sm" data-bs-toggle="pill" data-bs-target="#dom-a16ce819-34df-4f3a-9ac2-33363cd4b200" type="button" role="tab" aria-controls="dom-a16ce819-34df-4f3a-9ac2-33363cd4b200" aria-selected="false" id="tab-dom-a16ce819-34df-4f3a-9ac2-33363cd4b200">Code</button></div>
                    </div>
                  </div>
                </div>
                <div class="card-body bg-body-tertiary">
                  <div class="tab-content">
                    <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-371f4bbd-ef1c-4b65-8597-d5244f060c8d" id="dom-371f4bbd-ef1c-4b65-8597-d5244f060c8d"><!-- Find the JS file for the following chart at: src/js/charts/echarts/examples/candle-stick-mixed-chart.js--><!-- If you are not using gulp based workflow, you can find the transpiled code at: public/assets/js/echarts-example.js-->
                      <div class="echart-candlestick-mixed-chart-example" style="min-height: 300px;" data-echart-responsive="true"></div>
                    </div>
                    <div class="tab-pane code-tab-pane" role="tabpanel" aria-labelledby="tab-dom-a16ce819-34df-4f3a-9ac2-33363cd4b200" id="dom-a16ce819-34df-4f3a-9ac2-33363cd4b200"><pre class="scrollbar rounded-1" style="max-height:420px"><code class="language-html">
