...
<!-- Mirrored from prium.github.io/falcon/v3.21.0/modules/charts/chartjs.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 17 Oct 2024 20:06:51 GMT -->
      ...
      <div class="container" data-layout="container">
                        ...
                        <div class="row">
                          ...
                          <div class="col-6 col-xxl-3">
                            <div class="nav flex-column">
                              ...
                              <p class="nav-link text-700 mb-0 fw-bold">ECharts</p><a class="nav-link py-1 link-600 fw-medium" href="echarts/line-charts.html">Line charts</a><a class="nav-link py-1 link-600 fw-medium" href="echarts/bar-charts.html">Bar charts</a><a class="nav-link py-1 link-600 fw-medium" href="echarts/candlestick-charts.html">Candlestick charts</a><a class="nav-link py-1 link-600 fw-medium" href="echarts/geo-map.html">Geo map</a><a class="nav-link py-1 link-600 fw-medium" href="echarts/scatter-charts.html">Scatter charts</a><a class="nav-link py-1 link-600 fw-medium" href="echarts/pie-charts.html">Pie charts</a><a class="nav-link py-1 link-600 fw-medium" href="echarts/gauge-charts.html">Gauge charts</a><a class="nav-link py-1 link-600 fw-medium" href="echarts/radar-charts.html">Radar charts</a><a class="nav-link py-1 link-600 fw-medium" href="echarts/heatmap-charts.html">Heatmap charts</a><a class="nav-link py-1 link-600 fw-medium" href="echarts/how-to-use.html">How to use</a>
                            </div>
                          </div>
                          <div class="col-6 col-xxl-3">
                            <div class="nav flex-column">
              ...
              <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                ...
                <li class="nav-item"><!-- label-->
                  ...
                  <ul class="nav collapse show" id="charts">
                    <li class="nav-item"><a class="nav-link active" href="chartjs.html">
                    ...
                    <li class="nav-item"><a class="nav-link dropdown-indicator" href="#eCharts" data-bs-toggle="collapse" aria-expanded="false" aria-controls="charts">
                      ...
                      <ul class="nav collapse" id="eCharts">
                        ...
                        <li class="nav-item"><a class="nav-link" href="echarts/gauge-charts.html">
        ...
        <div class="content">
          ...
          <div class="card mb-3">
            ...
            <div class="card-body position-relative">
              <div class="row">
                <div class="col-lg-8">
                  <h3>Chart Js</h3>
                  <p class="mb-0">Falcon uses chart.js - simple yet flexible JavaScript charting for designers & developers</p><a class="btn btn-link btn-sm ps-0 mt-2" href="http://chartjs.org/docs/latest/" target="_blank">Chart Js documentations<span class="fas fa-chevron-right ms-1 fs-11"></span></a>
                </div>
              </div>
            </div>
          </div>
          <div class="card mb-3">
            ...
            <div class="card-body bg-body-tertiary"> <pre class="scrollbar mt-2"><code class="language-html">&lt;script src=&quot;vendors/chart/chart.umd.js&quot;&gt;&lt;/script&gt;</code></pre>
            </div>
          </div>
                ...
                <div class="card-header">
                  <div class="row flex-between-end">
                    ...
                    <div class="col-auto ms-auto">
                      <div class="nav nav-pills nav-pills-falcon flex-grow-1" role="tablist"><button class="btn btn-sm active" data-bs-toggle="pill" data-bs-target="#dom-b928f2f1-3c7a-474b-9e64-4afe2655db50" type="button" role="tab" aria-controls="dom-b928f2f1-3c7a-474b-9e64-4afe2655db50" aria-selected="true" id="tab-dom-b928f2f1-3c7a-474b-9e64-4afe2655db50">Preview</button><button class="btn btn-sm" data-bs-toggle="pill" data-bs-target="#dom-3fa6fb4d-fc84-4870-a2df-044b141739a7" type="button" role="tab" aria-controls="dom-3fa6fb4d-fc84-4870-a2df-044b141739a7" aria-selected="false" id="tab-dom-3fa6fb4d-fc84-4870-a2df-044b141739a7">Code</button></div>
                    </div>
                  </div>
                </div>
                <div class="card-body bg-body-tertiary">
                  <div class="tab-content">
                    <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-b928f2f1-3c7a-474b-9e64-4afe2655db50" id="dom-b928f2f1-3c7a-474b-9e64-4afe2655db50"><!-- Find the JS file for the following chart at: src/js/charts/chartjs/chart-bar.js--><!-- If you are not using gulp based workflow, you can find the transpiled code at: public/assets/js/theme.js--><canvas class="max-w-100" id="chartjs-bar-chart" width="1618" height="1000"></canvas></div>
                    <div class="tab-pane code-tab-pane" role="tabpanel" aria-labelledby="tab-dom-3fa6fb4d-fc84-4870-a2df-044b141739a7" id="dom-3fa6fb4d-fc84-4870-a2df-044b141739a7"><pre class="scrollbar rounded-1" style="max-height:420px"><code class="language-html">
&lt;!-- Find the JS file for the following chart at: src/js/charts/chartjs/chart-bar.js--&gt;
&lt;!-- If you are not using gulp based workflow, you can find the transpiled code at: public/assets/js/theme.js--&gt;&lt;canvas class=&quot;max-w-100&quot; id=&quot;chartjs-bar-chart&quot; width=&quot;1618&quot; height=&quot;1000&quot;&gt;&lt;/canvas&gt;</code></pre>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="card">
                <div class="card-header">
                  <div class="row flex-between-end">
                    ...
                    <div class="col-auto ms-auto">
                      <div class="nav nav-pills nav-pills-falcon flex-grow-1" role="tablist"><button class="btn btn-sm active" data-bs-toggle="pill" data-bs-target="#dom-df9ddb1e-8b98-4bc5-b212-e714905fcad5" type="button" role="tab" aria-controls="dom-df9ddb1e-8b98-4bc5-b212-e714905fcad5" aria-selected="true" id="tab-dom-df9ddb1e-8b98-4bc5-b212-e714905fcad5">Preview</button><button class="btn btn-sm" data-bs-toggle="pill" data-bs-target="#dom-31036d65-e7f6-41ba-83a2-5c6dccb139d7" type="button" role="tab" aria-controls="dom-31036d65-e7f6-41ba-83a2-5c6dccb139d7" aria-selected="false" id="tab-dom-31036d65-e7f6-41ba-83a2-5c6dccb139d7">Code</button></div>
                    </div>
                  </div>
                </div>
                <div class="card-body bg-body-tertiary">
                  <div class="tab-content">
                    <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-df9ddb1e-8b98-4bc5-b212-e714905fcad5" id="dom-df9ddb1e-8b98-4bc5-b212-e714905fcad5"><!-- Find the JS file for the following chart at: src/js/charts/chartjs/chart-line.js--><!-- If you are not using gulp based workflow, you can find the transpiled code at: public/assets/js/theme.js--><canvas class="max-w-100" id="chartjs-line-chart" width="1618" height="1000"></canvas></div>
                    <div class="tab-pane code-tab-pane" role="tabpanel" aria-labelledby="tab-dom-31036d65-e7f6-41ba-83a2-5c6dccb139d7" id="dom-31036d65-e7f6-41ba-83a2-5c6dccb139d7"><pre class="scrollbar rounded-1" style="max-height:420px"><code class="language-html">
&lt;!-- Find the JS file for the following chart at: src/js/charts/chartjs/chart-line.js--&gt;
&lt;!-- If you are not using gulp based workflow, you can find the transpiled code at: public/assets/js/theme.js--&gt;&lt;canvas class=&quot;max-w-100&quot; id=&quot;chartjs-line-chart&quot; width=&quot;1618&quot; height=&quot;1000&quot;&gt;&lt;/canvas&gt;</code></pre>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="card">
                <div class="card-header">
                  <div class="row flex-between-end">
                    ...
                    <div class="col-auto ms-auto">
                      <div class="nav nav-pills nav-pills-falcon flex-grow-1" role="tablist"><button class="btn btn-sm active" data-bs-toggle="pill" data-bs-target="#dom-921d7025-c8b1-43ab-81a8-3f8614a55a6c" type="button" role="tab" aria-controls="dom-921d7025-c8b1-43ab-81a8-3f8614a55a6c" aria-selected="true" id="tab-dom-921d7025-c8b1-43ab-81a8-3f8614a55a6c">Preview</button><button class="btn btn-sm" data-bs-toggle="pill" data-bs-target="#dom-5a6064ca-a271-4790-8092-c8dc55214a1c" type="button" role="tab" aria-controls="dom-5a6064ca-a271-4790-8092-c8dc55214a1c" aria-selected="false" id="tab-dom-5a6064ca-a271-4790-8092-c8dc55214a1c">Code</button></div>
                    </div>
                  </div>
                </div>
                <div class="card-body bg-body-tertiary">
                  <div class="tab-content">
                    <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-921d7025-c8b1-43ab-81a8-3f8614a55a6c" id="dom-921d7025-c8b1-43ab-81a8-3f8614a55a6c"><!-- Find the JS file for the following chart at: src/js/charts/chartjs/chart-doughnut.js--><!-- If you are not using gulp based workflow, you can find the transpiled code at: public/assets/js/theme.js--><canvas class="max-w-100" id="chartjs-doughnut-chart" width="350"></canvas></div>
                    <div class="tab-pane code-tab-pane" role="tabpanel" aria-labelledby="tab-dom-5a6064ca-a271-4790-8092-c8dc55214a1c" id="dom-5a6064ca-a271-4790-8092-c8dc55214a1c"><pre class="scrollbar rounded-1" style="max-height:420px"><code class="language-html">
&lt;!-- Find the JS file for the following chart at: src/js/charts/chartjs/chart-doughnut.js--&gt;
&lt;!-- If you are not using gulp based workflow, you can find the transpiled code at: public/assets/js/theme.js--&gt;&lt;canvas class=&quot;max-w-100&quot; id=&quot;chartjs-doughnut-chart&quot; width=&quot;350&quot;&gt;&lt;/canvas&gt;</code></pre>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="card">
                <div class="card-header">
                  <div class="row flex-between-end">
                    ...
                    <div class="col-auto ms-auto">
                      <div class="nav nav-pills nav-pills-falcon flex-grow-1" role="tablist"><button class="btn btn-sm active" data-bs-toggle="pill" data-bs-target="#dom-0a872147-4b03-45c5-aa08-103679c6c222" type="button" role="tab" aria-controls="dom-0a872147-4b03-45c5-aa08-103679c6c222" aria-selected="true" id="tab-dom-0a872147-4b03-45c5-aa08-103679c6c222">Preview</button><button class="btn btn-sm" data-bs-toggle="pill" data-bs-target="#dom-96ac4b14-e693-4d9a-94f0-cce57f6e0a62" type="button" role="tab" aria-controls="dom-96ac4b14-e693-4d9a-94f0-cce57f6e0a62" aria-selected="false" id="tab-dom-96ac4b14-e693-4d9a-94f0-cce57f6e0a62">Code</button></div>
                    </div>
                  </div>
                </div>
                <div class="card-body bg-body-tertiary">
                  <div class="tab-content">
                    <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-0a872147-4b03-45c5-aa08-103679c6c222" id="dom-0a872147-4b03-45c5-aa08-103679c6c222"><!-- Find the JS file for the following chart at: src/js/charts/chartjs/chart-pie.js--><!-- If you are not using gulp based workflow, you can find the transpiled code at: public/assets/js/theme.js--><canvas class="max-w-100" id="chartjs-pie-chart" width="350"></canvas></div>
                    <div class="tab-pane code-tab-pane" role="tabpanel" aria-labelledby="tab-dom-96ac4b14-e693-4d9a-94f0-cce57f6e0a62" id="dom-96ac4b14-e693-4d9a-94f0-cce57f6e0a62"><pre class="scrollbar rounded-1" style="max-height:420px"><code class="language-html">
&lt;!-- Find the JS file for the following chart at: src/js/charts/chartjs/chart-pie.js--&gt;
&lt;!-- If you are not using gulp based workflow, you can find the transpiled code at: public/assets/js/theme.js--&gt;&lt;canvas class=&quot;max-w-100&quot; id=&quot;chartjs-pie-chart&quot; width=&quot;350&quot;&gt;&lt;/canvas&gt;</code></pre>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="card">
                <div class="card-header">
                  <div class="row flex-between-end">
                    ...
                    <div class="col-auto ms-auto">
                      <div class="nav nav-pills nav-pills-falcon flex-grow-1" role="tablist"><button class="btn btn-sm active" data-bs-toggle="pill" data-bs-target="#dom-43018ff7-844e-4fd3-a242-f73034a801fd" type="button" role="tab" aria-controls="dom-43018ff7-844e-4fd3-a242-f73034a801fd" aria-selected="true" id="tab-dom-43018ff7-844e-4fd3-a242-f73034a801fd">Preview</button><button class="btn btn-sm" data-bs-toggle="pill" data-bs-target="#dom-cd108048-07c8-4bfc-a897-e0f2335a64d3" type="button" role="tab" aria-controls="dom-cd108048-07c8-4bfc-a897-e0f2335a64d3" aria-selected="false" id="tab-dom-cd108048-07c8-4bfc-a897-e0f2335a64d3">Code</button></div>
                    </div>
                  </div>
                </div>
                <div class="card-body bg-body-tertiary">
                  <div class="tab-content">
                    <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-43018ff7-844e-4fd3-a242-f73034a801fd" id="dom-43018ff7-844e-4fd3-a242-f73034a801fd"><!-- Find the JS file for the following chart at: src/js/charts/chartjs/chart-polar.js--><!-- If you are not using gulp based workflow, you can find the transpiled code at: public/assets/js/theme.js--><canvas class="max-w-100" id="chartjs-polar-chart" width="350"></canvas></div>
                    <div class="tab-pane code-tab-pane" role="tabpanel" aria-labelledby="tab-dom-cd108048-07c8-4bfc-a897-e0f2335a64d3" id="dom-cd108048-07c8-4bfc-a897-e0f2335a64d3"><pre class="scrollbar rounded-1" style="max-height:420px"><code class="language-html">
&lt;!-- Find the JS file for the following chart at: src/js/charts/chartjs/chart-polar.js--&gt;
&lt;!-- If you are not using gulp based workflow, you can find the transpiled code at: public/assets/js/theme.js--&gt;&lt;canvas class=&quot;max-w-100&quot; id=&quot;chartjs-polar-chart&quot; width=&quot;350&quot;&gt;&lt;/canvas&gt;</code></pre>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="card">
                <div class="card-header">
                  <div class="row flex-between-end">
                    ...
                    <div class="col-auto ms-auto">
                      <div class="nav nav-pills nav-pills-falcon flex-grow-1" role="tablist"><button class="btn btn-sm active" data-bs-toggle="pill" data-bs-target="#dom-47ddfa96-6eaf-4d17-b934-836eb7ac9941" type="button" role="tab" aria-controls="dom-47ddfa96-6eaf-4d17-b934-836eb7ac9941" aria-selected="true" id="tab-dom-47ddfa96-6eaf-4d17-b934-836eb7ac9941">Preview</button><button class="btn btn-sm" data-bs-toggle="pill" data-bs-target="#dom-406295b8-3c83-4d00-b868-883fde6c88bc" type="button" role="tab" aria-controls="dom-406295b8-3c83-4d00-b868-883fde6c88bc" aria-selected="false" id="tab-dom-406295b8-3c83-4d00-b868-883fde6c88bc">Code</button></div>
                    </div>
                  </div>
                </div>
                <div class="card-body bg-body-tertiary">
                  <div class="tab-content">
                    <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-47ddfa96-6eaf-4d17-b934-836eb7ac9941" id="dom-47ddfa96-6eaf-4d17-b934-836eb7ac9941"><!-- Find the JS file for the following chart at: src/js/charts/chartjs/chart-radar.js--><!-- If you are not using gulp based workflow, you can find the transpiled code at: public/assets/js/theme.js--><canvas class="max-w-100" id="chartjs-radar-chart" width="350"></canvas></div>
                    <div class="tab-pane code-tab-pane" role="tabpanel" aria-labelledby="tab-dom-406295b8-3c83-4d00-b868-883fde6c88bc" id="dom-406295b8-3c83-4d00-b868-883fde6c88bc"><pre class="scrollbar rounded-1" style="max-height:420px"><code class="language-html">
&lt;!-- Find the JS file for the following chart at: src/js/charts/chartjs/chart-radar.js--&gt;
&lt;!-- If you are not using gulp based workflow, you can find the transpiled code at: public/assets/js/theme.js--&gt;&lt;canvas class=&quot;max-w-100&quot; id=&quot;chartjs-radar-chart&quot; width=&quot;350&quot;&gt;&lt;/canvas&gt;</code></pre>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="card">
                <div class="card-header">
                  <div class="row flex-between-end">
                    ...
                    <div class="col-auto ms-auto">
                      <div class="nav nav-pills nav-pills-falcon flex-grow-1" role="tablist"><button class="btn btn-sm active" data-bs-toggle="pill" data-bs-target="#dom-c800a232-732f-4de2-8ca2-60f4b4f254ee" type="button" role="tab" aria-controls="dom-c800a232-732f-4de2-8ca2-60f4b4f254ee" aria-selected="true" id="tab-dom-c800a232-732f-4de2-8ca2-60f4b4f254ee">Preview</button><button class="btn btn-sm" data-bs-toggle="pill" data-bs-target="#dom-3ff513b2-78d8-4cb7-b6c9-b9df9c0df907" type="button" role="tab" aria-controls="dom-3ff513b2-78d8-4cb7-b6c9-b9df9c0df907" aria-selected="false" id="tab-dom-3ff513b2-78d8-4cb7-b6c9-b9df9c0df907">Code</button></div>
                    </div>
                  </div>
                </div>
                <div class="card-body bg-body-tertiary">
                  <div class="tab-content">
                    <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-c800a232-732f-4de2-8ca2-60f4b4f254ee" id="dom-c800a232-732f-4de2-8ca2-60f4b4f254ee"><!-- Find the JS file for the following chart at: src/js/charts/chartjs/chart-bubble.js--><!-- If you are not using gulp based workflow, you can find the transpiled code at: public/assets/js/theme.js--><canvas class="max-w-100" id="chartjs-bubble-chart" height="200"></canvas></div>
                    <div class="tab-pane code-tab-pane" role="tabpanel" aria-labelledby="tab-dom-3ff513b2-78d8-4cb7-b6c9-b9df9c0df907" id="dom-3ff513b2-78d8-4cb7-b6c9-b9df9c0df907"><pre class="scrollbar rounded-1" style="max-height:420px"><code class="language-html">
&lt;!-- Find the JS file for the following chart at: src/js/charts/chartjs/chart-bubble.js--&gt;
&lt;!-- If you are not using gulp based workflow, you can find the transpiled code at: public/assets/js/theme.js--&gt;&lt;canvas class=&quot;max-w-100&quot; id=&quot;chartjs-bubble-chart&quot; height=&quot;200&quot;&gt;&lt;/canvas&gt;</code></pre>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="card">
                <div class="card-header">
                  <div class="row flex-between-end">
                    ...
                    <div class="col-auto ms-auto">
                      <div class="nav nav-pills nav-pills-falcon flex-grow-1" role="tablist"><button class="btn btn-sm active" data-bs-toggle="pill" data-bs-target="#dom-d75fb5f1-8170-4d9a-8830-6305ba232ed9" type="button" role="tab" aria-controls="dom-d75fb5f1-8170-4d9a-8830-6305ba232ed9" aria-selected="true" id="tab-dom-d75fb5f1-8170-4d9a-8830-6305ba232ed9">Preview</button><button class="btn btn-sm" data-bs-toggle="pill" data-bs-target="#dom-186fa8bf-6913-4fa1-ab6f-8bd14e819b0a" type="button" role="tab" aria-controls="dom-186fa8bf-6913-4fa1-ab6f-8bd14e819b0a" aria-selected="false" id="tab-dom-186fa8bf-6913-4fa1-ab6f-8bd14e819b0a">Code</button></div>
                    </div>
                  </div>
                </div>
                <div class="card-body bg-body-tertiary">
                  <div class="tab-content">
                    <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-d75fb5f1-8170-4d9a-8830-6305ba232ed9" id="dom-d75fb5f1-8170-4d9a-8830-6305ba232ed9"><!-- Find the JS file for the following chart at: src/js/charts/chartjs/chart-scatter.js--><!-- If you are not using gulp based workflow, you can find the transpiled code at: public/assets/js/theme.js--><canvas class="max-w-100" id="chartjs-scatter-chart" height="200"></canvas></div>
                    <div class="tab-pane code-tab-pane" role="tabpanel" aria-labelledby="tab-dom-186fa8bf-6913-4fa1-ab6f-8bd14e819b0a" id="dom-186fa8bf-6913-4fa1-ab6f-8bd14e819b0a"><pre class="scrollbar rounded-1" style="max-height:420px"><code class="language-html">
&lt;!-- Find the JS file for the following chart at: src/js/charts/chartjs/chart-scatter.js--&gt;
&lt;!-- If you are not using gulp based workflow, you can find the transpiled code at: public/assets/js/theme.js--&gt;&lt;canvas class=&quot;max-w-100&quot; id=&quot;chartjs-scatter-chart&quot; height=&quot;200&quot;&gt;&lt;/canvas&gt;</code></pre>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="card">
                <div class="card-header">
                  <div class="row flex-between-end">
                    ...
                    <div class="col-auto ms-auto">
                      <div class="nav nav-pills nav-pills-falcon flex-grow-1" role="tablist"><button class="btn btn-sm active" data-bs-toggle="pill" data-bs-target="#dom-ecb87769-5417-4acb-94e3-a435da0e9235" type="button" role="tab" aria-controls="dom-ecb87769-5417-4acb-94e3-a435da0e9235" aria-selected="true" id="tab-dom-ecb87769-5417-4acb-94e3-a435da0e9235">Preview</button><button class="btn btn-sm" data-bs-toggle="pill" data-bs-target="#dom-67b3ff58-78cb-4826-a6dd-b6abd435479a" type="button" role="tab" aria-controls="dom-67b3ff58-78cb-4826-a6dd-b6abd435479a" aria-selected="false" id="tab-dom-67b3ff58-78cb-4826-a6dd-b6abd435479a">Code</button></div>
                    </div>
                  </div>
                </div>
                <div class="card-body bg-body-tertiary">
                  <div class="tab-content">
                    <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-ecb87769-5417-4acb-94e3-a435da0e9235" id="dom-ecb87769-5417-4acb-94e3-a435da0e9235"><!-- Find the JS file for the following chart at: src/js/charts/chartjs/chart-combo.js--><!-- If you are not using gulp based workflow, you can find the transpiled code at: public/assets/js/theme.js--><canvas class="max-w-100" id="chartjs-combo-chart" width="1618" height="500"></canvas></div>
                    <div class="tab-pane code-tab-pane" role="tabpanel" aria-labelledby="tab-dom-67b3ff58-78cb-4826-a6dd-b6abd435479a" id="dom-67b3ff58-78cb-4826-a6dd-b6abd435479a"><pre class="scrollbar rounded-1" style="max-height:420px"><code class="language-html">
&lt;!-- Find the JS file for the following chart at: src/js/charts/chartjs/chart-combo.js--&gt;
&lt;!-- If you are not using gulp based workflow, you can find the transpiled code at: public/assets/js/theme.js--&gt;&lt;canvas class=&quot;max-w-100&quot; id=&quot;chartjs-combo-chart&quot; width=&quot;1618&quot; height=&quot;500&quot;&gt;&lt;/canvas&gt;</code></pre>
                    </div>
                  </div>
                </div>
              </div>
