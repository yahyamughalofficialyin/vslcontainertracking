...
<!-- Mirrored from prium.github.io/falcon/v3.21.0/modules/forms/basic/select.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 17 Oct 2024 20:06:56 GMT -->
          ...
          <div class="card mb-3">
            ...
            <div class="card-body position-relative">
              <div class="row">
                <div class="col-lg-8">
                  <h3>Select</h3>
                  <p class="mb-0">Customize the native selects with custom CSS that changes the element’s initial appearance.</p><a class="btn btn-link btn-sm ps-0 mt-2" href="https://getbootstrap.com/docs/5.3/forms/select" target="_blank">Select on Bootstrap<span class="fas fa-chevron-right ms-1 fs-11"></span></a>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="card-header">
              <div class="row flex-between-end">
                ...
                <div class="col-auto ms-auto">
                  <div class="nav nav-pills nav-pills-falcon flex-grow-1 mt-2" role="tablist"><button class="btn btn-sm active" data-bs-toggle="pill" data-bs-target="#dom-591ced94-25bd-47aa-bd26-54137d4fa212" type="button" role="tab" aria-controls="dom-591ced94-25bd-47aa-bd26-54137d4fa212" aria-selected="true" id="tab-dom-591ced94-25bd-47aa-bd26-54137d4fa212">Preview</button><button class="btn btn-sm" data-bs-toggle="pill" data-bs-target="#dom-7ca07407-322e-4fcd-a688-e46949d9ea0b" type="button" role="tab" aria-controls="dom-7ca07407-322e-4fcd-a688-e46949d9ea0b" aria-selected="false" id="tab-dom-7ca07407-322e-4fcd-a688-e46949d9ea0b">Code</button></div>
                </div>
              </div>
            </div>
            <div class="card-body bg-body-tertiary">
              <div class="tab-content">
                <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-591ced94-25bd-47aa-bd26-54137d4fa212" id="dom-591ced94-25bd-47aa-bd26-54137d4fa212"><select class="form-select" aria-label="Default select example">
                    <option selected="">Open this select menu</option>
                    <option value="1">One</option>
                    <option value="2">Two</option>
                    <option value="3">Three</option>
                  </select></div>
                <div class="tab-pane code-tab-pane" role="tabpanel" aria-labelledby="tab-dom-7ca07407-322e-4fcd-a688-e46949d9ea0b" id="dom-7ca07407-322e-4fcd-a688-e46949d9ea0b"><pre class="scrollbar rounded-1" style="max-height:420px"><code class="language-html">&lt;select class=&quot;form-select&quot; aria-label=&quot;Default select example&quot;&gt;
  &lt;option selected=&quot;&quot;&gt;Open this select menu&lt;/option&gt;
  &lt;option value=&quot;1&quot;&gt;One&lt;/option&gt;
  &lt;option value=&quot;2&quot;&gt;Two&lt;/option&gt;
  &lt;option value=&quot;3&quot;&gt;Three&lt;/option&gt;
          ...
          <div class="card">
            <div class="card-header">
              <div class="row flex-between-end">
                ...
                <div class="col-auto ms-auto">
                  <div class="nav nav-pills nav-pills-falcon flex-grow-1 mt-2" role="tablist"><button class="btn btn-sm active" data-bs-toggle="pill" data-bs-target="#dom-a75854f4-ab47-4ed9-8307-47ede3d8e2a0" type="button" role="tab" aria-controls="dom-a75854f4-ab47-4ed9-8307-47ede3d8e2a0" aria-selected="true" id="tab-dom-a75854f4-ab47-4ed9-8307-47ede3d8e2a0">Preview</button><button class="btn btn-sm" data-bs-toggle="pill" data-bs-target="#dom-163d8362-17ba-436b-aa7c-d39747069e3d" type="button" role="tab" aria-controls="dom-163d8362-17ba-436b-aa7c-d39747069e3d" aria-selected="false" id="tab-dom-163d8362-17ba-436b-aa7c-d39747069e3d">Code</button></div>
                </div>
              </div>
            </div>
            <div class="card-body bg-body-tertiary">
              <div class="tab-content">
                <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-a75854f4-ab47-4ed9-8307-47ede3d8e2a0" id="dom-a75854f4-ab47-4ed9-8307-47ede3d8e2a0"><select class="form-select form-select-lg mb-3" aria-label=".form-select-lg example">
                    <option selected="">Open this select menu</option>
                    <option value="1">One</option>
                    <option value="2">Two</option>
                    <option value="3">Three</option>
                ...
                <div class="tab-pane code-tab-pane" role="tabpanel" aria-labelledby="tab-dom-163d8362-17ba-436b-aa7c-d39747069e3d" id="dom-163d8362-17ba-436b-aa7c-d39747069e3d"><pre class="scrollbar rounded-1" style="max-height:420px"><code class="language-html">&lt;select class=&quot;form-select form-select-lg mb-3&quot; aria-label=&quot;.form-select-lg example&quot;&gt;
  &lt;option selected=&quot;&quot;&gt;Open this select menu&lt;/option&gt;
  &lt;option value=&quot;1&quot;&gt;One&lt;/option&gt;
  &lt;option value=&quot;2&quot;&gt;Two&lt;/option&gt;
  &lt;option value=&quot;3&quot;&gt;Three&lt;/option&gt;
