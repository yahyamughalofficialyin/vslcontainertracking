...
<!-- Mirrored from prium.github.io/falcon/v3.21.0/dashboard/support-desk.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 17 Oct 2024 20:05:05 GMT -->
              ...
              <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                <li class="nav-item"><!-- parent pages--><a class="nav-link dropdown-indicator" href="#dashboard" role="button" data-bs-toggle="collapse" aria-expanded="true" aria-controls="dashboard">
                  ...
                  <ul class="nav collapse show" id="dashboard">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="support-desk.html">
              ...
              <div class="row g-0 h-100">
                <div class="col-12 mb-3">
                  <div class="card bg-body-tertiary dark__bg-opacity-50 shadow-none">
                    ...
                    <div class="d-flex align-items-center z-1 p-0"><img src="../assets/img/illustrations/ticket-welcome.png" alt="" width="96" />
                      <div class="ms-n3">
            ...
            <div class="col-xxl-6">
              <div class="card h-100">
                <div class="card-header d-flex flex-between-center border-bottom border-200 py-2">
                  ...
                  <div class="dropdown font-sans-serif btn-reveal-trigger"><button class="btn btn-link text-600 btn-sm dropdown-toggle dropdown-caret-none btn-reveal" type="button" id="dropdown-unresolved-tickets" data-bs-toggle="dropdown" data-boundary="viewport" aria-haspopup="true" aria-expanded="false"><span class="fas fa-ellipsis-h fs-11"></span></button>
                    ...
                    <div class="col-md-auto border-end-md border-200 pt-3 pt-md-0 d-md-flex align-items-center">
                      <div class="row flex-md-column px-3">
                        <div class="col-auto border-end border-end-md-0 border-bottom-md pb-md-3 mb-md-3 ps-0 ps-md-3 pe-x1 pe-md-3 me-1 me-md-0">
                          <div class="d-flex align-items-center mb-n1"><label class="fs-9 mb-n1 text-700 cursor-pointer" for="urgent">14</label><input class="form-check-input small-dot mt-0 shadow-none remove-checked-icon rounded-circle cursor-pointer" type="checkbox" data-unresolved-tickets="Urgent" value="" id="urgent" checked="checked" /></div><label class="fs-11 mb-0 text-700 cursor-pointer" for="urgent">Urgent</label>
                        </div>
                        <div class="col-auto border-end border-end-md-0 border-bottom-md pb-md-3 mb-md-3 pe-x1 pe-md-3 me-1 me-md-0">
                          <div class="d-flex align-items-center mb-n1"><label class="fs-9 mb-n1 text-700 cursor-pointer" for="high">16</label><input class="form-check-input small-dot mt-0 shadow-none remove-checked-icon rounded-circle cursor-pointer form-check-input-info" type="checkbox" data-unresolved-tickets="High" value="" id="high" checked="checked" /></div><label class="fs-11 mb-0 text-700 cursor-pointer" for="high">High</label>
                        </div>
                        <div class="col-auto border-end border-end-md-0 border-bottom-md pb-md-3 mb-md-3 pe-x1 pe-md-3 me-1 me-md-0">
                          <div class="d-flex align-items-center mb-n1"><label class="fs-9 mb-n1 text-700 cursor-pointer" for="medium">53</label><input class="form-check-input small-dot mt-0 shadow-none remove-checked-icon rounded-circle cursor-pointer bg-priority-medium" type="checkbox" data-unresolved-tickets="Medium" value="" id="medium" checked="checked" /></div><label class="fs-11 mb-0 text-700 cursor-pointer" for="medium">Medium</label>
                        </div>
                        <div class="col-auto pe-0">
                          <div class="d-flex align-items-center mb-n1"><label class="fs-9 mb-n1 text-700 cursor-pointer" for="low">25</label><input class="form-check-input small-dot mt-0 shadow-none remove-checked-icon rounded-circle cursor-pointer bg-priority-low" type="checkbox" data-unresolved-tickets="Low" value="" id="low" checked="checked" /></div><label class="fs-11 mb-0 text-700 cursor-pointer" for="low">Low</label>
                        </div>
                      </div>
                    </div>
                ...
                <div class="card-header d-md-flex justify-content-between border-bottom border-200 py-3 py-md-2">
                  ...
                  <div class="row g-md-0">
                    <div class="col-auto d-md-flex">
                      <div class="d-flex align-items-center me-md-3 form-check mb-0"><input class="form-check-input dot mt-0 shadow-none remove-checked-icon rounded-circle cursor-pointer" type="checkbox" data-number-of-tickets="On Hold Tickets" value="" id="onHoldTickets" checked="checked" /><label class="form-check-label lh-base mb-0 fs-11 text-500 fw-semi-bold font-base cursor-pointer" for="onHoldTickets">On Hold Tickets</label></div>
                      <div class="d-flex align-items-center me-md-3 form-check mb-0 mt-n1 mt-md-0"><input class="form-check-input dot mt-0 shadow-none remove-checked-icon rounded-circle open-tickets cursor-pointer" type="checkbox" data-number-of-tickets="Open Tickets" value="" id="openTickets" checked="checked" /><label class="form-check-label lh-base mb-0 fs-11 text-500 fw-semi-bold font-base cursor-pointer" for="openTickets">Open Tickets</label></div>
                    </div>
                    <div class="col-auto d-md-flex">
                      <div class="d-flex align-items-center me-md-3 form-check mb-0"><input class="form-check-input dot mt-0 shadow-none remove-checked-icon rounded-circle due-tickets cursor-pointer" type="checkbox" data-number-of-tickets="Due Tickets" value="" id="dueTickets" checked="checked" /><label class="form-check-label lh-base mb-0 fs-11 text-500 fw-semi-bold font-base cursor-pointer" for="dueTickets">Due Tickets</label></div>
                      <div class="d-flex align-items-center form-check mb-0 mt-n1 mt-md-0"><input class="form-check-input dot mt-0 shadow-none remove-checked-icon rounded-circle unassigned-tickets cursor-pointer" type="checkbox" data-number-of-tickets="Unassigned Tickets" value="" id="unassignedTickets" checked="checked" /><label class="form-check-label lh-base mb-0 fs-11 text-500 fw-semi-bold font-base cursor-pointer" for="unassignedTickets">Unassigned Tickets</label></div>
                    </div>
                  </div>
                </div>
            ...
            <div class="col-xxl-4 col-md-6">
              <div class="card h-100">
                <div class="card-header d-flex flex-between-center border-bottom border-200 py-2">
                  ...
                  <div class="dropdown font-sans-serif btn-reveal-trigger"><button class="btn btn-link text-600 btn-sm dropdown-toggle dropdown-caret-none btn-reveal" type="button" id="dropdown-customer-satisfaction" data-bs-toggle="dropdown" data-boundary="viewport" aria-haspopup="true" aria-expanded="false"><span class="fas fa-ellipsis-h fs-11"></span></button>
...
<!-- Mirrored from prium.github.io/falcon/v3.21.0/dashboard/support-desk.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 17 Oct 2024 20:05:07 GMT -->
</html>